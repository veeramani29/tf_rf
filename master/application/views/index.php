        ...
        <div class="md-card" id="login_card">
            <div class="md-card-content large-padding" id="login_form">
                <div class="login_heading">
                   ...
                   <form id="login" novalidate="" name="login" method="post">
            ...
            <?php echo ($error_msg!='')?'<div class="uk-alert uk-alert-danger text-center" data-uk-alert=""><a href="#" class="uk-alert-close uk-close" ></a>'.$error_msg.'</div>':''; ?>
                    ...
                    <div class="uk-form-row">
                        <label for="login_username">Username</label>
                         <input type="text" name="username" required="" class="md-input" value="<?php echo set_value('username'); ?>" placeholder="Username" id="username" />

                    </div>
                    <div class="uk-form-row">
                        <label for="login_password">Password</label>
                          <input type="password" class="md-input" required="" name="password" value="<?php echo set_value('password'); ?>" placeholder="Password" id="password" />      
                    ...
                    <div class="uk-margin-top">
                      <a class="uk-float-right" href="<?php echo base_url('login/forgotpassword');?>">Forgot Password ?</a>
