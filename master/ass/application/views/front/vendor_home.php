...
<div class="row">
    <div class="col-md-12">
    	...
    	<div class="col-md-6 pull-left" style="padding:8px 15px;">
			<?php
                if(!file_exists('uploads/vendor/logo_'.$vendor.'.png')){
            ?>
    		<img src='<?php echo base_url(); ?>uploads/vendor/logo_0.png'  class="img-responsive pull-left" width="300"/>
            <?php
                } else {
            ?>
    		<img src='<?php echo base_url(); ?>uploads/vendor/logo_<?php echo $vendor; ?>.png'  class="img-responsive pull-left" width="300"/>
            <?php
                }
            ?>
        </div>
