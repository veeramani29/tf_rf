...
altair_crud_table = {
    init: function() {
        ...
        $('.jtable tbody tr:first td.jtable-command-column').hide();
},
            ...
            actions: {
                listAction: WEB_URL+'admin/actions?action=list',
                createAction: WEB_URL+'admin/actions?action=create',
                
                updateAction: WEB_URL+'admin/actions?action=update',
               
                deleteAction: WEB_URL+'admin/actions?action=delete',
            },
            fields: {
                user_id: {
                    key: true,
                ...
                access_level: {
                    title: 'Access Level',
                    width: '13%',
                    options: {'ACC-2': 'Sub-admin','ACC-3': 'Marketing'}
                },
