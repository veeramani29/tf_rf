...
altair_crud_table = {
    init: function() {
        ...
        $('#students_crud').jtable({
            ...
            actions: {
                listAction: WEB_URL+'users/actions?action=list',
                createAction: WEB_URL+'users/actions?action=create',
                updateAction: WEB_URL+'users/actions?action=update',
                deleteAction: WEB_URL+'users/actions?action=delete',
            },
            fields: {
                user_id: {
                    key: true,
