...
$this->data['umrah'] = $this->umrah_model->get_umrah()->result();
//print("<pre>");print_r($this->data['galleries']);exit;

$this->load->view("umrah/view_album",$this->data);
...
$gallery_id =  $this->umrah_model->create_umrah($data);
...
$this->load->view("umrah/create_album",$this->data);
...
$this->data['umrah'] =  $this->umrah_model->edit_umrah($id);
...
$gallery_id =  $this->umrah_model->update_umrah($data,$id);
...
$this->data['message'] = (validation_errors() ? validation_errors() : $this->session->flashdata('message'));
$this->load->view("umrah/edit_album",$this->data);
...
$page_delete = $this->umrah_model->delete_umrah($id);
//unlink("./upload/umrah/cover_pic/$img");
redirect("umrah/manage_gallery");
}
...
function update_publish(){
	...
	$data['withdraw'] =  1;
	$id = $_REQUEST['id'];
	$news_id =  $this->umrah_model->update_ads($data,$id);
	echo $id;
