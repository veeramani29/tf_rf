                ...
                <div class="content">
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="box">
                                <div class="box-head">
                                    <h3>Activate Deposit Details</h3>
                                </div>
...
<?php if (validation_errors() != '') { ?>                              
                                    ...
                                    <?php } ?> 
                                    <form action="<?php echo site_url(); ?>/b2b/activate_new_deposit" method="post" class='validate form-horizontal' enctype="multipart/form-data">
                                        
                                        <legend>Activation Action</legend>
                                        <div class="control-group">
                                            <label for="req" class="control-label">Select Action</label>
                                            <div class="controls">
                                                <select name="activate_deposit" required>
                                        ...
                                        <div class="form-actions">
                                            <input type="submit" class="btn btn-primary" value="Update Deposit Status">
                                        </div>
                                        <?php 
                                            $agentDetails = $this->B2b_Model->getAgentDetailsOnId($tran_details->agent_id);
                                        ?>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <span><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/upload/<?php echo $tran_details->scan_copy; ?>"></span>
                                            </div>
                                        </div>
