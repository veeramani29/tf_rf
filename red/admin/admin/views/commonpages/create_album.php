...
<form action="<?php echo site_url(); ?>/commonpages/create_album" method="post" class='validate form-horizontal' enctype="multipart/form-data">
<legend>Common Pages Information</legend>
...
<input type="submit" class="btn btn-primary" value="Add Common Pages">
</div>
