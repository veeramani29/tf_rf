...
<?php if (validation_errors() != '') { ?>                              
                                ...
                                ?>
                                    <form action="<?php echo site_url(); ?>/crs/add_hotel_room_info/<?php echo $hotel_id; ?>" method="post" class='validate form-horizontal' enctype="multipart/form-data">
                                        <legend>Room Information</legend>
                                        
                                        <div class="control-group">
                                            <label for="req" class="control-label">Room Type</label>
                                            <div class="controls">
                                                <input type="text" id="req" class='required' name="room_type" style="width: 327px;" autocomplete="off" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="req" class='required' name="room_inclusion" style="width: 327px;" autocomplete="off" required />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="req" class="control-label">Room Description</label>
                                            <div class="controls">
                                                <textarea class="ckeditor" name="room_desc"></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="req" class="control-label">Room Price / Night</label>
                                            <div class="controls">
                                                <input type="text" id="req" class='required' name="room_price" style="width: 327px;" autocomplete="off" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="dat" class='required' name="from_date" style="width: 327px;" autocomplete="off" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="dat1" class='required' name="date_to" style="width: 327px;" autocomplete="off" required />
                                            </div>
                                        </div>
