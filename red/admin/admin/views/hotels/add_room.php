                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    ...
                                    <form action="<?php echo site_url(); ?>/hotels/add_room" method="post" class='validate form-horizontal' enctype="multipart/form-data">
                                        <legend>General Information</legend>
                                        <div class="control-group">
                                            <label for="req" class="control-label">Select Hotel</label>
                                            <div class="controls">
                                                <select name="hotel" class='required' style="width: 300px;" onchange="getRoomTypeOnHotelId(this.value);" required>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="room_name" class='required' name="room_name" autocomplete="off" required value="" style="width: 291px;"/>
                                            </div>
                                        </div>
