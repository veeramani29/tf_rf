                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    ...
                                    <form action="<?php echo site_url(); ?>/hotels/add_room_type" method="post" class='validate form-horizontal' enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" id="room_type" class='required' name="room_type" autocomplete="off" required value="<?php echo set_value('room_type'); ?>" style="width: 291px;" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label for="req" class="control-label">Max Adult<span style='color:red;'>*</span></label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="room_condition" rows="3" style="width:290px;"></textarea>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label for="req" class="control-label">Description</label>
                                            <div class="controls">
                                                <textarea name="description" rows="3" style="width:290px;"></textarea>
                                            </div>
                                        </div>
