                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    ...
                                    <form action="<?php echo site_url(); ?>/hotels/edit_category/<?php echo $id; ?>" method="post" class='validate form-horizontal' enctype="multipart/form-data">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select id="parent_category" name="parent_category" class='required' style="width: 300px;" required>
                                                    ...
                                                    <?php 
                                                        if($category != ''){
                                                            $catList = $this->hotels_model->getParentCategoryOnGroup($category->group_id);
                                                            if($catList != ''){
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <img src="<?php echo Image_Path.$category->category_thumb; ?>" width="100" height="100">
