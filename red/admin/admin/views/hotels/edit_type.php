                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    ...
                                    <form action="<?php echo site_url(); ?>/hotels/edit_type/<?php echo $id; ?>" method="post" class='validate form-horizontal' enctype="multipart/form-data">
                                        <legend>General Information</legend>
                                        
                                        <div class="control-group">
                                            <label for="req" class="control-label">Business Type</label>
                                            <div class="controls">
                                                <input type="text" id="business_type" class='required' name="business_type" autocomplete="off" required value="<?php echo $type->business_type; ?>" />
                                            </div>
                                        </div>
                                        <input type="hidden" name="type_id" value="<?php echo $id; ?>">
                                        <div class="form-actions">
                                            <input type="submit" class="btn btn-primary" value="Save Type">
                                        </div>
