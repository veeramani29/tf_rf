...
<form action="<?php echo site_url(); ?>/packages/create_album" method="post" class='validate form-horizontal' enctype="multipart/form-data">
<legend>Packages Information</legend>

<div class="control-group">
<label for="req" class="control-label">Package Name</label>
<div class="controls">
<input type="text" id="package_name" class='required' name="package_name" autocomplete="off" required value="<?php echo set_value('package_name'); ?>" />
</div>
</div>
...
<option value="<?php echo $country_list[$i]->Country; ?>"><?php echo $country_list[$i]->Country; ?></option>
<?php }	?>
</select>
</div>
</div>
...
<option value="<?php echo $city_list[$i]->City; ?>"><?php echo $city_list[$i]->City; ?></option>
<?php }	?>
</select>
</div>
</div>
...
<div class="controls">
$<input type="text" id="price" class='required' name="price" autocomplete="off" required value="<?php echo set_value('price'); ?>" />
</div>
</div>
...
<div class="controls">
<input type="date" class="required" name="package_show_date" id="package_show_date" required value="<?php echo set_value('package_show_date'); ?>" >
</div>
</div>
...
<div class="controls">
<input type="date" class="required" name="package_hide_date" id="package_hide_date" required value="<?php echo set_value('package_hide_date'); ?>" >
</div>
</div>
...
<div class="controls">
<input type="text" id="hotel_name" class='required' name="hotel_name" autocomplete="off" required value="<?php echo set_value('hotel_name'); ?>" />
</div>
</div>
...
<div class="controls">
<input type="text" id="room_type" class='required' name="room_type" autocomplete="off" required value="<?php echo set_value('room_type'); ?>" />
</div>
</div>
...
<div class="controls">
<input type="file" class="required" name="package_image" id="package_image" required>
</div>
</div>
...
<div class="controls">
<input type="file" class="required" name="hotel_image" id="hotel_image" required>
</div>
</div>
...
<div class="controls">
<input type="text" id="total_nights" class='required' name="total_nights" autocomplete="off" required value="<?php echo set_value('total_nights'); ?>" />
</div>
</div>
...
<div class="controls">
<input type="text" id="airline" class='required' name="airline" autocomplete="off" required value="<?php echo set_value('airline'); ?>" />
</div>
</div>
...
<div class="controls">
<input type="text" id="transportation" class='required' name="transportation" autocomplete="off" required value="<?php echo set_value('transportation'); ?>" />
</div>
</div>
...
<input type="submit" class="btn btn-primary" value="Add Packages">
</div>
