                            ...
                            <div class="box">
                                <div class="box-head tabs">
                                    ...
                                    <ul class="nav  nav-pills">
                                        <li>
                                            <a class="tip btn btn-mini" href="<?php echo site_url(); ?>/packages/add_type" data-original-title="Add Tour Type">
                                                    ...
                                                    if (!empty($types)) {
                                                        ...
                                                        <?php
                                                            foreach ($types as $type) {
                                                                $groupName = $this->packages_model->getGroupNameOnID($type->group_id);
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="center">
                                                                    <a class="btn btn-info" href="<?php echo site_url(); ?>/packages/edit_type/<?php echo $type->id; ?>" title="Edit" data-rel="tooltip">
                                                                        <i class="icon-edit icon-white"></i> 
                                                                    </a>
                                                                    <a class="btn btn-danger" href="<?php echo site_url(); ?>/packages/delete_type/<?php echo $type->id; ?>" title="Delete / Block" data-rel="tooltip" onClick="return confirm('Do you Want to delete this link!')">
