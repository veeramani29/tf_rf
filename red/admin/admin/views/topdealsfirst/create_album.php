...
<form action="<?php echo site_url(); ?>/topdealsfirst/create_album" method="post" class='validate form-horizontal' enctype="multipart/form-data">
...
<div class="controls">
<input type="text" id="place" class='required' name="place" autocomplete="off" required />
</div>
</div>
...
<input type="submit" class="btn btn-primary" value="Add Topdals Fiirst Section">
</div>
