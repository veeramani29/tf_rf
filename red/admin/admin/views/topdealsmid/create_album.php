...
<form action="<?php echo site_url(); ?>/topdealsmid/create_album" method="post" class='validate form-horizontal' enctype="multipart/form-data">
...
<input type="submit" class="btn btn-primary" value="Add Topdals Mid Section">
</div>
