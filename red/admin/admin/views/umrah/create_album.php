...
<form action="<?php echo site_url(); ?>/umrah/create_album" method="post" class='validate form-horizontal' enctype="multipart/form-data">
...
<input type="submit" class="btn btn-primary" value="Add umrah Packages">
</div>
