...
class Hotel extends CI_Controller {
    ...
    public function search() {
        ...
        $data['api'] = array('0'=>'1','1'=>'3');
         ...
         //$data['api'] = array('0'=>'2');
        $this->load->view('hotel_new/search', $data);
    }
    ...
    public function getHotelSearchData($apiId) {
        ...
        if ($apiId == '1') {
            ...
            $serchView = $this->load->view('hotel_new/roomsxml_result', $data, true);
        ...
        if($apiId == 2){
            ...
            $serchView = $this->load->view('hotel_new/tacenter_result',$data,true);
            echo json_encode(
                array(
                    'hotel_search_result'=>$serchView,
                    'locations'=>$loc,
        ...
        if($apiId == 3){
            ...
            $serchView = $this->load->view('hotel_new/rezlive_result',$data,true);
            echo json_encode(
                array(
                    'hotel_search_result'=>$serchView,
                    'locations'=>$loc,
    ...
    public function details($apiId, $id) {
       ...
       //echo"<pre>"; print_r($data);die;
        $this->load->view('hotel_new/details', $data);
    }
    ...
    public function pre_booking($apiId, $hotelId, $roomId) {
        ...
        $this->load->view('hotel_new/pre_booking', $data);
    }
