...
class Flight_Model extends CI_Model {
    ...
    function addFlightBookingDetails($postData,$onwardDetails,$requestData,$priceFinalData,$agentInfo,$adminMarkup)
    {
        ...
        if($requestData['infant'] > 0)
        {
            for($i=0;$i<$requestData['infant'];$i++)
            {
                $this->db->query($sql="insert into flight_booking_pax_details set master_id='".$id."', 
                                                                                    ...
                                                                                    first_name='".$postData['infantFname'][$i]."',
                                                                                    last_name='".$postData['infantLname'][$i]."',
                                                                                    dob='".$postData['infantDob'][$i]."',
    ...
    function addFlightBookingDetailsRound($onwardDetails,$returnDetails,$postData,$requestData,$priceFinalData,$agentData,$adminMarkup)
    {
