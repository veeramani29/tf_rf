                            ...
                            <div class="row">
                                <div class="col-sm-4 col-md-3">
                                    <div class="toggle-container filters-container">
                                        <div class="panel style1 arrow-right" style="background-color: #f00;">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" style="color: #fff;font-family: georgia;" href="#modify-search-panel" class="collapsed">Modify Search</a>
                                            </h4>
                                            <div id="modify-search-panel" class="panel-collapse collapse">
                                                <div class="panel-content" style="background-color: #ffffff;">
                                                    <form id="flight_form" errorblkid="homeErrorMessage" action="<?php echo site_url(); ?>/agent_flight/search" method="GET" >
                                                        <div class="form-group">
                                                            <input type="radio" name="journey_type" id="one_way" value="one_way" onclick="check_return();" <?php echo($searchData['journey_type'] == 'one_way' ? 'checked' : '') ?>>Oneway
                                                            &nbsp;&nbsp;&nbsp;
                                                            <input type="radio" name="journey_type" id="round_trip" value="round_trip" onclick="check_return();" <?php echo($searchData['journey_type'] == 'round_trip' ? 'checked' : '') ?>>Round
                                                            &nbsp;&nbsp;&nbsp;
                                                        </div>
                                                        <div class="form-group">
                                                            <label>From</label>
                                                            <input type="text" class="input-text full-width" name="from" id="from_airport" placeholder="" value="<?php echo $searchData['from']; ?>" required/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>To</label>
                                                            <input type="text" class="input-text full-width" name="to" id="to_airport" placeholder="" value="<?php echo $searchData['to']; ?>" required/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Departure on</label>
                                                            <div>
                                                                <input type="text" class="input-text full-width" id="datepicker" name="sd" placeholder="yyyy-mm-dd" value="<?php echo $searchData['sd']; ?>" required/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group" id="return_div" <?php echo($searchData['journey_type'] == 'round_trip' ? 'style="display:block;"' : 'style="display:block;"'); ?>>
                                                            <label>Arriving On</label>
                                                            <div>
                                                                <input type="text" class="input-text full-width" id="datepicker1" name="ed" placeholder="yyyy-mm-dd" value="<?php echo($searchData['journey_type'] == 'round_trip' ? $searchData['ed'] : ''); ?>" required/>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div style="margin-bottom: 25px;margin-right: 62px;">								
                                                            <input type="submit" tabindex="11" class="btn btn-default pull-right" value="Search flights" title="Search flights" style="background: #f74623; color:#fff;">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel style1 arrow-right">
                                            <h4 class="search-results-title"><span class="glyphicon glyphicon-search"></span>&nbsp;&nbsp;<b><span id="count_progress"></span></b><span id="flight_found" style="display:none;font-family: rome;"> Flights Found.</span><img src="<?php echo base_url(); ?>assets/images/small_loader.gif" id="small_progress"></h4>
                                        </div>
                                        <div class="panel style1 arrow-right">
                                            <h4 class="panel-title">
