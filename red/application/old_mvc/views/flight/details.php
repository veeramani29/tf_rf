                ...
                <div class="col-md-9 fli_padleft0">
                    ...
                    <div class="col-md-12 fli_det_bor fli_pad0" style="margin-top: 10px; padding-bottom: 10px !important;">
                        ...
                        <div class="col-md-10 fli_pad0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control child_book_date" name="child_dob[]" placeholder="Date Of Birth*" style="background-color: #ffffff;" oninvalid="this.setCustomValidity('Select your date of birth')" readonly required>
                                </div> 
                            </div>
                            <?php if (isset($flightDetails['Inbound']['baggage']) && count($flightDetails['Inbound']['baggage']) > 0) { ?>
                        ...
                        <div class="col-md-10 fli_pad0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control infant_book_date" style="background-color: #ffffff;" name="infant_dob[]" placeholder="Date Of Birth*" readonly required>
                                </div> 
                            </div>
                             <?php if (isset($flightDetails['Inbound']['baggage']) && count($flightDetails['Inbound']['baggage']) > 0) { ?>
                            <div class="col-md-3 fli_pad0">
