...
$airlineList[]=$OutstartLeg['carrier']['name'];
        ...
        <div class="col-md-12 searchflight_box sort-by-section pull-left" style="margin-bottom:15px;">
            <div class="FlightInfoBox" data-price="<?php echo number_format($totalFare,2,'.',''); ?>" data-stops="<?php echo $Stops; ?>" data-airlines="<?php echo $instartLeg['carrier']['name']; ?>" data-depart="<?php echo $indepDetails[1]; ?>" data-arrival="<?php echo $inarvDetails[1]; ?>" data-duration="<?php //echo $totalDur; ?>" data-departure="<?php //echo $depTimeFilter; ?>">
...
<small><?php echo $OutstartLeg['carrier']['name']; ?></small>
                ...
                <div class="col-md-3" style="padding-left:0px;padding-top: 25px;">
                    ...
                    <div class="col-md-10">
                       ...
                       <div style="clear:both;"></div>
                       <a onclick="window.location.href='<?php echo site_url(); ?>/flight/details/<?php echo $i; ?>';" class="button btn-small full-width" style="text-decoration:none;">SELECT NOW</a>
                       ...
                       <div style="clear:both;"></div>
                        ...
                        Flight Details</a></span>| 
                                            ...
                                            <span class="f_color" style="position: relative;top: 16px;font-size: 16px;color: #000;"> <a class="href_<?php echo ($i+1);?>" href="javascript:void(0);" id="<?php echo $fareRules;?>" onclick="show_fare_popup(this.id,this,1)">Fare Rules</a></span>
                    </div>
                   </div>
