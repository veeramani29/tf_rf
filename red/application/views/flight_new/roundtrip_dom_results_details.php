       ...
       # $arvTime = explode(':', $result1);
        ...
        $duration = $diff->format('%hH, %iM'); //die;
           ...
           <ul class="flightstable mt20">
                                            <li class="ft1">
                         <td><?php echo $time_in_12_hour_format_dep; ?></td>
                ...
                <li class="ft3"><?php echo $airlieName; ?> - Flight  <?php echo $stops['carrier']['code']; ?>-<?php echo $stops['flightNo']; ?>, <?php echo 'Economy'; //$stops['Class'];   ?></li>
