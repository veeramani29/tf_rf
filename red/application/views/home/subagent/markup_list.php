    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Manage Sub Agent Markup</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 tab-content">
                        <div id="flightMarkup" class="panel panel-default tab-pane fade in active">
                            ...
                            <form name="fl_submarkup_add" id="fl_submarkup_add">
...
<!--                            <div class="panel-heading fl_mark_head" >
                            ...
                            <div class="panel-body">
                                ...
                                <input type="hidden" name="sub_id" id="sub_id" value="<?php echo $subagent_id ?>">
                                <div style="clear:both;"></div>
                                <div class="panel-heading fl_mark_head" style="font-weight:bold;">
                            ...
                            <div class="col-md-12" style="margin-top:10px;">
                                <div class="custom-search" style="margin-bottom: 35px;text-align:center;">
                                    <input type="button" name="" value="Update Flight Markup" id="update_fl_markup_submit" onclick="return updateSubAgentFlMarkupDetails('<?php echo $subagent_id ?>');" class="btn btn-primary" style="color:#ffffff;">
                        ...
                        <div id="hotelMarkup" class="panel panel-default tab-pane fade in">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="margin-top:10px;">
                                    <div class="custom-search" style="margin-bottom: 35px;text-align:center;">
                                        <input type="button" name="" value="Update Hotel Markup" id="update_ho_markup_submit" onclick="return updateSubAgentHoMarkupDetails('<?php echo $subagent_id ?>');" class="btn btn-primary" style="color:#ffffff;">
