                                    ...
                                    <div class="toggle-container filters-container">
                                        ...
                                        <div class="panel style1 arrow-right">
                                            ...
                                            <div id="modify-search-panel" class="panel-collapse collapse">
                                                ...
                                                <div class="panel-content" style="background-color: #ffffff;height:auto">
                                                    <form id="flight_frm" errorblkid="homeErrorMessage" action="<?php echo site_url(); ?>/flightbeta/search" method="GET" >
                                        ...
                                        <div class="panel style1 arrow-right">
                                            ...
                                            <div id="Rflight-stops-filter" class="panel-collapse collapse">
                                                <div class="panel-content">
                                                    <ul class="check-square filters-option">
                                                        <li style="width: 100%;padding: 7px 0 5px 15px;"><input type="checkbox" class='Rstop_filter' name="Rstops" value="0" onclick="filter();" checked>Non Stop</a></li>
                                                        <li style="width: 100%;padding: 7px 0 5px 15px;"><input type="checkbox" class='Rstop_filter' name="Rstops" value="1" onclick="filter();" checked>1 Stop</a></li>
                                                        <li style="width: 100%;padding: 7px 0 5px 15px;"><input type="checkbox" class='Rstop_filter' name="Rstops" value="2" onclick="filter();" checked>2 Stops</a></li>
                                                        <li style="width: 100%;padding: 7px 0 5px 15px;"><input type="checkbox" class='Rstop_filter' name="Rstops" value="3" onclick="filter();" checked>3 Stops</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function ()
        {
            ...
            for (var i = 0, l = api_array.length; i < l; i++){
                $.ajax({
                    url: Site_Url + '/flightbeta/getSearchData/' + api_array[i],
                    data: 'searchId=1',
                    dataType: 'json',
                    type: 'get',
                    beforeSend: function (){
