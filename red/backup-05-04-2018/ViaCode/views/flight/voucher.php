                ...
                <div style="padding:0px;width:100%; float:left;">
                    ...
                    <div style="background-color: #f1f1f1; width:100%; float:left; ">
                        ...
                        <div style=" width:58%;float:left;">
                            <p style="float: right;color: red;border: 1px solid red;padding: 6px;border-radius: 4px;"><?php echo($flightDetails->not_refundable == 1 ? ' Refundable':'Not Refundable'); ?></p>
                        </div>
                    </div>
                    <div style="clear:both;"></div>
                    ...
                    <div style="width:100%; float:left;">
                        ...
                        <div style="width:25%;float:left;">
                            ...
                            <p>
                                <b>
                                    <?php 
                                        $depDateArr = explode(' ',$DepartureDateTime[$i]);
                        ...
                        <div style="width:25%;float:left;">
                            ...
                            <p>
                                <b>
                                    <?php 
                                        $arvDateArr = explode(' ',$ArrivalDateTime[$i]);
                        ...
                        <div style="width:25%;float:left;">
                            <?php 
                                ...
                                $date1 = new DateTime($depDateArr[0] . ' ' . $depDateArr['1']);
                                $date2 = new DateTime($arvDateArr[0] . ' ' . $arvDateArr[1]);
                                $diff = $date2->diff($date1);
                                $duration = $diff->format('%hH, %iM'); //die;
                                ###############################Duration Calculation##################################################
                            ?>
                            <p style="color:#a9a9a9;text-align:right;padding-right: 40px;"><?php echo $duration; ?></p>
                            <p style="color:#a9a9a9;text-align:right;padding-right: 40px;"><?php echo $flightDetails->stops; ?> Stops</p>
                        </div>
                        <div style="clear:both;"></div>
                        <?php 
                            if (count($Departure_LocationCode) > 2 && $i < count($Departure_LocationCode) - 2) {
                                $date3 = new DateTime($arvDateArr[0] . ' ' . $arvDateArr[1]);
                                #$depDateTim3 = explode(' ', $DepartureDateTime[$i+1]);
                                #print_r($depDateTim3);
                                #$chunks2 = str_split($depDateTim3[1], 2);
                                #$result2 = implode(':', $chunks2);
                                $date4 = new DateTime($DepartureDateTime[$i+1]);
                    ...
                    <div style="background-color: #f1f1f1; width:100%; float:left; ">
                        ...
                        <div style=" width:58%;float:left;">
                            <p style="float: right;color: red;border: 1px solid red;padding: 6px;border-radius: 4px;"><?php echo($roundDetails->not_refundable == 1 ? ' Refundable':'Not Refundable'); ?></p>
                        </div>
                    </div>
                    <div style="clear:both;"></div>
                    <hr style="margin-top:0px;">
                    ...
                    <div style="width:100%; float:left;">
                        ...
                        <div style="padding:0px; width:100%; float:left;">
                            ...
                            <?php if($pax->extra_baggage_onward!=''){ $baggEx = explode(';',$pax->extra_baggage_onward); $baggageCost = ($baggageCost+$baggEx[1]); ?>
                            <div style="width:25%;float:left;">
                    ...
                    <div style="width:100%; float:left;">
                        ...
                        <div style="padding:0px; width:100%; float:left;">
                            ...
                            <?php  if($pax->extra_baggage_return!=''){ $baggEx = explode(';',$pax->extra_baggage_return); $baggageCost = ($baggageCost+$baggEx[1]); ?>
                            <div style="width:25%;float:left;">
                                <p style="text-align:right;padding-right: 40px;"><?php echo $baggEx[0]; ?> kg</p>
                            </div>
                             <?php } ?>
