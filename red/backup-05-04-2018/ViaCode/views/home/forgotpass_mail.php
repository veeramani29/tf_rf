     ...
     <!-- <tr>
      ...
      <tr>
        <td align="center" valign="top" bgcolor="#dcdbdb" style="background-color:#dcdbdb; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000000;"><table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            <td width="50%" align="left" valign="top" style="color:#ffffff; font-family:Verdana, Geneva, sans-serif; font-size:11px;">Hello, <?php echo $check['agent_data']->first_name; ?></td>
        ...
        <td align="center" valign="top" bgcolor="#ffffff" style="background-color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000000; padding:12px;"><table width="100%" border="0" cellspacing="0" cellpadding="10" style="margin-bottom:10px;">
          <tr>
            <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#525252;">
                <div style="font-size:22px;">Forgot password notification.</div>
            <div style="font-size:18px; color:#006d00;">Password successfully changed.</div>
              
<div>  
        
        <p>Below is the new password, Kindly login to your account and change the password for security reasons.</p>
        
        <p>Password : <?php echo $check['pass']; ?></p>
</div> </td>
          </tr>
        </table>
