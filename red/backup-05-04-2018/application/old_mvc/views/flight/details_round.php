                ...
                <div class="col-md-9 fli_padleft0">
                        ...
                        <div class="col-md-12 fli_det_bor satur" style="margin-top:2px;">
                            ...
                            <div class="col-md-3 fli_padlefto fli_bor12">
                                ...
                                <div class="col-md-4 fli_padleft0">
                                    <img alt="" class="fli_fli_icon12" src="<?php echo base_url(); ?>assets/images/airline_logo/<?php echo $flight['Carrier_code']; ?>.gif">
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="col-md-3 fli_padlefto">
                                ...
                                <div class="col-md-12 fli_padleft0">
                                    ...
                                    <p class="fli_pad_bot2">Meal: <?php echo $flight['MealInfo']; ?></p>
                                        ...
                                        ?>
                                        <div class="col-md-12">
                                            <h4 class="fli_wai" style="font-size: 14px;">Connection flight at <?php echo $codes[1]['airport_city']; ?> ( <?php echo $flight['Destination']; ?> )&nbsp;&nbsp;Layover Time : <?php echo $layover; ?></h4>
                                        </div>
                                        <?php
                                        } 
                                        $i++;
                            ...
                            <div class="col-md-3 fli_padlefto">
                                ...
                                <div class="col-md-12 fli_padleft0">
                                    ...
                                    <p class="fli_pad_bot2">Meal: <?php echo $flightR['MealInfo']; ?></p>
                                        ...
                                        ?>
                                        <div class="col-md-12">
                                            <h4 class="fli_wai" style="font-size: 14px;">Connection flight at <?php echo $codes[1]['airport_city']; ?> ( <?php echo $flightR['Destination']; ?> )&nbsp;&nbsp;Layover Time : <?php echo $layover; ?></h4>
                                        </div>
                                        <?php
                                        } 
                                        $i++;
                    ...
                    <div class="col-md-12 fli_det_bor fli_pad0" style="margin-top: 10px; padding-bottom: 10px !important;">
                        ...
                        <div class="col-md-10 fli_pad0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control adult_book_date" name="adult_dob[]" placeholder="Date Of Birth*" oninvalid="this.setCustomValidity('Select your date of birth')" readonly required>
                                </div> 
                            </div>
                        ...
                        <div class="col-md-10 fli_pad0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="child_book_date" name="child_dob[]" placeholder="Date Of Birth*" style="background-color: #ffffff;" oninvalid="this.setCustomValidity('Select your date of birth')" readonly required>
                                </div> 
                            </div>
                            <?php if (isset($flightDetails['Inbound']['baggage']) && count($flightDetails['Inbound']['baggage']) > 0) { ?>
                        ...
                        <?php } ?>
                            <?php if (isset($flightDetails['Outbound']['baggage']) && count($flightDetails['Outbound']['baggage']) > 0) { ?>
                            <div class="col-md-4">
                                <select class="form-control" name="childBaggageReturn[]">
                                    <option value="">Return Additional Baggage</option>
                                    <option value=''>Not Required</option>
                                    <?php for ($d = 0; $d < count($flightDetails['Outbound']['baggage']); $d++) { ?>
                                    <option value="<?php echo $flightDetails['Outbound']['baggage'][$d]['size'] . ';' . $flightDetails['Outbound']['baggage'][$d]['price']; ?>"><?php echo $flightDetails['Outbound']['baggage'][$d]['size'] . 'KG - &nbsp;&nbsp;PHP' . $flightDetails['Outbound']['baggage'][$d]['price']; ?></option>
                        ...
                        <div class="col-md-10 fli_pad0">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="infant_book_date" style="background-color: #ffffff;" name="infant_dob[]" placeholder="Date Of Birth*" readonly required>
                                </div> 
                            </div>
                             <?php if (isset($flightDetails['Inbound']['baggage']) && count($flightDetails['Inbound']['baggage']) > 0) { ?>
                            <div class="col-md-3 fli_pad0">
                        ...
                        <?php } ?>
                            <?php if (isset($flightDetails['Outbound']['baggage']) && count($flightDetails['Outbound']['baggage']) > 0) { ?>
                            <div class="col-md-4">
                                <select class="form-control" name="infantBaggageReturn[]">
                                    <option value="">Return Additional Baggage</option>
                                    <option value=''>Not Required</option>
                                    <?php for ($d = 0; $d < count($flightDetails['Outbound']['baggage']); $d++) { ?>
                                    <option value="<?php echo $flightDetails['Outbound']['baggage'][$d]['size'] . ';' . $flightDetails['Outbound']['baggage'][$d]['price']; ?>"><?php echo $flightDetails['Outbound']['baggage'][$d]['size'] . 'KG - &nbsp;&nbsp;PHP' . $flightDetails['Outbound']['baggage'][$d]['price']; ?></option>
                    ...
                    <div class="col-md-12 fli_padright0" style="padding-bottom:10px;">
                        <div class="custom-search pull-right">
                            <label>&nbsp;</label>
                            <input type="submit" name="" value="Continue to Payment" class="btn fli_butt_book" style="color:#fff;background-color: #f74623;">
                        </div>
                    </div>
                    </form>
