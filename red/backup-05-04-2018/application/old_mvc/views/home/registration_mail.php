        ...
        <td align="center" valign="top" bgcolor="#ffffff" style="background-color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#000000; padding:12px;"><table width="100%" border="0" cellspacing="0" cellpadding="10" style="margin-bottom:10px;">
          <tr>
            <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#525252;">
                <div style="font-size:22px;">Welcome To Redtag Travels - Agent's Portal</div>
            <div style="font-size:18px; color:#006d00;">Your Registration is pending. It will be reviewed by Redtag Travels and will be activated within 24 Hrs.</div>
              
<div>  
        <p>Thank you for registering with us. The best hotel travel deals are waiting for you at the lowest rates. Just login and search for your the hotel, flight, cars and tour packages</p>
        <p>Below are your account details. Once you login go to my account and change the password for security reasons. keep it safe and don't share it with any one.</p>
        <p>Email : <?php echo $agent_email ?></p>
        <p>Password : <?php echo $pass ?></p>
        <p>Account No. : <?php echo $user_no ?></p>
