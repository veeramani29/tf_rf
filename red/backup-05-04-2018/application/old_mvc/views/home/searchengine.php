                    ...
                    <div class="container">
                        <!-- Tab panes --><div class="full-width" id="search">
                            <ul class="col-md-8 nav nav-tabs">
                                ...
                                <li><a data-toggle="tab" href="#hotels"><i class="fa fa-bed" aria-hidden="true"style="padding-right: 7px;"></i>Hotel</a></li>
                            </ul>
                                    ...
                                    <form id="flight_frm" action="<?php echo site_url(); ?>/flight/search" method="GET">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>From</label> 
                                                <input type="text" name="from" id="flFrom" class="form-control " placeholder="From airport or city" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>To</label>
                                                <input type="text" name="to" id="flTo" class="form-control " placeholder="To airport or city" >
                                            </div>
                                        </div>
                                        <div style="clear:both;"></div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " id="flSd" name="sd" placeholder="Departure date" >
                                            </div>
                                        </div>
                                        <div class="col-md-6" id="ReturnDateContainer" style="display:none;">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Return on</label>
                                                <input type="text" class="form-control " id="flEd" name="ed" placeholder="Return date" >
                                            </div>
                                        </div>
                                        <div style="clear:both;"></div>
                                        <div class="col-md-4">
