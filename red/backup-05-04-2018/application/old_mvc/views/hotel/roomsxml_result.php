<div class="col-sm-8 col-md-9">
    ...
    <?php
        ...
        foreach ($result as $list) {
            ...
            $hototalPriceAry[] = $totalPrice;
    ?>
        <div class="hotel-item searchhotel_box HotelInfoBox searchflight" data-price="<?php echo $totalPrice; ?>" data-hotel-name="<?php echo $list['name']; ?>" data-star="<?php echo $star; ?>" data-facility="<?php echo $amenity; ?>" data-location="<?php echo $location; ?>" data-type="<?php echo $type; ?>" data-api="<?php echo 1; ?>" style="margin-top: 22px;">
        ...
        <div class="item-body">
            <div class="item-title">
                <p style="margin-bottom:0px;"><a href="<?php echo site_url(); ?>/hotel/details/1/<?php echo $i; ?>" style="font-size: 27px;color: #616161;"><?php echo $list['name']; ?></a></p></div>
