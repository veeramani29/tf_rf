            ...
            <div class="col-md-12 re_pad0">
                ...
                <div class="col-md-9 fli_padleft0">
                    ...
                    <?php
                        ...
                        $duration = explode(':', gmdate("H:i", ($flightData['flights'][0]['flyTime'] * 60)));
                        $durHour = $duration[0];
                        $durMin = $duration[1];
                    ?>
                    <div class="col-md-12 fli_pad0">
                        <div class="col-md-12 fli_det_bor flight" style="cursor:pointer;">
                            ...
                            <div class="col-md-1 fli_right0 fli_stop">
                                <span><?php echo $flightData['flights'][0]['stops']; ?> stop</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 fli_det_bor satur" style="margin-top:2px;">
                            ...
                            <div class="col-md-3 fli_padlefto fli_bor12">
                                ...
                                <div class="col-md-8">
                                    <p class="fli_pad_bot2"><?php echo $flight['carrier']['name'] ?></p> 
                            ...
                            <div class="col-md-3 fli_padlefto fli_bor12">
                                ...
                                <div class="col-md-12 fli_padleft0">
                                    ...
                                    <p class="fli_pad_bot2"><b><?php echo $result; ?></b> <?php echo($flight['depDetail']['terminal'] != '' ? ', '.$flight['depDetail']['terminal'] : ''); ?></p>
                            ...
                            <div class="col-md-3 fli_padlefto fli_bor12">
                                ...
                                <div class="col-md-12 fli_padleft0">
                                    ...
                                    <p class="fli_pad_bot2"><b><?php echo $result1; ?></b> <?php echo($flight['arrDetail']['terminal'] != '' ? ', '.$flight['arrDetail']['terminal'] : ''); ?></p>
                            ...
                            <div class="col-md-3 fli_padlefto">
                                ...
                                <div class="col-md-12 fli_padleft0">
                                    <p class="fli_pad_bot2">Economy (<?php echo ($flight['classDetail']['adt']['class'])?$flight['classDetail']['adt']['class']:'Not Included'; ?>)</p>
                                    <p class="fli_pad_bot2">Baggage: <?php echo ($flight['amenities']['baggage']['cabin']['adt']['desc'])?$flight['amenities']['baggage']['cabin']['adt']['desc']:'Not Included'; ?></p>
                                    <p class="fli_pad_bot2">Meal: <?php echo ($flight['MealInfo']['meal'])?$flight['MealInfo']['meal']:'Not Included'; ?></p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 fli_det_bor" style="margin-top: 10px;">
                        <div class="col-md-12 flight fli_padleft0">
                            <p class="fli_acc"><span style="padding-right:10px;"><img alt="" src="<?php echo base_url(); ?>assets/images/img/flights/i.png"></span>
                                <a data-toggle="modal" data-target="#fare_rulebeta" style="color: #e67e22;cursor:pointer;text-decoration:none;">Fare Information</a>&nbsp;&nbsp;&nbsp;
                                <a data-toggle="modal" data-target="#baggage_policybeta" style="color: #e67e22;cursor:pointer;text-decoration:none;">Baggage Policy</a>&nbsp;&nbsp;&nbsp;
                                <a data-toggle="modal" data-target="#terms_conditionbeta" style="color: #e67e22;cursor:pointer;text-decoration:none;">Terms & Conditions</a></p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10 fli_pad0">
                            ...
                            <div class="col-md-3">
                                <select class="form-control fli_padleft0 fli_padright0" name="adultBaggageOnward[]" >
                                    ...
                                    <option value="<?php echo $flightDetails['ssr']['ssrHeap']['baggage'][0]['data'][$d]['desc'] . ';' . $flightDetails['ssr']['ssrHeap']['baggage'][0]['data'][$d]['amount']; ?>"><?php echo $flightDetails['ssr']['ssrHeap']['baggage'][0]['data'][$d]['desc'] . 'KG - &nbsp;&nbsp;&#8369;' . $flightDetails['ssr']['ssrHeap']['baggage'][0]['data'][$d]['amount']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        <?php } ?>
                    ...
                    <div class="col-md-12 fli_det_bor fli_pad0 pull-left" style=" padding-bottom: 10px !important; margin-bottom:10px; width:100%;">
                        ...
                        <?php
                            foreach($flightDetails['fare']['paxFares']['adt'] as $key => $value){
                                ...
                                if($key != ''){?>
									<div class="col-md-12">
										<div class="col-md-6 fli_pad_bot2 fli_padleft0"><?php echo $key; ?></div>
										<div class="col-md-6 pull-right fli_pad_bot2 fli_padright0" style="text-align:right;" >&#8369; <?php echo number_format(($value['amount'] *$adult),2,'.',','); ?></div>
									</div>
									<?php 
                                }
                        ...
                        ?>
                                <div class="col-md-12">
                                    <div class="col-md-6 fli_pad_bot2 fli_padleft0"><?php echo $keyc; ?></div>
                        ...
                        ?>
                                <div class="col-md-12">
                                    <div class="col-md-6 fli_pad_bot2 fli_padleft0"><?php echo $keyIn; ?></div>
                        ...
                        <div class="col-md-12" style="padding-top:15px;">
                            ...
                            <div class="col-md-6 fli_padright0">
                                <h4 class="pull-right fli_clr_de">&#8369; <span id="tot_cost"><?php echo number_format($flightDetails['fare']['totalFare']['total']['amount'],2,'.',','); ?></span></h4>
                                
                                <input type="hidden" id="fl_tot" name="fl_tot" value="<?php echo $flightDetails['fare']['paxFares']['totalFare']['total']['amount']; ?>">
                            </div>
                        </div>
                    </div>
                            ...
                            <div style="width:100%;">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <?php
                                        ...
                                        if ($flightDetails['fare']['paxFares']['adt']['total']['amount'] !="") {
                                            ?>
                                            
                                            <tr>
                                                <?php
                                                if ($flightDetails['fare']['paxFares']['adt']['total'] !="") {
                                                    ?>
                                                    <td style="font-weight:bold;">Total Amount</td>
                                                    <td style="font-weight:bold;">PHP <?php echo ($flightDetails['fare']['paxFares']['adt']['total']['amount']*$adult); ?></td>
                                                    <?php
                                                } else {
                                                    if ($flightDetails['fare']['paxFares']['adt']['base'])
                                                        $showPrice = ($flightDetails['fare']['paxFares']['adt']['base']['amount']);
                                                    ?>
                                                    <td><?php //echo $flightDetails['fare'][$i]['ChargeType']; ?></td>
                                                    <td>PHP <?php echo $showPrice; ?></td>
                                                    <?php
                                ...
                                if ($searchData['child'] > 0) {
                                    ...
                                    <table class="table table-bordered">
                                       ...
                                       <?php
                                        ...
                                        if ($flightDetails['fare']['paxFares']['chd']['total']['amount'] !="") {
                                            ?>
                                            
                                            <tr>
                                                <?php
                                                if ($flightDetails['fare']['paxFares']['chd']['total'] !="") {
                                                    ?>
                                                    <td style="font-weight:bold;">Total Amount</td>
                                                    <td style="font-weight:bold;">PHP <?php echo ($flightDetails['fare']['paxFares']['chd']['total']['amount']*$child); ?></td>
                                                    <?php
                                                } else {
                                                    if ($flightDetails['fare']['paxFares']['chd']['base'])
                                                        $showPrice = ($flightDetails['fare']['paxFares']['chd']['base']['amount']);
                                                    ?>
                                                    <td><?php //echo $flightDetails['fare'][$i]['ChargeType']; ?></td>
                                                    <td>PHP <?php echo $showPrice; ?></td>
                                                    <?php
                                ...
                                if ($searchData['infant'] > 0) {
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        if ($flightDetails['fare']['paxFares']['inf']['total']['amount'] !="") {
                                            ?>
                                            
                                            <tr>
                                                <?php
                                                if ($flightDetails['fare']['paxFares']['inf']['total'] !="") {
                                                    ?>
                                                    <td style="font-weight:bold;">Total Amount</td>
                                                    <td style="font-weight:bold;">PHP <?php echo ($flightDetails['fare']['paxFares']['inf']['total']['amount']*$infant); ?></td>
                                                    <?php
                                                } else {
                                                    if ($flightDetails['fare']['paxFares']['inf']['base'])
                                                        $showPrice = ($flightDetails['fare']['paxFares']['inf']['base']['amount']);
                                                    ?>
                                                    <td><?php //echo $flightDetails['fare'][$i]['ChargeType']; ?></td>
                                                    <td>PHP <?php echo $showPrice; ?></td>
                                                    <?php
