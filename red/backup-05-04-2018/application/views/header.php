...
<div class="full-width top-header" id="redtop" style="padding-top:0px;">
    ...
    <div class="navbar-header">
        <a href="<?php echo base_url(); ?>/home" class="logo"><img src="<?php echo base_url(); ?>assets/images/logo.png" height="150px;" width="250px;" class="img-responsive"></img></a>
    </div>
    </div>
    <div class="col-md-9 pad_top">
    	 <ul class="nav-bar navbar-right">
            <li>
