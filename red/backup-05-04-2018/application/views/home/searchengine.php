                        ...
                        <!-- Tab panes --><div class="full-width" id="search">
                            ...
                            <div class="col-md-8 tab-content" style="padding-bottom:55px; padding-top:10px;">
                                <div role="tabpanel" class="tab-pane active" id="flights">
                                    <form id="flight_frm" action="<?php echo site_url(); ?>/flight/search" method="GET">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-sms-6 col-sm-6 col-md-3 pad_right0 pad_left0" style="width: 180px;">
                                            <div class="radio" style=" padding: 0px 0px 13px 0px;">
                                                <label><input type="radio" name="journey_type" id="multi_city" value="multi_city" tabindex="3" onclick="hideShowRoundTrip();" style="    width: 16%;height: 2em;"> <span class="rad_po">Multi City</span> </label>
                                            </div>
                                        </div>

                                        <div style="clear:both;"></div>
                                        <div class="collapse in" id="oneWayRound">
                                            <div class="col-md-6">
                                        ...
                                        <div class="collapse" id="multiCityTrip">

                                            <div class="clearfix multiCityContainer">

                                              <!-- Nav tabs -->
                                              <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#flight1" aria-controls="flight 1" role="tab" data-toggle="tab"><i class="fa fa-flight"></i>  Flight 1</a></li>
                                                <li role="presentation"><a href="#flight2" aria-controls="flight 2" role="tab" data-toggle="tab"><i class="fa fa-flight"></i> Flight 2</a></li>
                                                <li role="presentation"><a href=""><i class="fa fa-plus"></i></a></li>
                                                <!--li role="presentation"><a href="#flight3" aria-controls="flight 3" role="tab" data-toggle="tab"><i class="fa fa-flight"></i> Flight 3</a></li>
                                                <li role="presentation"><a href="#flight4" aria-controls="flight4" role="tab" data-toggle="tab"><i class="fa fa-flight"></i> Flight 4</a></li-->
                                              </ul>

                                              <!-- Tab panes -->
                                              <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active" id="flight1">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>From</label> 
                                                            <input type="text" name="from" id="flFrom" class="form-control " placeholder="Type atleast 3 letters" >
                                                ...
                                                <div role="tabpanel" class="tab-pane" id="flight2">
                                                                                                        <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>From</label> 
                                                            <input type="text" name="from" id="flFrom" class="form-control " placeholder="Type atleast 3 letters" >
                                                ...
                                                <div role="tabpanel" class="tab-pane" id="flight3">
                                                                                                        <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>From</label> 
                                                            <input type="text" name="from" id="flFrom" class="form-control " placeholder="Type atleast 3 letters" >
                                                ...
                                                <div role="tabpanel" class="tab-pane" id="flight4">
                                                                                                        <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>From</label> 
                                                            <input type="text" name="from" id="flFrom" class="form-control " placeholder="Type atleast 3 letters" >
                                        ...
                                        <div id="fl_more_options" style="display:none;">
                                            ...
                                            <div class="col-md-4" id="sr_ctzn_div" style="display:none">
                                                <label>&nbsp;</label>
                                                <div class="form-group">
