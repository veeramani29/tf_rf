                ...
                <div class="col-md-12 sort-by-section">
                    <h4>
                        <label class="col-xs-12 col-sm-6">
                            <span><?php echo $searchData['dest_city']; ?></span>
                            <span>Adults : <?php echo $searchData['adult_count']; ?></span>
                            <span>Child : <?php echo $searchData['child_count']; ?></span>
                            <span>Nights : <?php echo $searchData['nights']; ?></span>                            
                        </label>
                        
                        <span class="text-right text-xs-left col-xs-12 col-sm-6"><?php echo date('D d, M, Y', strtotime($searchData['cin'])) . ' &nbsp;&nbsp;To&nbsp;&nbsp; ' . date('D d, M, Y', strtotime($searchData['cout'])); ?></span>                        
                    </h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-3">
                            <h4 class="search-results-title">
                                ...
                                <b><span id="count_progress"></span></b>
                                ...
                                <a href="#mobileFilterPanel" class="pull-right" id="mobileFilterControler">Filters</a>
                            </h4>
                            <div id="mobileFilterPanel" class="toggle-container filters-container">
