					...
					<div class="box">
						<div class="box-head tabs">
                           ...
                           <ul class='nav nav-tabs'>
									...
									<a href="<?php echo WEB_URL; ?>currency/add_currency" ><button class="btn btn-primary">Add New Currency</button></a>
							...
							<div class="tab-content">
									...
									if($currency!='')
									{
											for($i=0;$i<count($currency);$i++)
											{
												...
												<tr>
                                                <td><?php echo $i+1; ?></td>
                                                <td><?php echo $currency[$i]->country; ?></td>
                                                <td><?php echo $currency[$i]->value; ?></td>
                                                 <td><div class="btn-group">
												<a class="btn btn-mini tip" href="<?php echo WEB_URL; ?>currency/edit_currency/<?php echo $currency[$i]->cur_id; ?>" data-original-title="Edit"><img alt="" src="<?php echo WEB_DIR; ?>img/icons/fugue/edit.png"></a>
												
												<a class="btn btn-mini tip" href="<?php echo WEB_URL; ?>currency/delete_currency/<?php echo $currency[$i]->cur_id; ?>" data-original-title="Remove"><img alt="" src="<?php echo WEB_DIR; ?>img/icons/fugue/cross.png"></a>
											</div></td>
