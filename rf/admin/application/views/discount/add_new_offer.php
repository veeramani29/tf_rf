...
<head>
  ...
  <body class='contrast-dark fixed-header'>
    <?php //print_r($_REQUEST);die; $this->load->view('header');?>
    <div id='wrapper'>
      ...
      <section id='content'>
        ...
        <div class='row'>
          <div class='col-sm-12'>
              ...
              <div class='box-content'>
                ...
                <form class='form form-horizontal validate-form'  id="new-page-form"  style='margin-bottom: 0;' method="post"  enctype="multipart/form-data"> 
                 ...
                 <div class='form-group'>
                  <label class='control-label col-sm-3 col-sm-3' for='validation_name'>Offer For <small class="has-error">*</small></label>
                  <div class='col-sm-3 controls'>
                    <select class='select2 form-control offer_for' data-rule-required='true' name='offer_for' id="offer_for">

                      <option value='Flight' <?php echo ($offer_details->offer_for=="Flight")?'selected="selected"':'';?>>Flight</option>
                      <option value='Hotel' <?php echo ($offer_details->offer_for=="Hotel")?'selected="selected"':'';?>>Hotel</option>
                    </select>
                  </div>
                ...
                <div class='form-group'>
                  ...
                  <div class='col-sm-3 controls'>
                    <select class='select2 form-control' data-rule-required='true' name='origin' id="validation_origin">
                      ...
                      <option value='<?=$airportsdata->airport_code;?>' <?php echo ($offer_details->origin==$airportsdata->airport_code)?'selected="selected"':'';?>><?=$airportsdata->airport_name;?>,<?=$airportsdata->airport_city;?>(<?=$airportsdata->airport_code;?>)</option>
                      <?php }?>
                    </select>
                  </div>
                  <label class='<?php echo ($offer_details->offer_for=="Hotel")?'hide':'';?> control-label col-sm-2 col-sm-2 flight' for='validation_name'>Destination <small class="has-error">*</small></label>
                  <div class='col-sm-3 controls flight <?php echo ($offer_details->offer_for=="Hotel")?'hide':'';?>'>
                   <select class='select2 form-control' data-rule-required='true' name='destination' id="validation_destination">
                     <?php 	foreach ($airports as $airportsdata) {?>
                     <option value='<?=$airportsdata->airport_code;?>' <?php echo ($offer_details->destination==$airportsdata->airport_code)?'selected="selected"':'';?>><?=$airportsdata->airport_name;?>,<?=$airportsdata->airport_city;?>(<?=$airportsdata->airport_code;?>)</option>
                     <?php }?>
                   </select>
                 </div>
               </div>
               ...
               <div class='form-group flight <?php echo ($offer_details->offer_for=="Hotel")?'hide':'';?>'>
            ...
            <div class='form-group'>
            <label class='control-label col-sm-3' for='datepicker'>Offer To Date <small class="has-error">*</small></label>
              <div class='input-group date col-sm-4' id='datetimepicker1'>
                <input class='form-control' placeholder='YYYY-MM-DD' name="to_date" type='text' value="<?php echo $offer_details->to_date;?>" data-rule-required='true' readonly>
         ...
         <div class='form-group'>
          <label class='control-label col-sm-3'>Shor Description <i class='icon-eur'></i><small class="has-error">*</small></label>
