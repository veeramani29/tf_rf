...
<html>
<head>
    <title>Add New Room Info | <?php echo PROJECT_NAME;?></title>
                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Add New Room Info</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Add New Room Info</div>
                      <div class='actions'>
                 ...
                 <form action="<?php echo WEB_URL; ?>hotelcrs/add_room_capacity_details" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>
							     <div class='form-group'>
                          <label class='control-label col-sm-3'  for='validation_current'>Home Name </label>
                          <div class='col-sm-4 controls'>
                     	
                                  
										<select name="hotel_name" class='form-control'   data-rule-required='true'  class='form-control'   data-rule-required='true'>									
                        ...
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_password' class=""> Room Type</label>
                          <div class='col-sm-4 controls'>
                      		 
                                     <input type="text" class='form-control'   data-rule-required='true' name="capacity_title" id="capacity_title"   >		
                                  </div>  </div>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                              	...
                              	<input type="text" name="capacity" id="capacity"  class='form-control'  data-rule-required='true'>		
                          ...
                          <div class='col-sm-4 controls'>
                              		...
                              		<input type="text" name="child_capacity"   class='form-control'   >		
