...
<script>
	...
	<title>Change Price | <?php echo PROJECT_NAME;?></title>
                       		...
                       		<div class="control-group">
                       			...
                       			<div class='form-group'>
									...
									<div class='col-sm-4 controls'>
										<div class='col-sm-6'>
										   <div class='input-group'>
												<input name="day" id="dayy" type="checkbox" value="Mon" style="margin-right:5px;" <?php //if(in_array('Mon', $sdays)) { echo 'checked'; } ?>/>Mon <br>
								...
								<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="display tableStatic">
									<tr style="background:#00acec"  height="45">
										...
										<td style="border-right:solid 1px #deab6f; text-align:center; padding:5px;">
											<input name="price" id="price" type="text" class="form-control"  style="height:20px; width:80px; margin-top:3px; background:#F2F2F2;" /></td>
										<td style="border-right:solid 1px #deab6f; text-align:center; padding:5px;">
											<input name="avail" id="avail" type="text" class="form-control"  style="height:20px;width:80px; margin-top:3px; background:#F2F2F2;"  onblur="checkavailcount(this.value)"/></td>
										<td style="border-right:solid 1px #deab6f; text-align:center; padding:5px;">
											<input name="adult" id="adult" type="text" class="form-control"  style="height:20px;width:80px; margin-top:3px; background:#F2F2F2;" /></td>
										<td style="border-right:solid 1px #deab6f; text-align:center; padding:5px;">
											<input name="child" id="child" type="text" class="form-control"  style="height:20px;width:80px; margin-top:3px; background:#F2F2F2;" /></td>
										<td style="border-right:solid 1px #deab6f; text-align:center; padding:5px;">
