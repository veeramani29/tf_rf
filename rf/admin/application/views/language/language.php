...
<html>
<head>
    <title>Languages | <?php echo PROJECT_NAME;?></title>
                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Language Library</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Language Library</div>
                     <!--  <div class='actions'>
                          ...
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            <thead>
                              <tr>
                       			...
                       			<tbody>
													<?php  if(!empty($languages)) { $count = 1; 
												foreach($languages as $key => $language) { ?>
											<tr>
												<td><?php echo $count; ?></td>
												<td><?php echo $language->page; ?></td>
												<td class="center">
											 	<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title=""  href="<?php echo WEB_URL; ?>language_library/view_content/<?php echo $language->page; ?>"  data-original-title="View">
