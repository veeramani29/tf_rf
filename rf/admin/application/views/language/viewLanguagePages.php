...
<html>
<head>
    <title>Language Label Management | <?php echo PROJECT_NAME;?></title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='page-header'>
                    <h1 class='pull-left'>
                      <i class='icon-male'></i>
                      <span>View Language Labels</span>
                    </h1>
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Pages and Sections Management</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Pages and Sections Management</div>

                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>language_library/addPagesForm"> <button class='btn' style='margin-bottom:5px'  ><i class='icon-male'></i> Add New Page</button></a>
				...
				<th>Actions</th>
                            ...
                            <tbody>
                              ...
                              <?php  if(!empty($pages)){ $c=1;foreach($pages as $page){?>
                              <tr>
                                <td><?php echo $c;?></td>
				...
				<a class='btn btn-info btn-xs has-tooltip' data-placement='top' title='Edit User' href='<?php echo WEB_URL; ?>language_library/getOneLanguagePage/<?=$page->id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
				 <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Delete' href='<?php echo WEB_URL; ?>language_library/deleteOneLanguagePage/<?=$page->id;?>'>
