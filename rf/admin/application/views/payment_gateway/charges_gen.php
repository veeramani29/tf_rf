...
<html>
<head>
    <title>Add New Payment Gateway Charges | <?php echo PROJECT_NAME;?></title>
  ...
  <body class='contrast-dark fixed-header'>
          ...
          <div class='row' id='content-wrapper'>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='page-header'>
                    <h1 class='pull-left'>
                      <i class='icon-plus'></i>
                      <span>Add New Payment Gateway Charges</span>
                    </h1>
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li>
                         <a href="<?php echo WEB_URL; ?>payment"> Payment Gateway Charges Management</a>
                        </li>
                        <li class='separator'>
                          <i class='icon-angle-right'></i>
                        </li>
                        <li class='active'>Add Generic Charges</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Add Generic Payment Gateway Charges</div>
                      <div class='actions'>
                        <a class="btn box-collapse btn-xs btn-link" href="#"><i></i></a>
                      </div>
                    </div>
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>payment/save_charges" method="post"  enctype="multipart/form-data"> 
			...
			<div class='form-group'>
			      ...
			      <option value="">Select Product</option>
                        ...
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='markup'>Charges</label>
                          <div class='col-sm-4 controls'>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>payment"><button class='btn btn-primary' type='button'>
	...
	$(document).ready(function(){
		...
		function isProductExists(val){
			...
			type:"POST",
			data:data,
			url:url+"isPaymentProductExists",
			dataType:"JSON",
			success:function(res){
				if(res.status=='1'){
					...
					setTimeout(function(){window.location.href=$("#thisController").val();},2000);
					return false;
				}
			}		
			});
