                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>payment/update" method="post"  enctype="multipart/form-data"> 
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control'  data-rule-number='true' data-rule-required='true' id='markup' name='markup' placeholder='Charges' type='text' value="<?=$result->markup;?>">
                          </div>
                        </div>
