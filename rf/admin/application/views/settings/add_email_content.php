	...
	<div class="container-fluid">
		<div class="content">
			...
			<div class="span12">
					<div class="box">
						<div class="box-head">				
				<form action="<?php echo WEB_URL; ?>home/insert_email_content" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="control-group">
										...
										<div class="controls">
											...
											?>
												<option value="<?php echo $value->domain_id; ?>"><?php echo $value->domain_name; ?></option>
											<?php } } ?>
											</select>
										</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="footer_left" class='span12 cleditor'></textarea>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="footer_right" class='span12 cleditor'></textarea>
									</div>
								</div>
