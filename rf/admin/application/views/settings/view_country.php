...
<html>
<head>
    <title>Country Management | <?php echo PROJECT_NAME;?></title>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Country Management</div>

                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>home_settings/add_country"> <button class='btn' style='margin-bottom:5px'><i class='icon-globe'></i> Add New Country</button> </a>
                      ...
                      <div class='responsive-table'>
                        <div class='scrollable-area'>
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                              <?php if(!empty($countrydata)){ $c=1;foreach($countrydata as $country){?>
                              <tr>
                                <td><?=$c;?></td>
                                ...
                                <td>
                                  <div class='text-right'>
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='Edit Country' href='<?php echo WEB_URL; ?>home_settings/edit_country/<?=$country->country_id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
                                 <!--    <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Delete' href='<?php echo WEB_URL; ?>home_settings/delete_country/<?=$country->country_id;?>'>
