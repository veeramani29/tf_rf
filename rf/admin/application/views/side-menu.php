      ...
      else
      {
        ...
        <!--    <li class='<?php if($controller == 'payment' && $method == 'index'){echo'active';}?>'>
          ...
          <li class='<?php if($controller == 'language_library'){echo'active';}?>'>
            ...
            <li class='<?php if($controller == 'discount'){echo'active';}?>'>
              <a href='<?php echo WEB_URL; ?>discount' class="dropdown-collapse">
                <i class='icon-link'></i><span>Discounted Or  Offers</span><i class="icon-angle-down angle-down"></i>
              </a>
              <ul class='<?php if($controller == 'discount'){echo'in';}?> nav nav-stacked'>
                <li class='<?php if($controller == 'discount'){echo'active';}?>'>
                  <a href='<?php echo WEB_URL; ?>discount'>
                    <i class='icon-link'></i>
                ...
                <li class='<?php if($controller == 'discount' && $method == 'add_new_offer'){echo'active';}?>'>
