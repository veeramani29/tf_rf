...
class Home extends CI_Controller {
	...
	public function cruise_line_image()
	{
	
		$data['image_line'] = $this->general_model->image_line();
		$data['image_text'] = $this->general_model->line_text();
		$data['line_text'] = $this->general_model->linefull_text();
		//echo "<pre>";print_r($data['line_text']);
		$this->load->view('cruiselines/api_view',$data);
		#$this->load->template('mainadmin/cruise_line_image',$data);
	...
	function update_password(){
		...
		if($r_info->password == md5($this->input->post('cpass')))
		{
