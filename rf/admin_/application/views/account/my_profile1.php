			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						...
						?>
							<form action="<?php echo WEB_URL; ?>home/update_profile" method="post" class="form-horizontal">
								...
								<div class="tab-pane active" id="basic">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<a href="<?php echo WEB_URL; ?>home/change_password" class="btn-danger btn">New password</a>
