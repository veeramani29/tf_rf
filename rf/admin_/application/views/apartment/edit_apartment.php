                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>apartment/upate_apt" method="post"> 
                          ...
                          <div class='col-sm-4 controls'>
                                  ...
                                  <div class='col-sm-6'>
                                    <div class='input-group'>
                                      <input type="hidden" value="<?php  echo $result6->apartment_type_id; ?>" name="id">
                                      <input type="text" name="apartment" value="<?php  echo $result6->apartment_type; ?>" ?>
