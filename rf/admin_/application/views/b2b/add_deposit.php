...
<html>
<head>
    <title>Deposit Agent Amount| <?php echo PROJECT_NAME;?></title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='page-header'>
                    <h1 class='pull-left'>
                      <i class='icon-male'></i>
                      <span>Deposit Agent Amount</span>
                    </h1>
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Deposit Agent Amount</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Deposit Agent Amount</div>
                      <div class='actions'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>deposit/add_deposit_amount/<?php echo $id; ?>" method="post"  enctype="multipart/form-data"> 
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='amount'>Amount Deposited</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-number='true' data-rule-required='true' id='amount' name='amount' placeholder='Amount' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='amount'>Deposited Date</label>
                          <div class='datepicker-input input-group col-sm-4' >
                            <input id='datepicker' class='datepicker-input form-control' data-format='MM/DD/YYYY' placeholder='MM/DD/YYYY' name="deposited_date" type='text'>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <textarea class='form-control' data-rule-required='true' id='validation_remarks' placeholder='Remarks' name='remarks' rows='3'></textarea>
                          </div>
                        </div>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>deposit/agent_deposit_view/<?php echo $id; ?>"><button class='btn btn-primary' type='button'>
