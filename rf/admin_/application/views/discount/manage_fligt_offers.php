              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='page-header'>
                    <h1 class='pull-left'>
                      <i class='icon-male'></i>
                      <span>Discounted Flight & Hotel</span>
                    </h1>
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Discounted Flight & Hotel</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Discounted Flight & Hotel Management</div>
				...
				?>
                              <tr>
                                <td><?=$c;?></td>
                                 <td><?=$p->offer_for; ?></td>
                                <td><?=$p->origin; ?></td>
                                <td><?=($p->destination!=null)?$p->destination:'-';?></td>
                                 <td><?=$p->price;?></td>
                                <td><?=$p->to_date;?></td>
                                <td><?=$p->exp_date;?></td>
                                 <td>
