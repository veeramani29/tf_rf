                ...
                <div class='box-content box-no-padding'>
                  <div class='responsive-table'>
                    <div class='scrollable-area'>
                      ...
                      <?php if (!empty($b2b_sub_list)) { ?>
                        <?php foreach ($b2b_sub_list as $users) { ?>
                      ...
                      <div class='actions' align="">
                        ...
                        <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                          ...
                          <tbody>
                            <?php if (!empty($b2b_sub_list)) {
                              $c = 1;
                              foreach ($b2b_sub_list as $users) { ?>
                              <tr>
                                <td><?= $c; ?></td>
                                <td><?php echo $users->email_id; ?></td>
                                <td>
                                  <a class="btn btn-danger btn-xs has-tooltip" onclick="return confirm('Are you sure?')" data-placement="top" title="" href="<?php  echo WEB_URL.'newsletter/b2b_deleteSubscriber/'.$users->agent_id; ?>" data-original-title="Delete subscriber">
