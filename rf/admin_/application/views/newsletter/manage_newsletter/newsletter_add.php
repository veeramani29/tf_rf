...
<style type="text/css">
    ...
    <title>Add Newsletter | <?php echo PROJECT_NAME;?></title>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form role="form" method="post" class="form-horizontal edit_email" action="<?php echo WEB_URL; ?>newsletter/save_newsletter/" enctype="multipart/form-data">                                                               
                                    <div class="form-body">                                   
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Template Name</label>
                                                <div class="col-md-4">
                                                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter Template name" name="template_name" value="" />
                                                </div>
                                        </div>
