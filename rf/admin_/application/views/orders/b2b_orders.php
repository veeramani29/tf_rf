                            ...
                            <div class='row'>
                                <div class='col-sm-12'>
                                    ...
                                    <ul class="nav nav-responsive nav-tabs"><li class="dropdown pull-right tabdrop hide"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="icon-align-justify"></i> <b class="caret"></b></a><ul class="dropdown-menu"></ul></li>
                                        <li id="apartments" class="active"><a data-toggle="tab" href="#retab1"><i class="icon-build"></i> Apartments</a></li>
                                        <li id="flights" class=""><a data-toggle="tab" href="#retab2"><i class="icon-flight"></i> Flights</a></li>
