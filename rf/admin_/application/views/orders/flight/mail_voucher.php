<div class="full marintopcnt contentvcr" id="voucher">
    <div class="container">
        ...
        <div class="centervoucher2">
            ...
            <div class="col-md-6" style="float: right; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
            	<div style="color: #666; display: block; line-height: 20px; overflow: hidden; text-align: right;">
                	<?php if($Booking->user_type == '3'){?>
  ...
  <tr>
    ...
    <div class="dterser">
        ...
        DEPARTURE:
        <?php echo date('D, d M', $this->manage_orders_model->get_unixtimestamp($segment->DepartureTime));?>
        </div>
        <div class="snotes">
  ...
  <tr>
    ...
    <div class="padwithbord">
        ...
        <?php echo $this->manage_orders_model->get_airline_name($segment->Carrier);?> <br />
        ...
        <div class="opfligt">Duration: <strong><?php echo $this->manage_orders_model->get_duration($this->manage_orders_model->get_unixtimestamp($segment->DepartureTime),$this->manage_orders_model->get_unixtimestamp($segment->ArrivalTime));?></strong></div>
    </div>
  </td>
    
    <td bgcolor="#FFFFFF" style="border-bottom:1px solid #EEE; border-right:1px solid #EEE;">
    <span style="font-size:16px; font-weight:bold;"><?php echo $segment->Origin;?></span><br><?php echo $this->manage_orders_model->get_airport_name($segment->Origin);?>
    </td>
    <td bgcolor="#FFFFFF" style="border-bottom:1px solid #EEE; border-right:1px solid #EEE;"><span style="font-size:16px; font-weight:bold;"><?php echo $segment->Destination;?></span><br><?php echo $this->manage_orders_model->get_airport_name($segment->Destination);?></td>
...
Stop(s): 0</td>
  ...
  <tr>
    <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;">Departing At:<br><span style="font-size:16px; font-weight:bold;"><?php echo date('d M, D Y H:i', $this->manage_orders_model->get_unixtimestamp($segment->DepartureTime));?></span><br></td>
    <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;">Arriving At:<br><span style="font-size:16px; font-weight:bold;"><?php echo date('d M, D Y H:i', $this->manage_orders_model->get_unixtimestamp($segment->ArrivalTime));?></span><br>
</td>
    </tr>
        </tbody></table>
...
<li>Your e-ticket details will be sent to the email address provided by you at the time of booking. If you do not receive your e-ticket within 8 hours of making your booking with <?php echo PROJECT_NAME;?>.com, please call our Customer Care Representative on 1234567890.
</li>
