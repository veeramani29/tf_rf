...
<html>
<head>
    <title>Update Sub-Admin | <?php echo PROJECT_NAME;?></title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='page-header'>
                    <h1 class='pull-left'>
                      <i class='icon-ok'></i>
                      <span>Update Admin Privileges</span>
                    </h1>
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Update Admin Privileges</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>privileges/update_privileges/<?php echo $admin->user_id;?>" method="post"> 
                       ...
                       <div class='form-group'>
                        ...
                        //  echo '<pre>';print_r($privileges);
                          ...
                          ?>
                            ...
                            <label class='checkbox-inline'><input type='checkbox' value='<?=$priv->id;?>' name="privilege[]" <?php if (in_array($priv->id, $modules)) {echo 'checked';}?>><?=$priv->privilege;?></label>
                            <?php $c++;}?>
                          </div>
                        </div>
