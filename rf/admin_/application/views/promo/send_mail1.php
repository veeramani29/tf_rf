				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content">
							<form action="<?php echo WEB_URL; ?>promo/send_mail_user_new/<?php echo $id; ?>" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>
								<div class="control-group">
									<label for="req" class="control-label">Subject</label>
									<div class="controls">
												<input type="text"  name="subject"   id="req" class='required'>
									</div>
								</div>
                            		<div class="control-group">
										<label for="tags" class="control-label">Email Id</label>
										<div class="controls">
											<input type="text" id="tags" value="" name="emailid" class='tagsinput span12'>
										</div>
									</div>
                                    
                                    <div class="control-group">
												<label for="check2" class="control-label">Users</label>
												<div class="controls">
													<label class="checkbox"><input type="checkbox" class='uniform' name="b2c" id="check2"> B2C All User </label>
													<label class="checkbox"><input type="checkbox" name="b2b" class='uniform'> B2B All User</label>
												</div>
											</div>
