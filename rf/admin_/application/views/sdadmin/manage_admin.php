...
<html>
<head>
    <title>Manage Sub-Admin | <?php echo PROJECT_NAME;?></title>
                      ...
                      <div class='responsive-table'>
                        <div class='scrollable-area'>
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                              <?php if(!empty($admin)){ $c=1;foreach($admin as $subadmin){?>
                              <tr>
                                <td><?=$c;?></td>
                                <td><?=$subadmin->firstname;?></td>
                                <td><?=$subadmin->email;?></td>
                                <td><?=$subadmin->domain_name;?></td>
                                <!-- <td><?=$subadmin->address;?></td> -->
                                <td><?=$subadmin->contact_no;?></td>
                                <td>

                                  <?php if($subadmin->status == '1'){?>
                                    <a href="<?php echo WEB_URL; ?>sdadmin/change_admin_status/<?php echo $subadmin->user_id; ?>/0">
                                      <span class='label label-success'><i class="icon-ok"></i> Active</span>
                                    </a>
                                  <?php }else{?>
                                    <a href="<?php echo WEB_URL; ?>sdadmin/change_admin_status/<?php echo $subadmin->user_id; ?>/1">
                                      <span class='label label-success'><i class="icon-remove-circle"></i> Deactive</span>
                                    </a>
                                  <?php }?>
                                </td>
                                <td>
                                  <div class='text-right'>
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='Edit' href='<?php echo WEB_URL; ?>sdadmin/edit_admin/<?=$subadmin->user_id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
