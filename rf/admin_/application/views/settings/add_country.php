...
<html>
<head>
    <title>Add New Country | <?php echo PROJECT_NAME;?></title>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>home_settings/add_country" method="post"  enctype="multipart/form-data"> 
                        <div class='form-group'>
                         ...
                         <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control'  data-rule-required='true' id='country_name' name='country_name' placeholder='Country Name' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='phonecode'>Phone Code</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-required='true' id='phonecode' name='phonecode' placeholder='Phone Code' type='text'>
                          </div>
                        </div>
