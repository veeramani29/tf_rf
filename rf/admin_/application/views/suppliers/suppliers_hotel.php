                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      ...
                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>supplier/add_supplier_hotel/<?php echo $id; ?>"> <button class='btn' style='margin-bottom:5px'><i class='icon-plus'></i> Add New Hotel</button></a>
                       <a  href="#"><i> &nbsp</i></a>
                      </div>
                              ...
                              <th>S.no</th>
                       			...
                       			<tbody>
											...
											<tr>
												...
												<td class="center">
											 	<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title=""  href="<?php echo WEB_URL; ?>supplier/delete_hotels_to_supplier/<?php echo $value->supplier_hotels_id; ?>/<?php echo $value->supplier_id; ?>"  data-original-title="Remove this Hotel">
