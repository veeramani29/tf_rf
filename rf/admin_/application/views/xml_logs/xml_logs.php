...
<html>
    <head>
        <title>XML Logs | <?php echo PROJECT_NAME;?></title>
                                ...
                                <div class='col-sm-12'>
                                    <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                                        <div class='box-header blue-background'>
                                            <div class='title'>XML Logs</div>
                                        </div>
                                        <div class='box-content box-no-padding'>
                                            <div class='responsive-table'>
                                                <div class='scrollable-area'>

                                                    <form method="post" id="myform" action="<?php echo base_url(); ?>xml_logs/export_all_xml_logs"  onsubmit="return checkForm(this);">
								    ...
								    <th>Actions</th>
                                                            ...
                                                            <tbody>
                                                                <?php if (!empty($xml_logs)) {
                                                                    $c = 1;
                                                                    foreach ($xml_logs as $xml_log) { ?>
                                                                        <tr>
                                                                            <td><?= $c; ?></td>
                                                                            <td><?php echo $xml_log->Api; ?></td>
									    <td><?php echo $xml_log->XML_Type; ?></td>
									    <td><?php echo $xml_log->Ip_address; ?></td>
									    <td><?php echo date('j M Y',strtotime($xml_log->XML_Time));?></td>
									    <td>
									     <a class='btn btn-inverse btn-xs has-tooltip' data-placement='top' title='See the xml request' href='<?php echo base_url(); ?>xml_logs/export_xml_log_request/<?php echo $xml_log->XML_logs_id; ?>' role='button'>
                                                                                        <i class='icon-search'></i>
                                                                              </a>
										<a class='btn btn-inverse btn-xs has-tooltip' data-placement='top' title='See the xml response' href='<?php echo base_url(); ?>xml_logs/export_xml_log_response/<?php echo $xml_log->XML_logs_id; ?>' role='button'>
                                                                                        <i class='icon-search'></i>
                                                                              </a>
									   </td>
                                                                        </tr>
