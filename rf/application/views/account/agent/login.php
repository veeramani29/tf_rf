...
<div class="centerfix">
  ...
  <div  class="pophed"><?php echo $this->lang->line('AL_Reset'); ?></div>
    <div class="signdiv">
        <form id="resetpwd" name="resetpwd" action="<?php echo WEB_URL;?>/account/resetpwd">
           <div class="ritpul"> 
              ...
              <div class="clear"></div>
              <div class="dntacnt"><?php echo $this->lang->line('AL_Suddenly'); ?>
    ...
    <div  class="pophed"><?php echo $this->lang->line('AL_SignIn'); ?></div>
            ...
            <div class="insigndiv">
             <form id="Agentlogin" name="Agentlogin" action="<?php echo WEB_URL;?>/agent/loginn">
               <div class="ritpul"> 
                  ...
                  <div class="rowput">
                    <span class="icon icon-lock"></span>
                      <input class="form-control logpadding" type="password" name="password" placeholder="<?php echo $this->lang->line('AL_EPass'); ?>" required>
                  </div>
                  <div class="misclog">
      ...
      <div class="wrapdivs" id="agentVerification" style="display: none;"> 
        ...
        <div class="signdiv" style="position: relative">
          <div id="AgntVeriContact" class="lodrefrentrev imgLoader">
            ...
            <div class="insigndiv">
              <form id="AgentVerify" name="AgentVerify" action="<?php echo WEB_URL;?>/agent/verifyContactDetails" method="post">
                 <div class="ritpul"> 
                    <span>
      ...
      <div id="messageAdminPopup" style="border: 1px solid black; background: #fff; display: none">
        <div class="popuphed">
