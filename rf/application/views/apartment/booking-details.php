...
?>
<style type="text/css">
 .container_flightdetails .fd_buttons li button{
          ...
          <div class="col-sm-12 nopadd">
            ...
            <?php if(isset($pnr_nos) && $pnr_nos!='') {
              ...
              <li role="presentation" class="<?=$disable;?>">
                <a class="tarifs_show" which-type="<?php echo $module;?>" href="#tarifs" aria-controls="home" role="tab" data-toggle="<?=$toggle;?>"><?php echo lang_line('TARIFS');?></a>
              </li>
              <li role="presentation" class="<?=$disable;?> <?php echo ($this->uri->segment(3)=='' && $this->input->get('orderId')=='')?"active":"";?>">
                <a href="#information" id="backbut1" aria-controls="profile" role="tab" data-toggle="<?=$toggle;?>"><?php echo lang_line('UR_INFO');?></a>
              </li>
              <li role="presentation" class="<?=$disable;?> <?php echo ($this->uri->segment(3)!='' && $this->input->get('orderId')=='')?"active":"";?>">
                <a href="#overview" aria-controls="messages" role="tab" data-toggle="<?=$toggle;?>"><?php echo lang_line('OVER_VIEW_PAY');?></a>
              </li>
...
$total_markup=$cart->VissibleOthersMarkup;
                      ...
                      <input type="hidden" id="c_ids" value="<?=$cid;?>"></input>
                       ...
                       <div class="col-xs-6 nopadd fd_name">
                        <div class="col-xs-2 padd_r">
                          ...
                          <select class="form-control full_width input_caretdown" name="selTitle<?php echo $cid;?>" id="selTitle<?php echo $cid;?>" required>   
                            ...
                            <?php if($this->session->userdata['language']!='dutch'):?>
                        ...
                        <!---->
                      <input type="hidden" value="<?php echo $this->session->userdata('b2c_id');?>" id="customerid"></input>
                       <input type="hidden" value="<?php echo $cid;?>" id="cartsid"></input>
                       <!------>
                        <div class="col-xs-4">
                      ...
                      <div class="col-xs-4 padd_r">
                        ...
                        <ul class="list-inline fd_dateob mar0">
                          ...
                          ?>
                          <li class="date">
                            <select class="form-control input_caretdown" name="birth_day<?php echo $cid;?>" id="birth_day<?php echo $cid;?>" required style="width:70px !important;">
                        ...
                        <div class="well well_transparent">
                          ...
                          foreach($pass_result as $key=>$value){
                            ...
                            <div class="col-xs-12 nopadd">
                              <h5>
                                <?php //echo lang_line('TRAVELLER');?> 
                                <?php if($this->session->userdata['language']!='dutch'){  
                                 echo substr(ucfirst($key), 0, -1)." ".$sno; 
                                  }else{
                                    if($key=="childs"){
                                       echo 'Kind '.$sno;
                                      }
                ...
                <div class="col-xs-3 fd_housezip">
                  <ul class="list-inline">
                    <li class="form-group nopadd col-xs-7">
                    ...
                    <li class="form-group nopadd col-xs-5">
                ...
                <!-- <div class="form-group  fd_phnumber">
                ...
                <div class="form-group fd_company">
                ...
                <div class="col-xs-4 pull-right fd_btns">
                  <ul class="normal-list fd_buttons text-right">
                    ...
                    <li><button type="button" id="backbutton" target="tarifs" which-type="<?php echo $module;?>" class="btn btn-secondry btn_inputs tested tarifs_show"><?php echo lang_line('BACK');?></button></li>
                    <li>
                    <?php /*?><button id="nextstep" target="overview" type="<?php echo ($this->uri->segment(3)!='' || $this->input->get('orderId')!='')?"button":"submit";?>" class="btn btn-primary btn_inputs <?php echo ($this->uri->segment(3)!='' || $this->input->get('orderId')!='')?"tested":"";?>"><?php echo lang_line('NEXT_STEP');?></button><?php */?>
                    <button id="nextstep"
              type="submit" class="btn btn-primary btn_inputs <?php echo ($this->uri->segment(3)!='' || $this->input->get('orderId')!='')?"tested":"";?>"><?php echo lang_line('NEXT_STEP');?></button></li>
        ...
        <p style="color: #D20B0B;
    font-size: 16px;
    padding-top: 50px;
    text-align: center;"><?php echo lang_line('COMPLETE_PREV_STEP');?></p><?php }else{?> <div class="col-xs-12">
                <div class="spacer30"></div>
        <ul class="list-inline overview_pay">
                    ...
                    if($request->type!=''){
                      if($request->type=='R'){
                        ...
                        foreach($response_details->segments as $multisegments){
                          ...
                          <li class="text-uppercase col-xs-12"><?php if($v==0) { ?><b><?php echo lang_line('MULTI_CITY');?></b> <?php } echo ($vv)."<sup>".$range."</sup>"."&nbsp;".lang_line('FLIGHT');?></li>
                          <li class="col-xs-12">
              ...
              <li class="col-xs-3 flightbook_subtotal">
                ...
                <?php if(array_sum($childs_total)!=0){ ?>
                <p><?php echo CURR_ICON.' '.(array_sum($child_total_price));?></p>
                <?php }  if(array_sum($infants_total)!=0){?>
                <p><?php echo CURR_ICON.' '.(array_sum($infant_total_price));?></p>
                <?php } ?>
              </li>
               <li class="full_width">
                <div class="col-xs-6">
                  <h5 class="total_text">Booking Fee</h5>
                </div>
                <div class="col-xs-6">
                  <h5><?php echo CURR_ICON.' '.($total_markup);?></h5>
                </div>
              </li>
              <li class="total full_width">
                ...
                <div class="col-xs-6">
                   <h5><?php echo CURR_ICON.' '.(array_sum($TaxPrice) + array_sum($BasePrice) +$total_markup);?></h5>
                </div>
        ...
        <li class="col-sm-3">
          <p>
         <?php 
         $getcountryname=$this->cart_model->showcountryname($checkout_user['country']);
         echo $getcountryname[0]->name;
        // $Defaultselect2=($userInfo->billing_country!='')?$getcountryname[0]->name:"NL"; ?> 
            <br/>
             <?php 
         if(!empty($checkout_user['txtcmpnyname']))
         {
          echo $checkout_user['txtcmpnyname'];
          }
          else{ echo 'N/A';}
         ?>
          </p>
      ...
      <div class="col-sm-12 nopadd">
            <div class="ft_paymentradio">
             ...
             <div class="col-sm-12 col-md-9 nopadd ft_paymentradio">
                <div class="col-xs-4">
                  <div class="radio-inline ">
                    ...
                    <label for="payment_type1">
                      ...
                      <?php echo lang_line('IDEAL');?> <?php echo lang_line('TRANSECTION_IDEAL_MSG');?>
                    </label>
                  </div>
                </div>
                <?php } ?>
                <div class="col-xs-4">
                  <div class="radio-inline ">
                    <input type="radio" name="payment_type"  id="payment_type1" class="triprad iradio_flat-blue" value="CreditCard"  />        
                    <label for="payment_type1">
                      <!--<span class="fa-stack">
                        <i class="fa fa-circle fa-stack-1x circle"></i>
                        <i class="fa fa-circle fa-stack-1x circle-yellow"></i>
                      </span>-->
                      <?php echo lang_line('CREDIT');?> <?php echo lang_line('TRANSECTION_CREDIT_CARD');?>
                    </label>
                  </div>
                </div>
            ...
            <!--   <p style="text-decoration:blink;color:green;"><b>Note :</b> You need to pay extra transection amount for (iDEAL 0% from total amount or CreditCard 3% from total amount)</p> -->
            </div>
            <?php } ?>
            <?php if($module!='FLIGHT'){ ?>
            ...
            <div class="col-xs-12 col-sm-3">
              <ul class="normal-list fd_buttons text-right" >
                <li>
                  <button type="button" target="information"  class="btn btn-secondry btn_inputs tested" id="backbut"><?php echo lang_line('BACK');?></button>
                </li>
                <?php if($this->uri->segment(3)!=''){
                  if($this->input->post('payment_type')==null) { 
                    ?>
                    <li><button  type="submit" class="btn btn-primary btn_inputs" ><?php echo lang_line('NEXT_STEP_OPTION');?></button></li>
                    <?php } }else{ ?>
                    <li><button target="confirmation" type="button" class="btn btn-primary btn_inputs tested" ><?php echo lang_line('NEXT_STEP_OPTION');?></button></li>
                    <?php } ?>
                  </ul>
                </div>
              </form>
...
$oredeid=$this->uri->segment(2);

$finalurl=WEB_URL."/booking/".$oredeid;
}
?>
...
jq.validator.addMethod("check_date_of_birth", function(value, element) {

   
    var day = $('#birth_day<?php echo $cid;?>').val();
    var month = $('#birth_month<?php echo $cid;?>').val();
    var year = $('#birth_year<?php echo $cid;?>').val();
    var age =  12;
...
jq("form").validate({
    rules: {
        birth_year<?php echo $cid;?>: { check_date_of_birth: true }
    }
});
</script>
<?php 
if($this->uri->segment(3)!=''){
$id=str_replace('"', '', base64_decode($this->uri->segment(3)));
?>
<script type="text/javascript">
$(document).ready(function(){
...
$.ajax({
       ...
       url:"http://rf.tekhne.nl/flight/delete_data/<?php echo $id;?>",
      beforeSend: function(){
...
<?php if($this->session->userdata('language')!='dutch'){
  $title='Confirmation';
  $message='This will redirect you to the results page. Are you sure you want to continue?';
}else{
    $title='Bevestiging';
  $message='Dit zal je terugbrengen naar de resultatenpagina. Weet je zeker dat je door wilt gaan?';
  }
  ?>
<link rel="stylesheet" type="text/css" href="<?php echo ASSETS;?>/testing/jquery.confirm/jquery.confirm.css" />
<script src="<?php echo ASSETS;?>/testing/jquery.confirm/jquery.confirm.js"></script>
<script>
 $(document).ready(function(){
  ...
  $('.tarifs_show').click(function(){
    ...
    $.confirm({
      ...
      'message' : '<?=$message;?>',
      'buttons' : {
        '<?php echo lang_line('ACCEPT_BACK');?>'  : {
          'class' : 'blue',
          'action': function(){
            //elem.slideUp();
  ...
  var data_toggle=$('.tarifs_show').attr('data-toggle');
 // alert($('.tarifs_show').attr("which-type"));
  if(len==0 && data_toggle!=''){

    if($('.tarifs_show').attr("which-type")=="FLIGHT"){
      $.ajax({
       type:'GET',
    ...
    }else if($('.tarifs_show').attr("which-type")=="HOTEL"){
     $.ajax({
       type:'GET',
      async: true,
      cache: false,
...
<?php //echo $this->session->userdata['session_data']['bookingid'];//print_r($this->session->userdata);?>
<?php if($this->uri->segment(3)!=''){?>
<!--<script>
...
{
    var postData = $("#checkout-apartment").serialize();
  //alert(postData);
  //exit;
    var formURL = $(this).attr("action");
    $.ajax(
    {
        url : 'http://rf.tekhne.nl/flight/custom_update',
        type: "POST",
        data : postData,
