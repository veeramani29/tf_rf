    ...
    <div class="container nopadd container_indexpage item active">
      <div class="col-md-9">
        <div class="fullwidthbg_image">
          <img src="<?=ASSETS?>images/FACTORY_RF-03.svg" class="factory_imageindex2 visible_large">
              ...
              <form class="form-inline flight_form" name="flight" method="post" id="flight" action="<?php echo WEB_URL;?>/flight/search_flight" autocomplete="off">
                ...
                <div class="normal">
                  ...
                  <div class="form-group col-xs-3 padd_l">
                    ...
                    <input type="text" class="form-control full_width input_calender first" name='depature' id="depature" placeholder="<?php echo lang_line('DATEPLACEHOLDER');?>" value="" required readonly>
                  </div>
                  <div class="form-group col-xs-3 sm2paddl0 sm3paddr0">
                    <label> <?php echo lang_line('RETURNING');?></label><br>
                    <input type="text" class="form-control full_width input_calender second" id="return" name='return' placeholder="<?php echo lang_line('DATEPLACEHOLDER');?>" value="" required readonly>
                  </div>
                ...
                <div class="multicity" style="display:none;">
                  ...
                  <div class="form-group col-xs-3 padd_l">
                    <label><?php echo lang_line('DEPARTING');?></label><br>
                    <input type="text" class="form-control full_width input_calender" name='mdepature[0]' id="multi-departure" placeholder="<?php echo lang_line('DATEPLACEHOLDER');?>"   required>
                  </div>
                  ...
                  <div class="form-group col-xs-6 col-sm-10 padd_l  smpaddr0" id=''>
                    <ul class="list-inline miltiflight_list">
                      ...
                      <li class="col-xs-4">
                        <input type="text" class="form-control fromflight full_width input_marker" name='mfrom[1]' placeholder="<?php echo lang_line('FLY_FROM');?>" required>
                      </li>
                      <li class="col-xs-4">
                        <input type="text" class="form-control departflight full_width input_marker" name='mto[1]' placeholder="<?php echo lang_line('FLY_TO');?>" required>
                      </li>
                      <li class="col-xs-4">
                        <input class="form-control input_calender full_width" id="multi-flight2" required name="mdepature[1]" placeholder="<?php echo lang_line('DATEPLACEHOLDER');?>" type="text" />
                      </li>
                    </ul>
                  </div>                  
                  <div class="form-group col-xs-6 col-sm-10 padd_l miltif_listcon smpaddr0 " id='multiflight3'>
                    <ul class="list-inline miltiflight_list">
                      ...
                      <li class="col-xs-4">
                        <input type="text" class="form-control fromflight full_width input_marker" name='mfrom[2]' placeholder="<?php echo lang_line('FLY_FROM');?>" required>
                      </li>
                      <li class="col-xs-4">
                        <input type="text" class="form-control departflight full_width input_marker" name='mto[2]' placeholder="<?php echo lang_line('FLY_TO');?>" required>
                      </li>
                      <li class="col-xs-4">
                        <input class="form-control input_calender full_width" id="multi-flight3" name="mdepature[2]" placeholder="<?php echo lang_line('DATEPLACEHOLDER');?>" type="text" required />
                      </li>
                    </ul>
                  </div>
                  <div class="form-group col-xs-6 col-sm-10 padd_l miltif_listcon smpaddr0" id='multiflight4'>
                    <ul class="list-inline miltiflight_list">
                      ...
                      <li class="col-xs-4">
                        <input type="text" class="form-control fromflight full_width input_marker" name='mfrom[3]' placeholder="<?php echo lang_line('FLY_FROM');?>" required>
                      </li>
                      <li class="col-xs-4">
                        <input type="text" class="form-control departflight full_width input_marker" name='mto[3]' placeholder=" <?php echo lang_line('FLY_TO');?>" required>
                      </li>
                      <li class="col-xs-4">
                        <input class="form-control input_calender full_width" id="multi-flight4" name="mdepature[3]" placeholder="<?php echo lang_line('DATEPLACEHOLDER');?>" type="text" required />
                      </li>
                    </ul>
                  </div>
                ...
                <div class="col-xs-12 padd_l smpaddr0 ff_dropdown">
                          ...
                          <div class="well">
                            <div class="departure_time">
                             <p> <i class="fa fa-mail-forward"></i>  <?php echo lang_line('DEP_TIME');?></p>
                              ...
                              <input type="hidden" name="depMinTime" id="depMinTime" value="" />
                              <input type="hidden" name="depMaxTime" id="depMaxTime" value="" />
                            ...
                            <div class="arival_time">
                              ...
                              <input type="hidden" name="arrMinTime" id="arrMinTime" value="" />
                              <input type="hidden" name="arrMaxTime" id="arrMaxTime" value="" />
                  ...
                  <div class="button_search">
                    <button id='flight_submit_button' name='flight_submit' type="submit" class="btn btn-primary" > <?php echo lang_line('SEARCH');?></button>                    
                  </div>
                </form>
              </div>
            </div>
