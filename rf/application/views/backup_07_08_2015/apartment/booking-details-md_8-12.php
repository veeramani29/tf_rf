...
<div class="container rftarifs_container container_flightdetails">
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="fd_content color_white">
          <div class="col-sm-12 nopadd">
            <ul class="nav nav-tabs fd_tabtitle" role="tablist">
              <li role="presentation" ><a class="tarifs_show" which-type="<?php echo $module;?>" href="#tarifs" aria-controls="home" role="tab" data-toggle="tab"><?php echo lang_line('TARIFS');?></a></li>
            ...
            <div class="tab-content fd_tabcontent">
              ...
              <div class="row">
                <div class="col-md-4">
                  <img style="width:100%;" src="<?php echo $CartHotelImage;?>">
                </div>
                <div class="col-md-8">
          ...
          <div class="form-group col-xs-4 col-sm-3 fd_country">
          ...
          <div class="form-group col-xs-4 col-sm-3 sm2padr0 fd_email">
          ...
          <div class="form-group col-xs-4 col-sm-3 fd_remail">
          ...
          <div class="form-group col-xs-6 col-sm-3 fd_phnumber">
            <label><?php echo lang_line('PHONE_NUM');?> *</label>
            <ul class="list-inline">
              <li class="col-xs-4 col-sm-6">
          ...
          <div class="form-group col-xs-6 col-sm-3 fd_company">
          ...
          <div class="col-xs-4 fd_registered">
      ...
      <div role="tabpanel" class="tab-pane <?php echo ($this->uri->segment(3)!='' && $this->input->get('orderId')=='')?"active":"";?>" id="overview"><!--third tab-->
        ...
        <li class="total full_width">
          ...
          <div class="col-xs-4 nopadd text-right">
      ...
      <li class="col-xs-12 ov_checkbox">
       ...
       <form name="payment" id="payment" method="post" action="<?php echo WEB_URL."/booking/doPaymentGate/".$final_paymentprice."/".$this->uri->segment(3)."/".$email1;?>">
        ...
        <div class="col-sm-12 nopadd">
          ...
          <div class="col-sm-9 nopadd ft_paymentradio">
            <div class="col-xs-4">
          ...
          <?php if($module!='FLIGHT'){ ?>
          <div class="col-sm-9 nopadd <?php echo ($module!='FLIGHT')?'paydiv':'';?>">
    ...
    <div class="col-sm-3 <?php //echo ($module!='FLIGHT')?'col-sm-3':'col-sm-12';?>">
      <ul class="normal-list fd_buttons text-right" >
        <li>
