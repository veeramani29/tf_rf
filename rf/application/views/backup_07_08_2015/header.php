...
?>
 ...
 <link rel="stylesheet" href="<?php echo ASSETS;?>css/validation.css" rel="stylesheet" />
...
$(document).ready(function(){
    ...
    $(".cboxClose1").click(function(){
      ...
      $(".example10").colorbox({width:"375px", height:"auto", inline:true, href:"#inline_example14"});
        ...
        <div class="popup_detail form">
          <div class="banner_signup">
            ...
            <form name="usermyaccount" id="usermyaccount" action="<?php echo WEB_URL;?>/account/create" method="post">
              ...
              <div>
              <input type="text" id="mname" name="mname"  placeholder="Middle Name"   class="book_txt " style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;"  />
              </div>
                <div>
...
<div id="perspective" class="perspective effect-moveleft">
 ...
 <div class="onlyapart offset-0">
  <!-- Navigation-->
	...
	<a href="<?php echo WEB_URL;?>" class="navbar-brand myband"><img style="height:40px;" src="<?php echo ASSETS;?>images/logo.png" alt="<?php echo $this->lang->line('H_logo_title'); ?>" class="img-responsive" /></a>
	</div>
...
<?php  if($this->router->fetch_method()!="signup_login" && $this->session->userdata("user_type")==''){
	...
	<div class="navbar-collapse collapse col-xs-4 filcols nopad margtop5">
