...
$VehicleKeywordRes = str_replace('common_v31_0:Keyword','Keyword',$VehicleKeywordRes);
...
if(isset($VehicleKeywordRes->Body->VehicleKeywordRsp)){
    ...
    if(!isset($VehicleKeywordRes['SOAP:Body']['SOAP:Fault']) && $VehicleKeywordRes != ''){
        $keywords = $VehicleKeywordRes['SOAP:Body']['vehicle:VehicleKeywordRsp']['common_v31_0:Keyword'];
    }
}else{
  $keywords = '';
}
...
?>
  <div class="parapop">
  <?php if(isset($keyword['common_v31_0:Text'])){?>
  	<h4 class="smlpopl"><?php echo $Name;?> (<?php echo $Description;?>)</h4>
    <p>
    <?php 
      foreach ($keyword['common_v31_0:Text'] as $key => $Text) {
        echo $Text.' ';
      }
    ?>
    </p>
