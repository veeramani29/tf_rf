			...
			<div class="container">
				...
				<div class="panel panel-default df">
					<div class="panel-heading">
						<div class="clearfix">
							...
							<div class="pull-right">
								<?php  $fli_img=explode(",", $flight_img[0]['airline_code']); ?>
								<img src="<?php echo ASSETS;?>images/airline_logo/<?php echo $fli_img[0] . '.gif'; ?>" alt="<?php  echo $fli_img[0];  ?>">
							<br>
							<?php echo $this->flight_model->get_airline_name($fli_img[0]);?>
							</div>
						</div>
					</div>
					<div class="panel-body">
						...
						<input  type="hidden" value="Economy" name="class">
