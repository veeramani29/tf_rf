									...
									foreach ($flex_air_segment_date as $key => $value) {
										...
										if($value == '0'){
											...
											<li style="padding: 0 2px;">
												<a href="javascript:void(0);"><span jt="onward"></span>
													...
													<div class="col-sm-9 col-md-10 padding-left-null">
														<div class="graph-date">
															<ul class="first">
																...
																<li style="border-right: 1px solid silver; width: 169px !important; height: 120px !important;">
																	...
																	<ul class="second">
																		...
																		<li>
																			...
																			<div class="clearfix">
                                        <br>
																				<img src="<?php echo ASSETS;?>images/airline_logo/<?php echo $flight_image;?>.gif" alt="" class="pull-left">
																			</div>
																		</li>
																		<?php $img++;} ?>
																	</ul>
