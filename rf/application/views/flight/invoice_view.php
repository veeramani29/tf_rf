...
<div class="full marintopcnt contentvcr" id="voucher">
    <div class="container">
        ...
        <div class="centervoucher2">
        	...
        	<div class="col-md-6">
                    ...
                    <img src="<?php echo ASSETS;?>images/logo.png" alt="RF Logo" />
  ...
  <tr>
    ...
    <div class="padwithbord">
        ...
        <div class="opfligt"><?php echo lang_line('DURATION');?>: <strong><?php echo $this->flight_model->get_duration($this->flight_model->get_unixtimestamp($segment->DepartureTime),$this->flight_model->get_unixtimestamp($segment->ArrivalTime));?></strong></div>
    </div>
	</td>
    ...
    <td width="25%" rowspan="2" bgcolor="#FFFFFF"><?php echo lang_line('AIRCRAFT');?>:<br><?php echo $segment->Equipment;?> <br><br>
      <?php echo lang_line('BOOK_CLASS');?>: <?php echo $segment->CabinClass;?></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;"><?php echo lang_line('DEPART_AT');?>:<br><span style="font-size:16px; font-weight:bold;"><?php echo date('d M, D Y H:i', $this->flight_model->get_unixtimestamp($segment->DepartureTime));?></span><br></td>
    <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;"><?php echo lang_line('ARRIVAL_AT');?>:<br><span style="font-size:16px; font-weight:bold;"><?php echo date('d M, D Y H:i', $this->flight_model->get_unixtimestamp($segment->ArrivalTime));?></span><br>
</td>
    </tr>
        </tbody></table>
...
<?php echo lang_line('BOOK_CLASS');?>: <?php echo $segment->CabinClass;?></td>
  ...
  <tr>
    ...
    <div class="padwithbord">
        ...
        <div class="opfligt"> <?php echo lang_line('OPERATED_BY');?>: <strong><?php echo ($segment->OperatingCarrier != "") ? $segment->OperatingCarrier : "-";?></strong></div>
