...
<?php if($req->type!='M' && (isset($req->days) && $req->days==1)){ ?>
         ...
         <div class="row hideDiv" id="chartSearch">
          <form class="custom show-search-options position-left" method="post" name="extradays_flight" id="extradays_flight" action="<?php echo WEB_URL;?>/flight/search_flight" accept-charset="UTF-8" novalidate>
...
<div class="htlmod collapse" id="modhtl">
  <div class="htlmodin widthmn">
   <div class="col-md-12 nopad">
    ...
    <form name="flight" id="flight" action="<?php echo WEB_URL;?>/flight/search_flight" method="post" autocomplete="off">
    <input type="hidden" name="Carriers" id="Carriers" value="<?php echo (isset($_REQUEST['Carriers']))?$_REQUEST['Carriers']:'';?>">
    <input type="hidden" name="provider" id="provider" value="<?php echo (isset($_REQUEST['provider']))?$_REQUEST['provider']:'';?>">
...
<?php $data['flights']=$flights; 
	$data['request']  = $request;
	if($flights!=''){
		$this->load->view('flight_new/ajax_results', $data);
		}
