	...
	<div class="row">
		...
		<div class="col-md-5">
			<div class="leftpul">
				...
				echo anchor_popup('auth/login/Facebook/login','<span class="fa fa-facebook"></span>
					<div class="mensionsoc">Login with Facebook</div>', $atts);
				$atts['class'] = 'logspecify tweetcolor';
				echo anchor_popup('auth/login/Twitter/login','<span class="fa fa-twitter"></span>
					<div class="mensionsoc">Login with Twitter</div>', $atts);
				$atts['class'] = 'logspecify gpluses';
				echo anchor_popup('auth/login/Google/login','<span class="fa fa-google-plus"></span>
