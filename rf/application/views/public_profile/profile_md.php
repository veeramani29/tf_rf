...
<?php if(isset($key) && $key != ''){$this->load->view('public_profile/references');}?>
       ...
       <div class="col-md-3">
          ...
          <div class="sidewiserow">
            <h3 class="sidewisehed">Verifications</h3>
            <?php 
              $count = $this->verification_model->checkB2CVerfication($b2c_id, $user_type)->num_rows();
              if($count == 1){
                $verifications = $this->verification_model->checkB2CVerfication($b2c_id, $user_type)->row();
                if($verifications->email == 1){
                  echo '<p class="sideop"><span class="icontik icon icon-check"></span><span class="strogtiv">Email Address</span><span class="littiv">Verified</span> </p>';
                }
                ...
                echo '<p class="sideop">No verification yet</p>';
              }
            ?>
          ...
          <div class="sidewiserow">
            <h3 class="sidewisehed">About Me</h3>
            <ul class="qlinkul">
                ...
                <?php }?>
                <?php if($userInfo->school != '' || $userInfo->school != NULL){?>
                <li class="abtmes"><span class="bolddesig">School</span><?php echo $userInfo->school;?></li>
                <?php }?>
            </ul>
         ...
         <div class="col-md-9">
          <div class="dashrow marbtm20">
                ...
                <div class="placemebr">
                    ...
                    if($id == $b2c_id){ 
                    ?>
                    <a href="<?php echo WEB_URL;?>/dashboard/profile/update" class="editproos">Edit Profile</a>
                    <?php }?>
                </div>
