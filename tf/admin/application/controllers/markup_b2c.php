...
class Markup_b2c extends CI_Controller {
    ...
    function index(){
		...
		// $data['result'] = $this->markup->fetch_markup_b2c()->result();
...
private function check_isvalidated(){
	...
	{
		$data['AirlinesList'] = $this->markup->get_all_airlines();
		$this->load->view('markup_b2c/AddB2CMarkup',$data);
	}
	...
	public function SaveB2CMarkUp()
	{
		...
		if($B2CMarkup['AllAirlines'] == 'N')
		{
			$ApplicableAirlines = $this->markup->get_all_airlines_codes('N',$B2CMarkup['ExceptAirlines']);
			$B2CMarkup['ApplicableAirlines'] = '|||'.implode('|||',$ApplicableAirlines).'|||';
			if(is_array($B2CMarkup['ExceptAirlines'])) {
				 $B2CMarkup['ExceptAirlines'] = implode('|||',$B2CMarkup['ExceptAirlines']);
			}
		}
		else{
			$ApplicableAirlines = $this->markup->get_all_airlines_codes('Y','All');
			$B2CMarkup['ApplicableAirlines'] = '|||'.implode('|||',$ApplicableAirlines).'|||';
			$B2CMarkup['ExceptAirlines'] = '';
		}
