...
<html>
<head>
    <title>Add New Page | <?php echo PROJECT_NAME;?></title>
      ...
      <section id='content'>
		...
		<div class='row'>
			...
			<div class='form-group'>
                          ...
                          <div class='col-sm-8 controls'>
                            <input class='form-control'  data-rule-required='true' value="" id="title_dutch" name='title_dutch' placeholder='Page Title (Dutch)' type='text'>
                          </div>
