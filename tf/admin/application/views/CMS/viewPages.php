...
<html>
<head>
    <title>View All Static Pages | <?php echo PROJECT_NAME;?></title>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Static Page Management</div>

                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>cms/addNewPageForm"> <button class='btn' style='margin-bottom:5px'  ><i class='icon-male'></i> Add New Page</button></a>
                              ...
                              <tr>
                                ...
                                <td><?=$url.$p->slug;?></td>
                                 ...
                                 <select onchange="activate(this.value);">
                                   <?php if($p->status == '1'){?>
                                    <option value="<?php echo WEB_URL; ?>cms/updatePageStatus/<?php echo $p->id; ?>/1" selected>Activate</option>
                                    <option value="<?php echo WEB_URL; ?>cms/updatePageStatus/<?php echo $p->id; ?>/0">De-activate</option>
                                    <?php }else{?>
                                    <option value="<?php echo WEB_URL; ?>cms/updatePageStatus/<?php echo $p->id; ?>/1">Activate</option>
                                    <option value="<?php echo WEB_URL; ?>cms/updatePageStatus/<?php echo $p->id; ?>/0" selected>De-activate</option>
                                  </select>
                                  <?php }?>
                                </td>
                                <td>
			 	 <div class='text-right'>
				<a class='btn btn-info btn-xs has-tooltip' data-placement='top' title='Edit Page' href='<?php echo WEB_URL; ?>cms/editPage/<?=$p->id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
				 <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Delete' href='<?php echo WEB_URL; ?>cms/deletePage/<?=$p->id;?>'>
