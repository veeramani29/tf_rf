...
<html>
<head>
    <title>Change Summary Info | <?php echo PROJECT_NAME;?></title>
                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Change Summary Info</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Change Summary Info</div>
                      <div class='actions'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>apartment/edit_description" method="post"> 
                          ...
                          <div class='col-sm-7 col-sm-offset-1'>
                            <div class='form-group'>
                              ...
                              <input class='form-control' id='title' value="<?php echo $result5->title; ?>" name="title" type='text' placeholder="Write a title">
                            </div>
                            <div class='form-group'>
                              <label>Summary</label>
                              <textarea class='form-control' id='summary'   placeholder="Write a summary in 250 characters or less" name="summary">
                              <?php echo trim($result5->desci); ?>
                              </textarea>
                            </div>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            ...
                            <input type="submit" class='btn btn-primary' name="submit" value="Update Summary">
