...
<html>
<head>
    <title>Add B2B Agent | <?php echo PROJECT_NAME;?></title>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Add New B2B Agent</div>
                      <div class='actions'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form'   style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>b2b/add_agent" method="post"  enctype="multipart/form-data"> 
                        <div class='form-group'>
                          <label class='control-label col-sm-3 col-sm-3' for='validation_name'>Name</label>
                          <div class='col-sm-2 controls'>
                            <input class='form-control' data-rule-minlength='2' data-rule-required='true' id='validation_saluation' name='sal' placeholder='Saluation' type='text'>
                          </div>
                          <div class='col-sm-3 controls'>
                            <input class='form-control' data-rule-minlength='2' data-rule-required='true' id='validation_fname' name='fnam' placeholder='First Name' type='text'>
                          </div>
                          <div class='col-sm-3 controls'>
                            <input class='form-control' data-rule-minlength='2' data-rule-required='true' id='validation_lname' name='lname' placeholder='Last Name' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_company'>Company Name</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control'  data-rule-required='true' id='validation_company' name='company' placeholder='Company Name' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-number='true' data-rule-required='true' id='validation_contact' name='phone' placeholder='Contact No' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_office'>Office No</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-number='true' data-rule-required='true' id='validation_office' name='office' placeholder='Office No' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-required='true' id='validation_city' name='city' placeholder='City' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_contact'>Postal Code</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-number='true' data-rule-required='true' id='validation_contact' name='postal' placeholder='Postal Code' type='text'>
                          </div>
                        </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input type="file" title='Search for a image to add' class='form-control' data-rule-required='true' id='validation_image' name='file'>
                          </div>
                        </div>
