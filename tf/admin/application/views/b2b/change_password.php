...
<html>
<head>
    <title>Change Agent Password | <?php echo PROJECT_NAME;?></title>
                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li>
                          <a href="<?php echo WEB_URL; ?>b2b/b2b_view"> Agent Management</a>
                        </li>
                        <li class='separator'>
                          <i class='icon-angle-right'></i>
                        </li>
                        <li class='active'>Change Agent Password</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Change Agent Password</div>
                      <div class='actions'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>b2b/update_password/<?php echo $user->agent_id; ?>" method="post"> 
