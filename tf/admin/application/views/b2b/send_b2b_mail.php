...
<html>
<head>
    <title>Send Mail to B2B Agent | <?php echo PROJECT_NAME;?></title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='page-header'>
                    <h1 class='pull-left'>
                      <i class='icon-ok'></i>
                      <span>Send Mail To <?php echo $user->firstname; ?></span>
                    </h1>
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Send Mail To <?php echo $user->firstname; ?></li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Send Mail To <?php echo $user->firstname; ?></div>
                      <div class='actions'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>b2b/send_mail" method="post"  enctype="multipart/form-data"> 
			<input type="hidden" name="firstname" value="<?php echo $user->firstname; ?>">                        
			<input type="hidden" name="mailid" value="<?php echo $user->email_id; ?>">
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_subject'>Subject</label>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-required='true' id='validation_city' name='subject' placeholder='Subject' type='text'>
                          </div>
                        </div>
                        <div class='box-content'>
                      <textarea class='form-control wysihtml5' id='body' placeholder='Some text here...' rows='10' name='message'></textarea>
                    </div>
