            ...
            <section id='content'>
                <div class='container'>
                                    ...
                                    <div class='page-header'>
                                        ...
                                        <div class='pull-right'>
                                            <ul class='breadcrumb'>
                                                ...
                                                <li class='active'>B2C User Bookings</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='col-sm-12'>
                                    <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                                        <div class='box-header blue-background'>
                                            <div class='title'>B2C User Bookings</div>
                                        </div>
					...
					<ul class="nav nav-responsive nav-tabs"><li class="dropdown pull-right tabdrop hide"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="icon-align-justify"></i> <b class="caret"></b></a><ul class="dropdown-menu"></ul></li>
						<li class="active"><a data-toggle="tab" href="#retab2"><i class="icon-flight"></i> Flights</a></li>
