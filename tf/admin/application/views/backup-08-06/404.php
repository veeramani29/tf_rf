            ...
            <div class='container'>
              <div class='row'>
                <div class='col-sm-4 col-sm-offset-4'>
                  ...
                  <div class='text-center'>
                    <a class='btn btn-md btn-ablock' href='#' onclick="window.history.go(-1); return false;">
          ...
          <div class='error-container-footer'>
            <div class='container'>
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='text-center'>
                    <img width="121" height="31" alt="Flatty" src="<?=base_url();?>assets/images/logo.png" />
                  </div>
                </div>
              </div>
            </div>
