    ...
    <div id='wrapper'>
      ...
      <section id='content'>
        <div class='container'>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    ...
                    <dir>  </dir>
                       <form id="regg"  novalidate="novalidate" class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>apartment/save_apartment" method="post"> 
                       
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_password'>Apartment Type &nbsp :</label> <input type="text" name="apartment" id="apartmant"> &nbsp &nbsp &nbsp  
                                
                          <input type="submit" class='btn btn-primary' name="submit" value="Add Apartmant Type">
                        </div>
                              ...
                              <tr>
                                ...
                                <td colspan="3" width="300" align="left">
                                  <div class='text-right'>
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='' href='<?php echo WEB_URL; ?>apartment/edit_apt/<?php  echo $id=$row->apartment_type_id; ?>'>
                                      <i class='icon-edit'></i>
                                    </a>
          ...
          <a href='<?php echo WEB_URL ?>apartment/delete_apt/<?php  echo $id=$row->apartment_type_id; ?>' 
