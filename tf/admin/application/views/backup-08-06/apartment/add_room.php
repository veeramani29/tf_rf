              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    ...
                    <dir>  </dir>
                       <form id="regg"  novalidate="novalidate" class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>apartment/save_room" method="post"> 
                       
                        <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_password'>Room Type &nbsp :</label> <input type="text" name="room" id="room"> &nbsp &nbsp &nbsp  
                                
                          <input type="submit" class='btn btn-primary' name="submit" value="Add Room Type">
                        </div>
                              ...
                              <tr>
                                ...
                                <td colspan="3" width="300" align="left">
                                  <div class='text-right'>
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='' href='<?php echo WEB_URL; ?>apartment/edit_room/<?php  echo $id=$row->room_id; ?>'>
                                      <i class='icon-edit'></i>
                                    </a>
                ...
                <!--   <a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href='<?php echo WEB_URL; ?>apartment/apartment_profile/<?php echo $pid=$row->address; ?>'>
                                      <i class="icon-search"></i>&nbsp;
         									 ...
         									 <a href='<?php echo WEB_URL ?>apartment/delete_room/<?php  echo $id=$row->room_id; ?>' 
