...
<html>
<head>
    <title>Change Admin Password| InnoGlobe</title>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>home/update_password" method="post"> 
                        <div class='form-group'>
                          ...
                          <a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL; ?>apartment/edit_basics/<?php echo $pid=$result['aid']; ?>" data-original-title="">
                                      <i class="icon-edit"></i>
                                    </a>
                          </div>
                        </div>
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                           <a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL; ?>apartment/edit_calendar/<?php echo $pid=$result['aid']; ?>"  data-original-title="">
                                      <i class="icon-edit"></i>
                                    </a>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
										<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL; ?>apartment/edit_price/<?php echo $pid=$result['aid']; ?>"  data-original-title="">
                                      <i class="icon-edit"></i>
                                    </a>                            
                          ...
                          <div class='col-sm-4 controls'>
										<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL; ?>apartment/edit_description/<?php echo $pid=$result['aid']; ?>"  data-original-title="">
                                      <i class="icon-edit"></i>
                                    </a>                            
                         ...
                         <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
										<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL; ?>apartment/edit_apartmet_pics/<?php echo $pid=$result['aid']; ?>"  data-original-title="">
                                      <i class="icon-edit"></i>
                                    </a>                            
                          ...
                          <div class='col-sm-4 controls'>
										<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL; ?>apartment/edit_ameniies/<?php echo $pid=$result['aid']; ?>" data-original-title="">
                                      <i class="icon-edit"></i>
                                    </a>                            
                          ...
                          <div class='col-sm-4 controls'>
										<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL; ?>apartment/edit_address/<?php echo $pid=$result['aid']; ?>"  data-original-title="">
                                      <i class="icon-edit"></i>
                                    </a>                            
