                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>apartment/upate_room" method="post"> 
                        <div class='form-group'>
                          <label class='control-label col-sm-3'  for='validation_current'>Home Type  </label>
                          <div class='col-sm-4 controls'>
                     	
                                  <div class='col-sm-6'>
                                    <div class='input-group'>
                                      <input type="hidden" value="<?php  echo $result6->room_id; ?>" name="id">
                                      <input type="text" name="room" value="<?php  echo $result6->room_type; ?>" ?>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>apartment/add_room"><button class='btn btn-primary' type='button'>
                                <i class='icon-reply'></i>
                                Go Back  
                              </button></a>
                              
                              <input type="submit" name="submit" value="Update home type" class='btn btn-primary'>
                            </div>
                          </div>
                        </div>
                      </form>
