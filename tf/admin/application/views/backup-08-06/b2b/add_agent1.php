				...
				<div class="span12">
					<div class="box">
						...
						<div class="box-content">
							<form action="<?php echo WEB_URL; ?>b2b/add_agent" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="control-group">
										...
										<div class="controls">
											<input type="text" name="office" id="office" class='required'>
										</div>
									</div>
                                      <div class="control-group">
