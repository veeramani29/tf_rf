                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>B2B Agent Logs</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'><?php echo $agent->firstname; ?> Agent Logs</div>
                      ...
                      <div class='responsive-table'>
                        <div class='scrollable-area'>
                         <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                              <?php if(!empty($log_details)){ $c=1;foreach($log_details as $log_detail){
                              ...
                              <tr>
                                ...
                                <td><?=$log_detail->create_time;?></td>
                                <td><?=$log_detail->ipaddress;?></td>
                              
                                <td><?=$log_detail->message;?></td>
