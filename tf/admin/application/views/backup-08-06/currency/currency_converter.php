...
<html>
<head>
    <title>Currency Management | InnoGlobe</title>
                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      ...
                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>currency/add_currency"> <button class='btn' style='margin-bottom:5px'><i class='icon-usd'></i> Add New Currency</button> </a>
                          ...
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?=$currencies->country_code;?></td>
                                <td><?=$currencies->currency_name;?></td>
