					...
					<div class="box">
						...
						<div class="box-content box-nomargin">
							<div class="tab-content">
                                   ...
                                   <form action="<?php echo WEB_URL; ?>domain/update_domain_bimage/<?php echo $id; ?>" enctype="multipart/form-data" method="post" class='validate form-horizontal'>
                                   <br>
								<div class="control-group">
								<label for="file2" class="control-label">Background Image</label>
												<div class="controls">
