...
<html>
<head>
    <title>Add New Hotel Info | InnoGlobe</title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='box'>
                      ...
                      <form class='form form-horizontal validate-form'   style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>hotelcrs/add_data/admin"  name="f1" method="post"> 
                       ...
                       <!--
                        <div class='form-group'>
                          <label class='control-label col-sm-3'  for='validation_current'>Select Country</label>
                          <div class='col-sm-4 controls'>
                                  ...
                                  <div class='col-sm-6'>
                                    <div class='input-group'>
                                   	<select name="country">
												...
												<?php if(!empty($country_list)){foreach($country_list as $key => $value){?>	
                             ...
                             <div class='form-group'>
                          <label class='control-label col-sm-3'  for='validation_current'>Select City </label>
                          <div class='col-sm-4 controls'>
                                  ...
                                  <div class='col-sm-6'>
                                    <div class='input-group'>
											...
											<select name="city"><option>  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</option></select>
                                     </div>
                                    </div> 
                                   </div>
                        </div>
                             ...
                             <div class='form-group'>
                          <label class='control-label col-sm-3'  for='validation_current'>Select Hotel
</label>
                          <div class='col-sm-4 controls'>
                     	
                                  <div class='col-sm-6'>
                                    <div class='input-group'>
                                      <select name="hotel"><option>  &nbsp &nbsp  &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</option></select>
                                     </div>
                                    </div> 
                                   </div>
                        </div>
                        <p style="padding-left:160px;"><b>OR ENTER HOTEL INFORMATION</b></p>
                       ...
                       <input name="pro_name" id="pro_name" type="text" class='form-control'   data-rule-required='true'  placeholder="Hotel Name" style="width:300px;">	
                             ...
                             <div class='form-group'>
                          <label  class='control-label col-sm-3' for='validation_name'>Hotel Chain Name: </label>
                      
                     	
                                <div class='col-sm-4 controls'>
                                    
            
                  		<input name="hotel_chain_name" style="width:300px;" class='form-control' id="hotel_chain_name" type="text"  data-rule-required='true' placeholder="Hotel Chain name">
                        ...
                        <div class='form-group'>
                      	...
                      	<input  class='form-control' style="width:300px;" type=search  autocomplete=off spellcheck name=country_val id=country_val list=countries placeholder="Ex:- Japan" >
										<datalist id=countries>
												...
												{ if(!empty($citylist[$c]->city)) { ?>
												<option value="<?php echo $citylist[$c]->city;?>"></option>
												<?php } } ?>
													
										</datalist>
											<span id="addanother" style="font-weight:bold;cursor:pointer;">Other</span>
                   ...
                   <input style="width:300px;" name="hotel_star" class='form-control' id="hotel_star" type="text"  data-rule-required='true' placeholder="stat"/>
                              
                                  </div>
                                 
                        </div>
                         <p style="padding-left:200px;"><b>Main Contact Information:</b></p>
                        
                       	
                        
                        <div class='form-group'>
                          <label  class='control-label col-sm-3 col-sm-3' for='validation_name'>First Name</label>
                           
                             
														 <div class='col-sm-4 controls'> 
           <input name="main_first_name" class='form-control' style="width:300px;" type="text" placeholder="First Name"  data-rule-required='true' value="<?php if(isset($contact_inf->main_first_name)){ echo $contact_inf->main_first_name; } ?>" />
                        ...
                        <div class='form-group'>
                          <label  class='control-label col-sm-3 col-sm-3' for='validation_name'>Last Name</label>
                          <div class='col-sm-4 controls'>
                             
											 
                                	<input name="main_last_name" class='form-control' style="width:300px;" type="text" placeholder="Last Name"  data-rule-required='true' />
                        ...
                        <div class='form-group'>
                          <label  class='control-label col-sm-3 col-sm-3' for='validation_name'>Email Address:
</label>
                          
                             
														   <div class='col-sm-4 controls'>
                                     
                              <input name="main_email" type="text" placeholder="Email" class='form-control' style="width:300px;" placeholder="Email"  data-rule-email='true' data-rule-required='true'   />
                         ...
                         <div class='form-group'>
                          ...
                          <label class='control-label col-sm-3' for='validation_password'>Fax :</label>
                                  ...
                                  <div class='col-sm-4 controls'>
                                 	<input name="main_fax" type="text" placeholder="Fax" class='form-control' style="width:300px;"  data-rule-email='true' data-rule-required='true' />	
                               </div>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>hotelcrs/index"><button class='btn btn-primary' type='button'>
