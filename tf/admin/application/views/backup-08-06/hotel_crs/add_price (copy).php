                           ...
                           <div class='input-group'>
                             <div class="controls" id="roomTypes">
											<?php if(isset($result->room_type) && $result->room_type!=''){ 
												echo '<select name="room_type" id="room_type" class="ma_pro_txt">
                           ...
                           <div class='input-group'>
                             ...
                             <div class="controls" id="roomTypeCapacity">
											<?php if(isset($result->room_category) && $result->room_category!=''){ 
												echo '<select name="capacity_type" id="capacity_type" class="ma_pro_txt">
                 	...
                 	<input type="file" name="image3" id="filepath3" >
                           ...
                           <div class='input-group'>
											...
											$policy = $this->Hotelcrs_model->get_child_policy($this->uri->segment(4));
											   ...
											   ?>
											<textarea name="child_policy" id="child_policy" cols="50" rows="4"><?php echo $poli;?></textarea>												
                    	...
                    	<?php
									        ...
									        ?>
									  <table summary="" width="800" > <tr><td>  From :<input name="sd[]" id="datepicker2" type="text" class="b2b-txtbox" />
   ...
   <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              ...
                              <input type="button" value="Submit" class="btn btn-primary" onClick="getDates();" class='btn btn-primary'>
