                        ...
                        <div class='form-group'>
                           ...
                           <div class='input-group'>
                             <div class="controls" id="roomTypes">
											<?php if(isset($result->room_type) && $result->room_type!=''){ 
												echo '<select name="room_type" id="room_type"     class="form-control" data-rule-required="true">
												<option value="'.$result->room_type.'" >'.$result->room_type.'</option>
												</select>'; } else { ?>Please Select Hotel First<?php	 } ?>
                           ...
                           <div class='input-group'>
                             ...
                             <div class="" id="roomTypeCapacity">
											<?php if(isset($result->room_category) && $result->room_category!=''){ 
												echo '<select name="capacity_type" id="capacity_type" class="form-control"  data-rule-required="true">
