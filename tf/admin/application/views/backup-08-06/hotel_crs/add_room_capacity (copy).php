                 ...
                 <form action="<?php echo WEB_URL; ?>hotelcrs/add_room_capacity_details" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>
                          ...
                          <div class='col-sm-4 controls'>
                                  ...
                                  <div class='col-sm-6'>
                                    <div class='input-group'> 
										<select name="hotel_name" class="required">											
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
														   ...
														   <div class='col-sm-6'>
                                    <div class='input-group'>
                                     <input type="text" name="capacity_title" class="required">
                                    </div>
                                  </div>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>apartment/edit_flat/"><button class='btn btn-primary' type='button'>
