...
<html>
<head>
    <title>Room Management | InnoGlobe</title>
                ...
                <div class='col-sm-12'>
                  ...
                  <!--  <div class='box-header blue-background'>
                    ...
                    <div class='title'>Room Type</div>
                          ...
                          <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>hotelcrs/add_room_capacity"> <button class='btn' style='margin-bottom:5px'><i class='icon-plus'></i>Add New Room Type</button></a>
                       <a  href="#"><i> &nbsp</i></a>
                      </div>
                      
                      <!--
                    	 <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>hotelcrs/add_room_type"> <button class='btn' style='margin-bottom:5px'><i class='icon-plus'></i>Add New Room Category</button></a>
                       <a  href="#"><i> &nbsp</i></a>
                      </div>
                          ...
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            <thead>
                              ...
                              <th>Action</th>
                       			...
                       			<tbody>
												 <?php if(!empty($result_view)) { foreach($result_view as $key => $value) {
												 ?>
											<tr>
												...
												<td><?php echo $value->hotel_name; ?></td>
													...
													<td><?php echo $value->child_capacity; ?></td>
											  
												<td class="center">
											 
		 
														
													<a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title=""  href="<?php echo WEB_URL; ?>hotelcrs/edit_room_capacity/<?php echo $value->capacity_id; ?>"   data-original-title="Edit">
                                      <i class="icon-edit"></i>
                                    </a>
                             
                             	
                                  <a href="<?php echo WEB_URL; ?>hotelcrs/delete_capacity/<?php echo $value->capacity_id; ?>" data-original-title="Delete"  onclick="return confirm('Do you want delete this record');" class="btn btn-danger btn-xs has-tooltip" data-original-title="Delete"> 
