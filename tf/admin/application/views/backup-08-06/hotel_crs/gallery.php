...
<html>
<head>
    <title>Gallery Management | InnoGlobe</title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  ...
                  <div class='box-header blue-background'>
                    <div class='title'>Gallery Management</div>
                       ...
                       <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>hotelcrs/add_gallery/<?php echo $supplier_id;?>/<?php echo $hotel_id;?>"> <button class='btn' style='margin-bottom:5px'><i class='icon-plus'></i> Add Images</button></a>
                       <a  href="#"><i> &nbsp</i></a>
                      </div>
                    ...
                    <div class='box-content'>
                      <div class='gallery'>
                        ...
                        <?php if(!empty($images)) { $count = 1; foreach($images as $key => $image) {?>
                          <li>
                            <div class='picture'>
                              <div class='tags'>
                                <a href="<?php echo WEB_URL; ?>hotelcrs/del_hotel_img/<?php echo $supplier_id; ?>/<?php echo $hotel_id; ?>/<?php echo $image->id; ?>" class='btn  has-tooltip btn-danger btn-xs' data-original-title="Delete"  onclick="return confirm('Do you want delete this image');"  data-original-title="Delete">
                              ...
                              <div class='actions'>
                                <div class='pull-left'>
                                 <a class='btn btn-link'>
                                    <?php echo $hotel_data->hotel_name;?>
                                 </a>
                                </div>
                                <div class='pull-right'>
                                 <a class='btn btn-link'>
                              ...
                              <a data-lightbox='flatty' href='<?php echo $image->url; ?>'>
                                <img width="230" src="<?php echo $image->url; ?>" />
                              </a>
                            </div>
                          </li>
                        <?php $count ++; } }else{ echo 'There is no images found';}?> 
                        </ul>
                      </div>
                    </div>
                  </div>
