                                 ...
                                 <th>Hotel Name</th>
                                  ...
                                  <i class="icon-remove"></i>
												...
												<?php if($value->status==1) { ?> 
													<a   href="<?php echo WEB_URL; ?>hotelcrs/update_all_hotel_status/<?php echo $value->sup_id; ?>/<?php echo $value->sup_hotel_id; ?>/0" style="color:#000;" data-original-title="Inactive">
														<img src="<?php echo WEB_DIR; ?>/assets/images/status_online.ico" width="15" align="center"/>
													</a> 
												<?php } else { ?> 
													<a class="" href="<?php echo WEB_URL; ?>hotelcrs/update_all_hotel_status/<?php echo $value->sup_id; ?>/<?php echo $value->sup_hotel_id; ?>/1" style="color:#000;" data-original-title="Active">
