...
<html>
<head>
    <title>Hotel Management | InnoGlobe</title>
  ...
  <body class='contrast-dark fixed-header'>
    ...
    <div id='wrapper'>
      ...
      <section id='content'>
                    ...
                    <div class='box-content box-no-padding'>
                      <div class='responsive-table'>
                        ...
                        <td><?php echo $count; ?></td>
												...
												<td><?php echo $value->res_phone; ?></td>
												<td><?php echo $value->res_fax;		?></td>
												<td>
	   ...
	   {
		   ?>
                                              <!-- <a href="<?php echo WEB_URL;?>hotelcrs/add_supplier/<?php echo $value->sup_id; ?>/<?php echo $value->sup_hotel_id ?>" data-original-title="Supplier"   class="btn btn-primary btn-xs has-tooltip" data-original-title="Supplier"> 
	   ...
	   ?>
                              <a href="<?php echo WEB_URL;?>hotelcrs/room_type_list/<?php echo $supplier_id; ?>/<?php echo $value->sup_hotel_id ?>" data-original-title="Room Management"   class="btn btn-primary btn-xs has-tooltip" data-original-title="Room Management"> 
                            <i class="icon-archive"></i>
                          </a>
                          <a href="<?php echo WEB_URL;?>hotelcrs/gallery/<?php echo $supplier_id; ?>/<?php echo $value->sup_hotel_id ?>" data-original-title="Gallery Management"   class="btn btn-primary btn-xs has-tooltip" data-original-title="Room Management"> 
                            <i class="icon-picture"></i>
                          </a>
                          <a class="btn btn-primary btn-xs has-tooltip" data-placement="top" title="" href="<?php echo WEB_URL;?>hotelcrs/edit_hotel_ad/<?php echo $supplier_id; ?>/<?php echo $value->sup_hotel_id ?>" data-original-title="Edit">
                            <i class="icon-edit"></i>
                          </a>
                                    <?php
					  if(!$this->session->userdata('supplier_logged_in'))
	   {
		   ?>
                          <a href="<?php echo WEB_URL;?>hotelcrs/delete_hotel_ad/<?php echo $supplier_id; ?>/<?php echo $value->sup_hotel_id ?>" data-original-title="Delete"  onclick="return confirm('Do you want delete this record');" class="btn btn-danger btn-xs has-tooltip" data-original-title="Delete"> 
	   ...
	   ?>
												...
												<?php if($value->status==1) { ?> 
													<a   href="<?php echo WEB_URL; ?>hotelcrs/update_all_hotel_status/<?php echo $supplier_id; ?>/<?php echo $value->sup_hotel_id; ?>/0" style="color:#000;" data-original-title="Inactive">
														<img src="<?php echo WEB_DIR; ?>/assets/images/status_online.ico" width="15" align="center"/>
													</a> 
												<?php } else { ?> 
													<a class="" href="<?php echo WEB_URL; ?>hotelcrs/update_all_hotel_status/<?php echo $supplier_id; ?>/<?php echo $value->sup_hotel_id; ?>/1" style="color:#000;" data-original-title="Active">
