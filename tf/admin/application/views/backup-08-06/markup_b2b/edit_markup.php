...
<html>
<head>
    <title>Add New Markup | InnoGlobe</title>
                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Add Generic Markup</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Add Generic Markup</div>
                      <div class='actions'>
                        <a class="btn box-collapse btn-xs btn-link" href="#"><i></i></a>
                      </div>
                    </div>
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>markup_b2b/update_b2b_markup/<?php echo $id; ?>/<?php echo $type; ?>" method="post"  enctype="multipart/form-data" onsubmit="return validateDup()"> 
                       <div id="msg"></div>
                <?php if($result->markup_type != 'Generic') {?>
							      <div class='form-group'>
                          <label class='control-label col-sm-3' for='markup'>Agent</label>
                          <div class='col-sm-4 controls'>
                                    <input type="hidden" name="id" value="<?php echo $result->markup_id; ?>">                 
                              <select class='form-control' data-rule-required='true' id='agent' name='agent'>
                                
                              <?php   foreach ($agents as $agent) { ?>
                              <option value="<?php echo $agent->agent_id; ?>" <?php if($result->agent_id ==$agent->agent_id){ echo "selected=selected"; } ?>><?php echo $agent->company_name.' - '.$agent->firstname; ?></option>
                              <?php }?> 
                            </select>
                    ...
                    <?php }?>    
                      ...
                      <option value="">Select Country</option>
                          ...
                          -->
                      <input class='form-control'   value="<?php echo $result->country;?>"    id='country' name='country' type='hidden' >
