...
<html>
<head>
    <title>Update Markup | InnoGlobe</title>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>markup_b2b/update" method="post"  enctype="multipart/form-data"> 
                        <div class='form-group'>
                          <?php // if($type == 1){?>
                          <label class='control-label col-sm-3' for='a'>Api</label>
                          <?php //}else{?>
                          <label class='control-label col-sm-3' for='a'>Agent</label>
                          <?php //}?>
                          <div class='col-sm-4 controls'>
                            <input class='form-control' data-rule-required='true' type='text' value="<?php //echo $result->a;?>" readonly id="a">
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control'  data-rule-number='true' data-rule-required='true' id='markup' name='markup' placeholder='Markup' type='text' value="<?php //echo $result->markup_b2b;?>">
                          </div>
                        </div>
