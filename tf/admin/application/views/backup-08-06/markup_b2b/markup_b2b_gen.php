                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>markup_b2b/save_markup_b2b" method="post"  enctype="multipart/form-data" onsubmit="return validateDup()"> 
                       <div id="msg"></div>
                          ...
                          <div class='col-sm-4 controls'>
                            ...
                            <option value="">Add Agent</option>
                              ...
                              <?php }?> 
  								  ...
  								  <div class='form-group'>
                          <label class='control-label col-sm-3' for='agent'>Api</label>
                          <div class='col-sm-4 controls'>
