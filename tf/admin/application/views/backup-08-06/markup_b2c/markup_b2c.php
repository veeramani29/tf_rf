                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      ...
                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>currency/add_currency"> <button class='btn' style='margin-bottom:5px'><i class='icon-plus'></i> Add Generic Markup</button></a>
                       <a href="<?php echo WEB_URL; ?>currency/add_currency"> <button class='btn' style='margin-bottom:5px'><i class='icon-globe'></i> Add Country Markup</button></a>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class='text-right'>
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='Edit Currency' href='<?php echo WEB_URL; ?>currency/edit_currency/<?=$currencies->cur_id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
                                    <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Delete' href='<?php echo WEB_URL; ?>currency/delete_currency/<?=$currencies->cur_id;?>'>
