                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>markup_b2c/save_markup_specific" method="post"  enctype="multipart/form-data" onsubmit="return validateDup()"> 
