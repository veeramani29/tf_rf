                  ...
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      ...
                      <!--  <a href="<?php echo WEB_URL; ?>markup_b2c/add_markup_gen"> <button class='btn' style='margin-bottom:5px'><i class='icon-plus'></i> Add Generic Markup</button></a>
                       <a href="<?php echo WEB_URL; ?>markup_b2c/add_markup_specific"> <button class='btn' style='margin-bottom:5px'><i class='icon-male'></i> Add Specific Markup</button></a> -->
                          ...
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?php if(!empty($markup->country)){echo $markup->country;}else{echo '---';}?></td>
 										            <td><?php echo $markup->markup; ?> %</td>
                                <td>
                                  <div class='text-right'>
                                   
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='Edit Markup' href='<?php echo WEB_URL; ?>markup_b2c/edit/<?php echo $id=$markup->markup_id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
