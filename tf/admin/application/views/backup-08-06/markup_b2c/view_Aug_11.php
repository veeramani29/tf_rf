                  ...
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      ...
                      <div class='actions'>
                       ...
                       <a href="<?php echo WEB_URL; ?>markup_b2c/add_markup_geo"> <button class='btn' style='margin-bottom:5px'><i class='icon-globe'></i> Add Geo Target Markup</button></a>
                        ...
                        <div class='scrollable-area'>
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><?=$c;?></td>
                                <td><?php if(!empty($markup->name)){echo $markup->name;}else{echo '---';}?></td>
                                <th><?php if(!empty($markup->api_name)){echo $markup->api_name;}else{echo '---';}?></th>
                                <td><?=$markup->markup;?> %</td>
                                <td>
                                  <div class='text-right'>
                                    <?php if(empty($markup->name)){?>
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='Edit Markup' href='<?php echo WEB_URL; ?>markup_b2c/edit/<?=$markup->markup_id;?>/1'>
                                      <i class='icon-edit'></i>
                                    </a>
                                    <?php }else{?>
                                    <a class='btn btn-primary btn-xs has-tooltip' data-placement='top' title='Edit Markup' href='<?php echo WEB_URL; ?>markup_b2c/edit/<?=$markup->markup_id;?>/2'>
                                      <i class='icon-edit'></i>
                                    </a>
                                    <?php }?>
                                    <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Delete' href='<?php echo WEB_URL ?>markup_b2c/del_mark/<?php echo $id=$markup->markup_id; ?>' onclick="return confirm('Are you sure, do you want delete this record?');">
