                        ...
                        <div class='col-sm-12'>
                          <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                            <div class='box-header blue-background'>
                              ...
                              <div class='actions'>
                               <a href="<?php echo WEB_URL; ?>packages/add_package_type"> <button class='btn' style='margin-bottom:5px'><i class='icon-male'></i> Add New Package Types</button></a>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class='text-right'>
                                            ...
                                            <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Delete' onclick="return confirm('Are you sure, do you want to delete this record?');" href='<?php echo WEB_URL; ?>packages/delete_package_type/<?=$k->packages_types_id;?>'>
