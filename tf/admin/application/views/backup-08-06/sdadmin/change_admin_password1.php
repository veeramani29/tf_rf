			...
			<div class="row-fluid">
				<div class="span12">
					<div class="box">
						...
						?>
							<form action="<?php echo WEB_URL; ?>sdadmin/update_admin_password/<?php echo $admin->user_id; ?>" method="post" class='validate form-horizontal'>
								<div class="control-group">
									<label for="req" class="control-label">Current Password</label>
									<div class="controls">
										<input type="text" name="cpass" id="req" class='required'>
                                        	<input type="hidden" name="email3" id="req"  value="<?php echo $admin->email; ?>">
                                            	<input type="hidden" name="name3" id="req"  value="<?php echo $admin->firstname; ?>">
									</div>
								</div>
								<div class="control-group">
