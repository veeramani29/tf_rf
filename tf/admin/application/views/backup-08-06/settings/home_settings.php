        ...
        <div class='container'>
          <div class='row' id='content-wrapper'>
			...
			<div class='form-group'>
			    ...
			    <input type="hidden" name="hidden_main_banner" value="<?php echo $isExists->main_banner;?>" >                         
			 </div>
			  <div class='col-sm-4 controls'>
				<img src="<?php echo $isExists->main_banner;?>" width="50" height="50">
			  </div>
                        </div> 
                    ...
                    <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_image'>Apartment Image</label>
                          <div class='col-sm-4 controls'>
                            <input type="file" title='Search for a image to add' class='form-control'  id='validation_image' name='apartment'>
                            <input type="hidden" name="hidden_apartment_banner" value="<?php echo $isExists->apartment_image;?>" >
                    </div>
                      <div class='col-sm-4 controls'>
                      <img src="<?php echo $isExists->apartment_image;?>" width="50" height="50">
                      </div>
                        </div>
                         <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            ...
                            <input type="hidden" name="hidden_hotel_banner" value="<?php echo $isExists->hotel_image;?>" >
                    </div>
                      <div class='col-sm-4 controls'>
                      <img src="<?php echo $isExists->hotel_image;?>" width="50" height="50">
                      </div>
                        </div>
                         <div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            ...
                            <input type="hidden" name="hidden_car_banner" value="<?php echo $isExists->car_image;?>" >
                    </div>
                      <div class='col-sm-4 controls'>
                      <img src="<?php echo $isExists->car_image;?>" width="50" height="50">
                      </div>
                        </div>
                         <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_image'>Vacation Image</label>
                          <div class='col-sm-4 controls'>
                            <input type="file" title='Search for a image to add' class='form-control'  id='validation_image' name='vacation'>
                            <input type="hidden" name="hidden_vacation_banner" value="<?php echo $isExists->vacation_image;?>" >
                    </div>
                      <div class='col-sm-4 controls'>
                      <img src="<?php echo $isExists->vacation_image;?>" width="50" height="50">
                      </div>
                        </div>
