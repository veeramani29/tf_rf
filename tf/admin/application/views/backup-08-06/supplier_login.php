...
<html>
	<head>
    <title>Sign in | InnoGlobe Administration</title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='text-center'>
                    <img width="200" src="<?=base_url();?>assets/images/logo.png" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class='container'>
              ...
              <div class='row'>
                <div class='col-sm-4 col-sm-offset-4'>
                  <h1 class='text-center title'>Supplier Sign in</h1>
                  <form action='<?php echo WEB_URL; ?>login/supplier_login' class='validate-form' method='post'>
