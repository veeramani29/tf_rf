...
<html>
<head>
    <title>Edit Suppliers Info | InnoGlobe</title>
 ...
 <form action="<?php echo WEB_URL; ?>supplier/update_supplierbyId/<?php echo $this->uri->segment(3);?>" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>								
                       ...
                       <input type="text" name="emailid" id="email" data-rule-email='true' data-rule-required='true' disabled  class='form-control' value="<?php echo $result[0]->email;?>" >
                      	...
                      	<input type="password" name="password" id="password" data-rule-minlength='6' data-rule-password='true' data-rule-required='true' class='form-control' value="<?php echo $result[0]->password;?>">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" data-rule-required='true' class='form-control' equalto="#password" value="<?php echo $result[0]->password;?>">
                          ...
                          <div class='form-group'>
                            ...
                            <div class="controls">
              	<input type="text" name="fname" id="fname" data-rule-required='true' class='form-control' value="<?php echo $result[0]->firstname;?>">
                        	</div>
                          ...
                          <div class='form-group'>
                         	 <label class='control-label col-sm-3'  for='validation_current'>Last Name
                          	 ...
                          	 <div class='col-sm-4 controls'>
                    <input type="text" name="lname" id="lname"  class='form-control' data-rule-required='true' value="<?php echo $result[0]->lastname;?>">
                          </div>
                          </div> 
                          ...
                          <div class='form-group'>
                   		...
                   		<input type="text" name="mobile" id="mobile"  data-rule-number='true' data-rule-required='true' class='form-control' value="<?php echo $result[0]->contact_no;?>">
                          </div>
                          </div> 
                	...
                	<input type="text" name="ph_no" id="ph_no" data-rule-number='true' data-rule-required='true' class='form-control' value="<?php echo $result[0]->contact_no;?>">
                          </div>
                          </div> 
                          ...
                          <div class='form-group'>
                      		...
                      		<input type="text" name="address" id="address"  data-rule-required='true' class='form-control'  value="<?php echo $result[0]->address;?>">
                          </div>
                          </div> 
                          ...
                          <div class='form-group'>
                         	 <label class='control-label col-sm-3'  for='validation_current'>Postal Code
                          	 ...
                          	 <div class='col-sm-4 controls'> 
                          	<input type="text" name="post_code" id="post_code"  data-rule-required='true' class='form-control'  value="<?php echo $result[0]->postal_code;?>">
                          </div>
                          </div> 
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>supplier"><button class='btn btn-primary' type='button'>
