  ...
  <?php if(isset($message) && $message!=''){
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <form method="post" id="myform" action="<?php echo base_url(); ?>b2c/export_b2c_users" >
                                        <div class='box-header blue-background'>
                                            <div class='title'>All Transaction History</div>
		...
		?>
                                                                           ...
                                                                           <?php echo $result->payout_status; ?> 
                                                                               ...
                                                                               <td class="tabletdcolor-<?php echo $clr_v; ?>">
                                                                         <?php 
																			  $dat =$result->travel_date;
																			  echo date('Y-m-d', strtotime($dat. ' + 2 days'));
																			    ?> 
                                                                              </td>
                                                                             <td class="tabletdcolor-<?php echo $clr_v; ?>">
                                                                           <?php echo $result->payout_method; ?> 
                                                                              </td>
                                                                               <td class="tabletdcolor-<?php echo $clr_v; ?>">
                                                                           <?php echo $result->payout_details; ?> 
                                                                              </td>
