            ...
            <section id='content'>
                <div class='container'>
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <form method="post" id="myform" action="<?php echo base_url(); ?>b2c/export_b2c_users" >
                                        <div class='box-header blue-background'>
                                            <div class='title'>Apartment Transaction Management</div>
                                                                ...
                                                                <?php if (!empty($user)) {
                                                                    ...
                                                                    foreach ($user as $users) { ?>
                                                                        ...
                                                                        <td><?= $c; ?></td>
                                                                            ...
                                                                            <td><a data-lightbox='flatty' href='<?php echo $users->profile_photo; ?>'>
                                                                                    <img width="50" title="<?= $users->firstname; ?>" alt="<?= $users->firstname; ?>" src="<?php echo $users->profile_photo; ?>"></a></td>
                                                                            <td>
                                                                            <?php if ($users->v_email == '1') { ?>
                                                                            <a class='btn btn-success btn-xs has-tooltip' data-placement='top' title='Email Verified'>  <i class='icon-envelope'></i></a><?php  } else { ?><a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Email Not Verified'>  <i class='icon-envelope'></i></a><?php }	if ($users->v_mobile == '1') { ?> <a class='btn btn-success btn-xs has-tooltip' data-placement='top' title='Phone Verified'>  <i class='icon-phone'></i></a><?php  } else { ?>   <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Phone Not Verified'>  <i class='icon-phone'></i></a>    <?php } ?>&nbsp;<?= $users->firstname; ?></td>
                                                                            <td><?= $users->email; ?></td>
                                                                                    ...
                                                                                    <div class='modal-dialog'>
                                                                                        <div class='modal-content'>
                                                                                            <div class='modal-header'>
                                                                                                <button aria-hidden='true' class='close' data-dismiss='modal' type='button'>&Auml;&sbquo;&mdash;</button>
                                                                                            ...
                                                                                            <div class='modal-body'>
																								...
																								<?php $i = 1; foreach ($promo as $promos) { ?>
                                                                                                            <label class="control-label" for="validation_promo<?= $c . $i; ?>">Choose Any One Promo</label><br>
                                                                                                            <div class='radio'>
                                                                                                                <label><input type='radio' data-rule-required='true' id="validation_promo<?= $c . $i; ?>" name="promoid" value='<?php echo $promos->promo_id; ?>'>
                                                                                                            <?php echo $promos->promo_code; ?> - <em> <?php echo $promos->discount; ?>% discount, valid upto <?php echo date('M j,Y', strtotime($promos->exp_date)); ?></em>
                                                                                                                </label>
                                                                                                            </div>
																								<?php $i++; } ?>
                                                                                                    </div>
                    ...
                    <a class='btn btn-inverse btn-xs has-tooltip' data-placement='top' title='Send Promo Code' data-toggle='modal' href='#modal-example2<?= $c; ?>' role='button'>
                                                                                    ...
                                                                                    <a class='btn btn-danger btn-xs has-tooltip' onclick="return confirm('Are you sure?')" data-placement='top' title='Delete' href='<?php echo WEB_URL; ?>b2c/update_user_status/<?= $users->user_id; ?>/2'>
                                                                                        <i class='icon-remove'></i>
                                                                                    </a>
                                                                      <?php 
																	  if($users->property_owner_created != 1) {
																	  if ($users->v_email == '1' && $users->v_mobile == '1') { ?>              
                                                                                ...
                                                                                <?php
																	  } else { ?> <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' title='Still profile verfication pending. So cant create property owner account of this user.' >
                                                                                        <i class='icon-copy'></i>
                                                                                    </a><?php } } ?>
                                                                                </div>
                                                                            </td>
