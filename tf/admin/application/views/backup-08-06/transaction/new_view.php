...
<html>
  ...
  <?php if(isset($message) && $message!=''){
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <form method="post" id="myform" action="<?php echo base_url(); ?>b2c/export_b2c_users" >
                                        <div class='box-header blue-background'>
                                            <div class='title'>New Transaction Request</div>
		...
		?>
                  ...
                  <form class="form" style="margin-bottom: 0;" action="<?php echo WEB_URL.'transaction/update_transaction_status/'.$result->transaction_id.'/'.$result->pnr_no; ?>" method="post" accept-charset="UTF-8">
    ...
    <script type="text/javascript">
		...
		$url = "<?php echo WEB_URL.'transaction/update_transaction_status/'; ?>"+id+"/"+val;
	//		alert($url);
