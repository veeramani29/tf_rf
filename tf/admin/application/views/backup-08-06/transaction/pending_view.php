...
<html>
  ...
  <?php if(isset($message) && $message!=''){
                                ...
                                <div class='col-sm-12'>
                                    ...
                                    <form method="post" id="myform" action="<?php echo base_url(); ?>b2c/export_b2c_users" >
                                        <div class='box-header blue-background'>
                                            <div class='title'>Current / Pending Transaction</div>
		...
		$url = base_url().'upload_files/temp_image/'.$uniqid.'.jpg';
		?>
                  ...
                  <form class="form" style="margin-bottom: 0;" action="<?php echo WEB_URL.'transaction/update_transaction_status_pend/'.$result->transaction_id.'/'.$result->pnr_no; ?>" method="post" accept-charset="UTF-8">
                          <div class='form-group'>
                              <label for='inputText1'>New Status</label>
                               <?php if($result->payout_status == 'Process') { ?>
                                                 ...
                                                 <option value="Failed">Failed</option>
                                                                                    ...
                                                                                    <?php  } if($result->payout_status == 'Deposit') { ?>
                                                                                    <select  name="status"  data-rule-required='true'>
                                                     <option value="" >Change The Status</option>                                
                                                
                                                
												 <option value="Process">Re-Process</option>
                                                 
                                                 
                                                 <option value="Failed_d">Failed</option>
