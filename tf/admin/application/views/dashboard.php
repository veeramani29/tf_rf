...
if(isset($get_b2b_stats)){
    $b2b_data_array = array();
    foreach($get_b2b_stats as $stats_key) {
      $stats_b2b_key_array = array(strtotime($stats_key->reg_date)*1000, $stats_key->reg_count);
      array_push($b2b_data_array, $stats_b2b_key_array);
    }
}
if(isset($get_flight_booking_stats)){
    $flight_stats = array();
...
if(isset($get_hotel_booking_stats)){
    $hotel_stats = array();
...
if(isset($get_apt_booking_stats)){
    $apt_stats = array();
    foreach($get_apt_booking_stats as $apt_key) {
      $apt_key_array = array(strtotime($apt_key->book_date)*1000, $apt_key->apt_count);
