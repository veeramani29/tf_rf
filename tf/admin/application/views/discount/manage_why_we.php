...
<html>
<head>
    <title>Manage Why We | <?php echo PROJECT_NAME;?></title>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Why We Management</div>

                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>discount/add_why_we"> <button class='btn' style='margin-bottom:5px'  ><i class='icon-male'></i> Add Why We</button></a>
				...
				?>
                              <tr>
                                <td><?=$c;?></td>
                                <td><?=$p->title; ?></td>
                                <td><a target="_blank" href="<?php echo ($p->url!=null)?$p->url:'javascript:;';?>"><?php echo ($p->url!=null)?$p->url:'N/A';?></a></td>
                                 <td><img src="<?php echo WHY_WE_IMG.$p->icon;?>"></td>
                                 ...
                                 <select onchange="activate(this.value);">
                                   <?php if($p->status == '1'){?>
                                    <option value="<?php echo WEB_URL; ?>discount/why_we_updateStatus/<?php echo $p->id; ?>/1" selected>Activate</option>
                                    <option value="<?php echo WEB_URL; ?>discount/why_we_updateStatus/<?php echo $p->id; ?>/0">De-activate</option>
                                    <?php }else{?>
                                    <option value="<?php echo WEB_URL; ?>discount/why_we_updateStatus/<?php echo $p->id; ?>/1">Activate</option>
                                    <option value="<?php echo WEB_URL; ?>discount/why_we_updateStatus/<?php echo $p->id; ?>/0" selected>De-activate</option>
                                  </select>
                                  <?php }?>
                                </td>
                                <td>
			 	 <div class='text-right'>
				<a class='btn btn-info btn-xs has-tooltip' data-placement='top' title='Edit Page' href='<?php echo WEB_URL; ?>discount/add_why_we/<?=$p->id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
				 <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' onclick="return confirm('Do you want delete this record');" title='Delete' href='<?php echo WEB_URL; ?>discount/why_we_delete/<?=$p->id;?>'>
