...
<html>
<head>
    <title>Add Submenu| <?php echo PROJECT_NAME;?></title>
              ...
              <!-- TAB-2 star here -->
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <textarea name="con" class='form-control ckeditor' id='wysiwyg2' rows='10' data-rule-required='true'> 
                       </textarea>
                    </div>
                  </div>
                </div>
            ...
            <div class="cloneSection">
                <form class='form form-horizontal validate-form' id='linkForm' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>help_center/add_content_link" method="post" name="frm3" enctype="multipart/form-data"> 
                    ...
                    <div class='form-actions' style='margin-bottom:0'>
                        <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>help_center/sub_menus/<?php echo $result->menu_id; ?>">
