...
<html>
<head>
    <title>Price Management | <?php echo PROJECT_NAME;?></title>
                  ...
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    ...
                    <div class='title'>Price Management</div>
                       ...
                       <a  href="#"><i> &nbsp</i></a>
                    	 ...
                    	 <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>hotelcrs/addPrice/<?php echo $supplier_id;?>/<?php echo $hotel_id;?>/<?php echo $room_id;?>"> <button class='btn' style='margin-bottom:5px'><i class='icon-plus'></i> Add pricing</button></a>
                       <a  href="#"><i> &nbsp</i></a>
                      </div>
                            ...
                            <thead>
                              <tr>
                                ...
                                <th>Type</th>
                       			...
                       			<tbody>
    												 <?php if(!empty($pricings)) { $count = 1; foreach($pricings as $key => $price) {?>
											        <tr>
                                <td><?php echo $count; ?></td>
      											    <td><?php echo $price->type; ?></td>
      													<td><?php echo date('D, d M Y',strtotime($price->from)); ?> to <?php echo date('D, d M Y',strtotime($price->to)); ?></td>
                                <td><?php echo $price->per_adult; ?></td>
      													<td class="center">
                                    ...
                                    <a href="<?php echo WEB_URL; ?>hotelcrs/del_price/<?php echo $supplier_id; ?>/<?php echo $hotel_id; ?>/<?php echo $room_id; ?>/<?php echo $price->id;?>/<?php echo $price->type; ?>"  data-original-title="Delete"  onclick="return confirm('Do you want delete this record');" class="btn btn-danger btn-xs has-tooltip" data-original-title="Delete"> 
