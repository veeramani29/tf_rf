                  ...
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>markup_b2c/UpdateB2CMarkUp/<?=$MDDetail->MDId;?>" method="post"  enctype="multipart/form-data" onsubmit="return validateDup()"> 
                        ...
                        <div class='form-group' id='MaxAmountCon' <?if($MDDetail->Per != 'Person'){echo "style='display:none;'";}?>>
                        ...
                        <div class='form-group'>
                          ...
                          <div class='col-sm-6 controls'>
                            <select class='select2 form-control' data-placeholder='Select' data-rule-required='true' id='AllAirline' name='AllAirlines'>
                                <option value="Y" <?=($MDDetail->AllAirlines == 'Y') ? "selected" : "";?>>Yes</option>
                                <option value="N" <?=($MDDetail->AllAirlines == 'N') ? "selected" : "";?>>No</option>
                            </select>
                          </div>
                        </div> 

                        <div class='form-group' id='ExceptAirlinesCon' <?=($MDDetail->AllAirlines == 'Y') ? "style='display:none;'" : "";?>>
                          ...
                          <div class='col-sm-6 controls'>
                            <select class="form-control multiselect searchable" data-placeholder='Select' data-rule-required='true' id='ExceptAirlines' name='ExceptAirlines[]' multiple>
                              <?php
                                $ExceptList = explode('|||', $MDDetail->ExceptAirlines);
                                // echo "<pre>";print_r($ExceptList);exit;
                                foreach ($AirlinesList as $Airline) {
                                ?>
                                  <option value="<?=$Airline->airline_code;?>" <?=(in_array($Airline->airline_code,$ExceptList)) ? 'selected' : '';?> ><?=$Airline->airline_name.' - '.$Airline->airline_code?></option>
                                <?php    
                                }
                              ?>
                            </select>
