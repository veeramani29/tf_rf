<?php $extra=$this->uri->segment(3, 0); $check_in_details=isset($check_in_details[0])?$check_in_details[0]:''; //print_r($check_in_details);exit;?>

<!DOCTYPE html>
<html>
<head>
    <title><?php echo ($extra!='')?"Update":"Add";?> Check In| <?php echo PROJECT_NAME;?></title>
    ...
    <div id='wrapper'>
      ...
      <section id='content'>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='page-header'>
                    <h1 class='pull-left'>
                      <i class='icon-male'></i>
                      <span><?php echo ($extra!='')?"Update":"Add";?> Check In</span>
                    </h1>
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li>
                         <a href="<?php echo WEB_URL; ?>home_settings/check_in"> View all Check In</a>
                        </li>
                        <li class='separator'>
                          <i class='icon-angle-right'></i>
                        </li>
                        <li class='active'><?php echo ($extra!='')?"Update":"Add";?> Check In</li>
                      </ul>
                    </div>
                  </div>
                </div>
		...
		<div class='row'>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'><?php echo ($extra!='')?"Update":"Add";?> Check In</div>
                      <div class='actions'>
			...
			<input type="hidden" name="thisController" id="thisController" value="<?php echo base_url(); ?>home_settings/" >	
			<p style="color:red;text-align: center;"><?php echo (isset($err_msg) && $err_msg!='')?$err_msg:"";?></p>
			
                        
                         <div class='form-group'>
                        <label class='control-label col-sm-3 col-sm-3' for='airline_list'>Airline <small class="has-error">*</small></label>
                          <div class='col-sm-3 controls'>
				 <select  class='select2 form-control' data-rule-required='true' name='airline_list' id="airline_list">
                              <option value="">Select</option>
                              <?php  
                             $airline_code_sel=isset($check_in_details->airline_code)?$check_in_details->airline_code:'';
                               	foreach ($airline_list as $airline_data) {?>
								 
                                <option value='<?=$airline_data->airline_code;?>' <?php  if($airline_data->airline_code==$airline_code_sel) { echo 'selected="selected"'; }?>><?=$airline_data->airline_name;?></option>
                              <?php  } ?>
                           </select>
                          </div>
						</div>	  
						...
						<div class='form-group'>
                          ...
                          <div class='col-sm-4 controls'>
                            <input class='form-control'  data-rule-required='true'  value="<?php echo isset($check_in_details->url)?$check_in_details->url:'';?>"  id="txtUrl" name='txtUrl' placeholder='Url' type='url'>
                          </div>
                        </div>
                        ...
                        <?php if($extra!=''){ ?>
                          ...
                          <div class='col-sm-4 controls'>
                           <img width="100px" height="100px" src="https://www.amadeus.net/static/img/static/airlines/medium/<?php echo $check_in_details->icon;?>"/>
                          </div>
                        </div>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>home_settings/check_in"><button class='btn btn-primary' type='button'>
                                <i class='icon-reply'></i>
                                Go Back
                              </button></a>
                              <button class='btn btn-primary' value="submit" type='submit' name="check_in" id="newPageForm">
                                <i class='icon-save'></i>
                               <?php echo ($extra!='')?"Update":"Add";?> Check In
                              </button>
                            </div>
                          </div>
                        </div>
