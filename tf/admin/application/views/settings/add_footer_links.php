...
<html>
<head>
    <title>Footer Links | <?php echo PROJECT_NAME;?></title>
			...
			<div class='box-content'>
		            <div class='tabbable' style='margin-top: 20px'>
		              <ul class='nav nav-responsive nav-tabs'>
		                <li class='active'><a data-toggle='tab' href='#retab1' class="tabpage" id="discover"><i class='icon-inbox'></i> Discover</a></li>
		                <li class=''><a data-toggle='tab' href='#retab2' class="tabpage" id="business"><i class='icon-inbox'></i> Business</a></li>
				...
				<input type="hidden" value="discover" name="page" id="page">
				...
				<div class='form-group'>                                
                                	<input class='form-control'  data-rule-required='true' name='dutch' placeholder='Type your new dutch word for link here...Ex : / flight search / car search' type='text'>
				</div>
				...
				<div class="modal fade addModelid" id="" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				  <div class="modal-dialog">
					...
					<div class='form-group'>   
						<label class='control-label col-sm-2'>Dutch</label>
		                        	<input class='form-control' id='dutch' data-rule-required='true' value="" name='dutch' placeholder='Type your new dutch word for label here...Ex : Change Date / Cancellation / Amendment' type='text'>
					</div>
