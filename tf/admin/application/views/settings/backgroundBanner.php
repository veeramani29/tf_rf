                ...
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Slide Banner Management</div>

                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>home_settings/backgroundForm"> <button class='btn' style='margin-bottom:5px'  ><i class='icon-male'></i> Add Slide Banner</button></a>
                       ...
                       <a class="btn box-collapse btn-xs btn-link" href="#"><i></i></a>
                          ...
                          <table class='data-table-column-filter table table-bordered table-striped' style='margin-bottom:0;'>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><?=$c;?></td>
                                <td><a data-lightbox='flatty' href='<?php echo $back->background_image;?>'>
