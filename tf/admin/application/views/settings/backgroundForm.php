                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Update Background</div>
                      <div class='actions'>
                    ...
                    <div class='box-content'>
                      <form class='form form-horizontal validate-form'   style='margin-bottom: 0;' action="<?php echo WEB_URL; ?>home_settings/addbackground" method="post"  enctype="multipart/form-data"> 
		<input type="hidden" name="hdnimagesizeval" id="hdnimagesizeval">
			                   <div class='form-group'>
                          <label class='control-label col-sm-3' for='validation_image'>Banner image</label>
                          <div class='col-sm-4 controls'>
                            ...
                            <br>
                          <small style="color:green;">Please Upload slider banner image size 1680x450</small>
                          </div>
                        ...
                        <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>home_settings/backgroundbanner"><button class='btn btn-primary' type='button'>
...
img = new Image();
img.onload = function () {
if(this.width!=1680 || this.height!=450){
  
alert("Your banner size should be equal to 1680x450");
