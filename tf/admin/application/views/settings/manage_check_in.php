...
<html>
<head>
    <title>Manage Check In | <?php echo PROJECT_NAME;?></title>
            ...
            <div class='col-xs-12'>
              ...
              <div class='row'>
                <div class='col-sm-12'>
                  <div class='box bordered-box orange-border' style='margin-bottom:0;'>
                    <div class='box-header blue-background'>
                      <div class='title'>Check In Management</div>

                      <div class='actions'>
                       <a href="<?php echo WEB_URL; ?>home_settings/add_check_in"> <button class='btn' style='margin-bottom:5px'  ><i class='icon-male'></i> Add Check In</button></a>
				...
				?>
                              <tr>
                                <td><?=$c;?></td>
                                <td> <?php echo $this->booking_model->get_airline_name($p->airline_code);?> (<?=$p->airline_code; ?>)</td>
                                <td><a target="_blank" href="<?=$p->url;?>"><?=$p->url;?></a></td>
                                 <td><img src="https://www.amadeus.net/static/img/static/airlines/small/<?php echo $p->icon;?>"></td>
                                 ...
                                 <select onchange="activate(this.value);">
                                   <?php if($p->status == '1'){?>
                                    <option value="<?php echo WEB_URL; ?>home_settings/check_in_updateStatus/<?php echo $p->id; ?>/1" selected>Activate</option>
                                    <option value="<?php echo WEB_URL; ?>home_settings/check_in_updateStatus/<?php echo $p->id; ?>/0">De-activate</option>
                                    <?php }else{?>
                                    <option value="<?php echo WEB_URL; ?>home_settings/check_in_updateStatus/<?php echo $p->id; ?>/1">Activate</option>
                                    <option value="<?php echo WEB_URL; ?>home_settings/check_in_updateStatus/<?php echo $p->id; ?>/0" selected>De-activate</option>
                                  </select>
                                  <?php }?>
                                </td>
                                <td>
			 	 <div class='text-right'>
				<a class='btn btn-info btn-xs has-tooltip' data-placement='top' title='Edit Page' href='<?php echo WEB_URL; ?>home_settings/add_check_in/<?=$p->id;?>'>
                                      <i class='icon-edit'></i>
                                    </a>
				 <a class='btn btn-danger btn-xs has-tooltip' data-placement='top' onclick="return confirm('Do you want delete this record');" title='Delete' href='<?php echo WEB_URL; ?>home_settings/check_in_delete/<?=$p->id;?>'>
