...
<nav id='main-nav'>
      ...
      ?>  
           ...
           <!--
            ...
            <li class='<?php if($controller == 'markup_b2c' || $controller == 'markup_b2b'){echo'active';}?>'>
              ...
              <ul class='<?php if($controller == 'markup_b2c' || $controller == 'markup_b2b'){echo'in';}?> nav nav-stacked'>
               <?php ?> <li class='<?php if($controller == 'markup_b2c'){echo'active';}?>'>
                  <a href='<?php echo WEB_URL; ?>markup_b2c'>
                    <i class='icon-user'></i>
                    <span>B2C Markup/Discount</span>
                  </a>
                </li><?php ?>
            ...
            <li class='<?php if($controller == 'orders' || $controller == 'manage_orders'){echo'active';}?>'>
                 <a class="dropdown-collapse" href="#"><i class='icon-inbox'></i>
                    <span>Booking Orders</span><i class='icon-angle-down angle-down'></i>
                  </a>
                  <ul class='<?php if($controller == 'orders' || $controller == 'manage_orders'){echo'in';}?> nav nav-stacked'>
                  
                   <?php ?> <li class='<?php if($controller == 'orders' && $method == 'b2c_orders'){echo'active';}?>'>
                    ...
                    <!--
                    <li class='<?php if($controller == 'orders' && $method == 'b2b_orders'){echo'active';}?>'>
                      <a href='<?php echo WEB_URL; ?>orders/b2b_orders'>
                        <i class='icon-male'></i>
                        <span>B2B Bookings</span>
                      </a>
                    </li>
                    -->
                    
                     <li class='<?php if($controller == 'orders' && $method == 'guest_orders'){echo'active';}?>'>
                      <a href='<?php echo WEB_URL; ?>orders/guest_orders'>
                        <i class='icon-male'></i>
                        <span>Guest Bookings</span>
                      </a>
                    </li> 
                     <li class='<?php if($controller == 'manage_orders'){echo'active';}?>'>
                      <a href='<?php echo WEB_URL; ?>manage_orders/'>
                        <i class='icon-male'></i>
        ...
        <!--    <li class='<?php if($controller == 'payment' && $method == 'index'){echo'active';}?>'>
              <a href='<?php echo WEB_URL; ?>payment'>
                <i class='icon-usd'></i>
                <span>Payment Gateway Charge Management</span>
              </a>
            </li>
            ...
            <!--<li class='<?php if($controller == 'packages'){echo 'active';}?>'>
              <a class="dropdown-collapse" href="#"><i class='icon-picture'></i>
                <span>Package Management</span><i class='icon-angle-down angle-down'></i>
              </a>
              <ul class='<?php if($controller == 'packages'){echo'in';}?> nav nav-stacked'>
              
                  <li class='<?php if($controller == 'packages'){ echo'active'; }?>'>
                  <a href='<?php echo WEB_URL; ?>packages/package_type'>
                    <i class='icon-user'></i>
                    <span>Packages Types</span>
                  </a>
                </li>
                
                <li class='<?php if($controller == 'package'){ echo'active'; }?>'>
                  <a href='<?php echo WEB_URL; ?>packages'>
                    <i class='icon-user'></i>
                    <span>Packages</span>
                  </a>
                </li>
            ...
            <li class='<?php if($controller == 'hotelcrs'){echo'active';}?>'>
           ...
           <li class='<?php if($controller == 'email'){echo'active';}?>'>
              <a href='<?php echo WEB_URL; ?>email/manage_emails'>
                <i class='icon-envelope'></i>
                <span>Manage Emails</span>
              </a>
            </li>

            <li class='<?php if($controller == 'newsletter'){echo'active';}?>'>
              <a class="dropdown-collapse" href="#"><i class='icon-envelope-alt'></i>
                <span>Newsletter</span><i class='icon-angle-down angle-down'></i>
              </a>
              <ul class='<?php if(($controller == 'newsletter' && $method == 'manage_newsletter') || $controller == 'newsletter' && $method == 'all_campaign' || $controller == 'newsletter' && $method == 'b2b_subscriber' || $controller == 'newsletter' && $method == 'b2c_subscriber' || $controller == 'newsletter' && $method == 'unregistered_subscriber'){echo'in';}?> nav nav-stacked'>
                <li class='<?php if(($controller == 'support' && $method == 'support_view') || $controller == 'support' && $method == 'add_ticket' || $controller == 'support' && $method == 'view_ticket'){echo'active';}?>'>
                  <a href='<?php echo WEB_URL; ?>newsletter/manage_newsletter'>
                    <i class='icon-ticket'></i>
                    <span>Manage Newsletter</span>
                  </a>
                </li>
                <li class='<?php if($controller == 'support' && $method == 'add_subject'){echo'active';}?>'>
                  <a href='<?php echo WEB_URL; ?>newsletter/all_campaign'>
                    <i class='icon-plus'></i>
                    <span>Manage Campaign</span>
                  </a>
                </li>
                <?php /*?>  <li class='<?php if($controller == 'support' && $method == 'view_subscribers'){echo'active';}?>'>
                  <a href='<?php echo WEB_URL; ?>newsletter/b2b_subscriber'>
                    <i class='icon-plus'></i>
                    <span>View B2B subscribers</span>
                  </a>
                </li><?php */?>
              <li class='<?php if($controller == 'support' && $method == 'view_subscribers'){echo'active';}?>'>
                  <a href='<?php echo WEB_URL; ?>newsletter/b2c_subscriber'>
                    <i class='icon-plus'></i>
                    <span>View B2C subscribers</span>
                  </a>
                </li>
                <li class='<?php if($controller == 'support' && $method == 'view_subscribers'){echo'active';}?>'>
                  <a href='<?php echo WEB_URL; ?>newsletter/unregistered_subscriber'>
                    <i class='icon-plus'></i>
                    <span>View unregistered subscribers</span>
                  </a>
                </li>
              </ul>
            </li>
    ...
    <ul class='<?php if($controller == 'home_settings'){echo'in';}?> nav nav-stacked'>
                    <li class='<?php if($controller == 'home_settings' && $method == 'index'){echo'active';}?>'>
                        <a href='<?php echo WEB_URL; ?>home_settings'>
                          <i class='icon-link'></i>
                          <span>Home & Footer settings</span>
                        </a>
              </li>
       <!-- <li class='<?php if($controller == 'home_settings' && $method == 'portfolio'){echo'active';}?>'>
              ...
              <li class='<?php if($controller == 'home_settings' && $method == 'social_links'){echo'active';}?>'>
               ...
               <li class='<?php if($controller == 'home_settings' && $method == 'insurance_settings'){echo'active';}?>'>
                        <a href='<?php echo WEB_URL; ?>home_settings/insurance_settings'>
                          <i class='icon-euro'></i>
                          <span>Insurance Settings</span>
                        </a>
              </li>
               <li class='<?php if($controller == 'home_settings' && $method == 'headerLinks'){echo'active';}?>'>
                        <a href='<?php echo WEB_URL; ?>home_settings/headerLinks'>
                          <i class='icon-link'></i>
                          <span>Header Links</span>
                        </a>
              </li>

        <li class='<?php if($controller == 'home_settings' && $method == 'addFooterLinks'){echo'active';}?>'>
                        <a href='<?php echo WEB_URL; ?>home_settings/addFooterLinks'>
                          <i class='icon-link'></i>
                          <span>Footer Links</span>
                        </a>
              </li>
              <li class='<?php if($controller == 'home_settings' && $method == 'check_in'){echo'active';}?>'>
                        <a href='<?php echo WEB_URL; ?>home_settings/check_in'>
                          <i class='icon-link'></i>
                          <span>Check In</span>
                        </a>
              </li>
               <li class='<?php if($controller == 'home_settings' && $method == 'backgroundbanner'){echo'active';}?>'>
                        <a href='<?php echo WEB_URL; ?>home_settings/backgroundbanner'>
                          <i class='icon-link'></i>
                          <span>Slide Banners Management</span>
                        </a>
              </li>
    ...
    <ul class='<?php if($controller == 'cms'){echo'in';}?> nav nav-stacked'>
         ...
         <li class='<?php if($controller == 'cms' && $method == 'viewAllPages'){echo'active';}?>'>
                    ...
                    <li class='<?php if($controller == 'discount' && ($method!= 'why_we' || $method!= 'add_why_we')){echo'active';}?>'>
                        <a href='<?php echo WEB_URL; ?>discount/add_new_offer'>
                          <i class='icon-link'></i>
                          <span>All Flight Offers</span>
                        </a>
				
      
       <li class='<?php if($controller == 'xml_logs'){echo'active';}?>'>
              <a href='<?php echo WEB_URL; ?>xml_logs/getAllXmlLogs' >
                <i class='icon-code'></i>
                <span>XML Logs</span>
              </a>
       </li>
       <li class='<?php if($controller == 'discount' && ($method == 'why_we' || $method== 'add_why_we')){echo'active';}?>'>
              <a href='<?php echo WEB_URL; ?>discount/why_we' >
                <i class='icon-code'></i>
                <span>Why We</span>
              </a>
       </li>
       <li class='<?php if($controller == 'help_center' && ($method == 'addhelplink' || $method== 'edit_menu')){echo'active';}?>'>
