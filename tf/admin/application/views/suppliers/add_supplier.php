...
<html>
<head>
    <title>Add Suppliers Info | <?php echo PROJECT_NAME;?></title>
                  ...
                  <div class='page-header'>
                    ...
                    <div class='pull-right'>
                      <ul class='breadcrumb'>
                        ...
                        <li class='active'>Add Suppliers Info</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    <div class='box-header blue-background'>
                      <div class='title'>Add Suppliers Info</div>
                      <div class='actions'>
					...
					if(isset($error))
					{
						echo '<font color="#FF0004"><strong>'.$error.'</font></strong>'; 
					}
					?>
 <form action="<?php echo WEB_URL; ?>supplier/insert_supplier" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>								
                         ...
                         <input type="text" name="emailid" id="email"  data-rule-email='true' data-rule-required='true'  class='form-control'>
                          ...
                          <div class='form-group'>
                         	...
                         	<input type="password" name="password" id="password" data-rule-minlength='6' data-rule-password='true' data-rule-required='true' class='form-control'>
                          </div>
                          ...
                          <div class='form-group'>
                         	 <label class='control-label col-sm-3'  for='validation_current'>Confirm Password
                          	 ...
                          	 <div class='col-sm-4 controls'>
                          		...
                          		<input type="password" name="confirm_password" id="confirm_password" data-rule-required='true' class='form-control' equalto="#password">
                          ...
                          <div class='form-group'>
                            ...
                            <div class="controls">
                        	<input type="text" name="fname" id="fname" data-rule-required='true' class='form-control'>
                        	</div>
                     	...
                     	<input type="text" name="lname" id="lname" data-rule-required='true' class='form-control'>
                        ...
                        <input type="text" name="mobile" id="mobile" data-rule-number='true' data-rule-required='true' class='form-control'>
                          ...
                          <div class='form-group'>
                         	 <label class='control-label col-sm-3'  for='validation_current'>Phone Number
                          	 ...
                          	 <div class='col-sm-4 controls'>
                       			...
                       			<input type="text" name="ph_no" id="ph_no" data-rule-number='true' data-rule-required='true' class='form-control'>
                          ...
                          <div class='form-group'>
                         	 <label class='control-label col-sm-3'  for='validation_current'>Adddress  </label>
                          	 <div class='col-sm-4 controls'>
                        			...
                        			<input type="text" name="address" id="address" data-rule-required='true' class='form-control'>
                          ...
                          <div class='form-group'>
                         	 <label class='control-label col-sm-3'  for='validation_current'>Postal Code
                          	 ...
                          	 <div class='col-sm-4 controls'>
                          		...
                          		<input type="text" name="post_code" id="post_code" data-rule-required='true' class='form-control'>
