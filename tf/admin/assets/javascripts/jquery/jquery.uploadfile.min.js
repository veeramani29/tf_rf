    ...
    e.fn.uploadFile = function (n) {
        ...
        function h(t, n, r) {
            for (var i = 0; i < r.length; i++) {
                if (!p(n, t, r[i].name)) {
                    if (t.showError) e("<div style='color:red;'><b>" + r[i].name+"&nbsp;"+t.extErrorStr + "</b> <br/>" + t.allowedTypes + "</div>").appendTo(n.errorLog);
                    continue
                }
        ...
        function m(n, r, i, s) {
            ...
            var u = e("<label style='position:relative !important;opacity:1 !important;'>Upload File</label><form method='" + i.method + "' action='" + i.url + "' enctype='" + i.enctype + "'></form>");
            var a = "<label>Upload File<label> <input type='file' id='" + o + "' name='" + i.fileName + "' accept='" + i.acceptFiles + "'/>";
            if (i.multiple) {
        ...
        function g(t, n) {
            this.statusbar = e("<div class=''></div>").width(n.statusBarWidth);
            ...
            this.filename = e("<div class=''></div>").appendTo();
            this.progressDiv = e("<div class='ajax-file-upload-progress'>").html(this.statusbar).hide();
            ...
            this.done = e("<div class='ajax-file-upload-green'></div>").appendTo().hide();
            this.downloadStr = e("<div class='ajax-file-upload-green'></div>").appendTo(this.statusbar).hide();
            this.del = e("<div class='ajax-file-upload-red'>" + n.deletelStr + "</div>").appendTo(this.statusbar).hide();
            if (n.showQueueDiv) e("#" + n.showQueueDiv).html(this.statusbar);
            else t.errorLog.html(this.statusbar);
            return this
        }
        ...
        var r = e.extend({
            ...
            extErrorStr: "is not allowed. <br> Allowed extensions: ",
