...
(function() {
  ...
  */
  ...
  $(document).ready(function() {
    ...
    */
    ...
    // setDataTable($(".data-table-column-filter1"));
    /*
    * --------------------------------------------------------------------------------------------------------------------
  ...
  */
  ...
  this.setDataTable1 = function(selector) {
    if (jQuery().dataTable) {
      return selector.each(function(i, elem) {
        var dt, sdom;
        if ($(elem).data("pagination-top-bottom") === true) {
        ...
        dt = $(elem).dataTable({
          ...
          "iDisplayLength": $(elem).data("pagination-records") || 10,
          tableTools: {
            "sSwfPath": api_url+"assets/swf/copy_csv_xls_pdf.swf"
          },
          oLanguage: {
            sLengthMenu: "_MENU_ records per page"
          },
        ...
        if ($(elem).hasClass("data-table-column-filter1")) {
          return dt.columnFilter();
        }
        if ($(elem).hasClass("data-table-column-filter2")) {
          return dt.columnFilter();
        }
        if ($(elem).hasClass("data-table-column-filter3")) {
          return dt.columnFilter();
        }
      });
    }
