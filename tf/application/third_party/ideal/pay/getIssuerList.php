...
<body onload="BodyOnLoad()" >
    <table border="0" width="100%">
        ...
        <tr>
            ...
            <td><span style="font: bold 24pt arial">Welcome To Ideal Payment</span><br>
                <span style="font: 18pt arial">Please Select your Bank And Countinue</span></td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="box" width="100%">
        ...
        <tr>
            <td style="margin:0;padding:0">
                <form class="center" name="same" id="same" action="getIssuerList.php" method="post">
    ...
    <table class="box" width="100%">
        <tbody>
                <?php  if($errorCode != "") { ?>
        <tr>
            <td colspan="2" width="200">Error Code</td><td><?php echo $errorCode; ?></td>
        </tr>
        <tr>
            <td colspan="2">Error Message</td><td><?php echo $errorMsg; ?></td>
        </tr>
        <tr>
            <td colspan="2">Consumer Message</td><td><?php echo $consumerMessage; ?></td>
        </tr>
            <?php } else { ?>
       <!-- <tr>
