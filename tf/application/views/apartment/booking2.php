...
<div class="insurance_container">
	...
	<div class="col-sm-12 pad0">
		<div class="inscon_style">
			<label for="no_travel">
				<input type="radio" name="insurance_type" id="no_travel" selval="no_travel" checked=""  value="No Insurance">
				No Insurance <span class="ics_text"><?php echo CURR_ICON ;?> 0</span>
			</label>
		</div>
	</div>
	<div class="col-sm-12 pad0">
		<div class="inscon_style inscon_styleinp">
			<div class="col-sm-10 padl0">
				<label for="travel">
					<input type="radio" name="insurance_type" id="travel" selval="travel" value="Travel Insurance">Travel Insurance 
					<span class="ics_passenger">
						X Passenger
			...
			<div class="col-sm-2 pad0">
				<span class="ics_text">
					<?php echo CURR_ICON." ".round($other_total_travel_insurance, 1, PHP_ROUND_HALF_UP);?>
				</span>
			</div>
		</div>
	</div>
	<div class="col-sm-12 pad0">
		<div class="inscon_style">
			<label for="cancel">
				<input type="radio" name="insurance_type" id="cancel" selval="cancel" value="Cancellation Insurance">Cancellation Insurance <span class="ics_text"><?php echo CURR_ICON." ".round($total_cancel_insurance,1,PHP_ROUND_HALF_UP);?></span>
			</label>
		</div>
	</div> 
	<div class="col-sm-12 pad0">
		<div class="inscon_style inscon_styleinp">
			<div class="col-sm-10 padl0">
				<label for="combed">
					<input type="radio" name="insurance_type" id="combed" selval="combed" value="Combined Travel Cancellation Insurance">Combined Travel Cancellation Insurance 
					<span class="ics_passenger">
						X Passenger
			...
			<div class="col-sm-2 pad0">
				<span class="ics_text"><?php echo CURR_ICON." ".round($total_combed_insurance,1,PHP_ROUND_HALF_UP);?></span>
			</div>
		</div>
	</div>
</div>
