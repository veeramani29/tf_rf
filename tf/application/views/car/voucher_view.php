...
Booking Class: <?php echo $car->VehicleClass;?><br>
  ...
  <tr>
    <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;">Pickup At:<br><span style="font-size:16px; font-weight:bold;"><?php echo date('d M, D Y H:i', $this->flight_model->get_unixtimestamp($car->PickupDateTime));?></span><br></td>
    <td bgcolor="#FFFFFF" style="border-right:1px solid #EEE;">Return At:<br><span style="font-size:16px; font-weight:bold;"><?php echo date('d M, D Y H:i', $this->flight_model->get_unixtimestamp($car->ReturnDateTime));?></span><br>
</td>
    </tr>
        </tbody></table>
