...
<!-- JS file -->
<script src="<?php echo ASSETS;?>js/jquery.easy-autocomplete.min.js"></script> 

<!-- CSS file -->
<link rel="stylesheet" href="<?php echo ASSETS;?>css/easy-autocomplete.min.css"> 
  ...
  <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWRj7iijpG2w3xNlYk-FDuYln1MgtIurs">
    </script>
</head>
