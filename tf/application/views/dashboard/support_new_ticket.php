                            ...
                            <div class="tiktcntnt">
                                ...
                                <div class="col-md-4">
                                    <div class="ticketactn">
                                        <a class="viewtickt viewTicket" id="<?php echo $support_sent->id; ?>" href="#viewticketss<?php echo $support_sent->id; ?>" data-toggle="tab">View Ticket</a>
                                        <a class="closetickt"  id="closeticket<?php echo $support_sent->support_ticket_id; ?>" href="javascript:void(0)" ticketid="<?php echo $support_sent->support_ticket_id; ?>" tickettype="sentTickets">Close Ticket</a>
                                    </div> 
                                </div>
                            </div>
            </div>
