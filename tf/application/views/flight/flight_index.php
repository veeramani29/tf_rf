	...
	<div class="main-text">
		<div class="col-md-12 text-center">
			<div class="container">
				...
				<form class="custom show-search-options position-left clearfix form-inline"  name="flight" id="flight" action="<?php echo WEB_URL;?>/flight/search" autocomplete="off">
					...
					<div id="one-round">
						...
						<div class="input-wrapper">
							<select class="checkoutWrapper select-main form-control" id="class" name="class" required>
							...
							<div id="multi_city_select" style="display: none;">
								<div id="paste_div">
									...
									<div class="multi_city_4  multi-city" style="display:none">
										<div class="input-wrapper">
											<input type="text" required="" id="from5" name="mfrom[4]" placeholder="From" class="flyinput fromflight form-control" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>
										<div class="input-wrapper">
											<input type="text" required="" id="to5" name="mto[4]" placeholder="To" class="flyinput fromflight form-control" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>

										<div class="input-wrapper">
											<input type="text" required="" id="depature5" name="mdepature[4]" placeholder="Depart" class="flyinput multi_city_selector search_date form-control" aria-required="true">
									...
									<div class="col-md-12">
										<div style="margin:0; padding:0" class="col-md-6">
											<div class="col-md-6">
												<div class="row">
													<div class="col-md-12 pad0">
														<div class="tour1 tours padin-botom">
															<a class="img-wd" href="#">  <img class="relative img1 img-responsive center-block" src="<?php echo ASSETS;?>images/site/img1.png" /></a>
												...
												<div class="row">
													<div class="col-md-12 pad0">
														<div class="tour1 tours padin-botom">
															<a class="img-wd" href="#">  <img class="relative img1 img-responsive center-block" src="<?php echo ASSETS;?>images/site/ca1.png" /></a>
										...
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-12 pad0">
													<div class="tour1 tours padin-botom">
														<a class="img-wd" href="#">  <img class="relative img1 img-responsive center-block" src="<?php echo ASSETS;?>images/site/ca2.png" /></a>
										...
										<div class="row">
											<div class="col-md-12 pad0">
												<div class="tour1 tours padin-botom">
													<a class="img-wd" href="#">  <img class="relative img1 img-responsive center-block" src="<?php echo ASSETS;?>images/site/ca3.png" /></a>
							...
							<div style="padding:0 " class="col-md-6 right-bans">
								<div class="col-md-12">
									<div class="tour1 tours">
										<a class="img-wd2" href="#"><img class="relative img1 img-responsive center-block" src="<?php echo ASSETS;?>images/site/banner2.png" /></a>
