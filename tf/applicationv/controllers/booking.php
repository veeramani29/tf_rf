            ...
            if($module == 'APARTMENT'){
               ...
               if(isset($checkout_form['middle_name'.$cid]) && $checkout_form['middle_name'.$cid]!=''){
				...
				$booking_flight = array(
                    ...
                    'insurance_amount' =>$checkout_form['insurance_amount'],
					'USER_TYPE' => $user_type,
                    'USER_ID' => $user_id,
                ...
                'insurance_type' => $checkout_form['insurance_type'],
                'insurance_amount' =>$checkout_form['insurance_amount'],
                'insurance_tax' => $checkout_form['insurance_tax'],
                'period' => $period,
                'amount' => ($TOTAL+$cart_flight_data->HiddenMarkupDiscount),
                'booking_status' => 'PROCESS'
                );
				...
				if($book_check=='ok'){
					...
					if($module == 'FLIGHT'){
						...
						if($count == 1){
							...
							$this->flight_model->Update_Booking_Global($bid, $update_booking, 'FLIGHT');
                            $up_ins=array('booking_status'=>$BookingStatus);
                            $this->flight_model->Update_insurance_details($pnr_no, $up_ins);
