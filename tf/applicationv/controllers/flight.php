...
$config['source_image'] = './admin/upload_files/home/portfolio/New_York_HD.jpg';
$config['new_image'] = './admin/upload_files/home/portfolio/new_New_York_HD.jpg';
$config['width'] = 1680;
$config['height'] = 450;
...
echo $data['img_src'] = base_url() . $config['new_image'];
...
return $data;
	...
	public function search(){
		//echo print_r($this->url)."veera";die;
		$this->session->set_userdata($this->url);
		$request = $this->input->get();
						...
						foreach ($AirSegmentRefs as $jk => $AirSegmentRef) {
							...
							foreach ($AirSegments as $key => $AirSegmentt) {
								...
								if($AirSegment_Key == $AirSegmentRef_Key){
									...
									$fs[$i][$mode]['segments'][$jk]['see'] = $ks;	

									$BookingInfo_Attr = $BookingInfo[$ks]['@attributes'];
