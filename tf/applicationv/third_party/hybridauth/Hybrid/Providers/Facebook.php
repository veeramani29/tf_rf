...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	*/
	function loginBegin(){
		$parameters = array("scope" => $this->scope, "redirect_uri" => $this->endpoint, "display" => "popup");
	...
	*/
	function getUserProfile()
	{
		...
		$this->user->profile->auth_id    = (array_key_exists('id',$data))?$data['id']:"";
		...
		// /$this->user->profile->country = $data['hometown']["name"];
		if( array_key_exists('birthday',$data) ) {
			...
			$this->user->profile->DOB   = $birthday_year.'-'.$birthday_month.'-'.$birthday_day;
		}
