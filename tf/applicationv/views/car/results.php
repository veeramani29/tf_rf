        ...
        <div class="container mt15 offset-0">
        	...
        	<div class="col-lg-5 nopad">
                <div class="tablpik">
                    ...
                    <div class="deplablpik"><strong><?php echo $this->flight_model->get_airport_cityname($req->pickup);?> (<?php echo $req->pickup;?>) </strong><?php echo date('d<\s\up>S</\s\up> M Y H:i',strtotime($req->depart_date." ".$req->depart_time));?></div>
                </div>
            </div>
            ...
            <div class="col-lg-5 nopad">
                <div class="tablpik">
                    ...
                    <div class="deplablpik"><strong><?php echo $this->flight_model->get_airport_cityname($req->dropoff);?> (<?php echo $req->dropoff;?>) </strong><?php echo date('d<\s\up>S</\s\up> M Y H:i',strtotime($req->return_date." ".$req->return_time));?></div>
                </div>
            </div>
...
<!--    <div class="popfooter">
      <button id="addWishList" class="popbutton blubutton">Book Car</button>
    </div>-->
  </div>
</div>
...
$(function() {
    ...
    $.ajax({
      type:'GET', 
      url: '<?php echo WEB_URL;?>/car/GetResults/<?php echo $request;?>',
      beforeSend: function(XMLHttpRequest){
        $('.imgLoader').fadeIn();
      }, 
      success: function(response) {
