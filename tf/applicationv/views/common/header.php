...
<div id="perspective" class="perspective effect-moveleft">
 <div class="container_cart"><div class="wrapper_cart"><div class="navbar-wrappermy"><div class="container"><div class="navbar">
   <div class="onlyapart offset-0">
    <!-- Navigation-->
    <div class="navbar-header col-xs-6 col-sm-3 nopad">
    ...
    <div class="col-xs-5 nopad mobheder">
      <ul class="simnavritrit">
        ...
        <?php } else{ ?>
          <button class="hide" id="showMenu">Show Menu</button>
          <?php } ?>
      </ul>
      ...
      <!-- <li style="margin-left:0px" class="dropdown " title="<?=lang('CHECK_IN');?>">
        <small style="cursor:pointer;" data-toggle="modal" data-target="#abtcheckinModal">About Check In</small>
        <br>
        <a style="padding;0px;" data-toggle="dropdown" class="mnuic dropdown-toggle" href="javascript:;">
        <strong><?=lang('CHECK_IN');?></strong>
        ...
        if ($this->session->userdata('b2c_id')) {
         ...
         <li class="dropdown navbar-right splli"> 
          ...
          <ul class="dropdown-menu dpm_usdash">
            ...
            <li>
              <a target="_blank" href="<?php echo WEB_URL;?>/dashboard/support_conversation"><?php echo lang('LOGIN_ACTION_SUPPORT_CONVERSATION'); ?></a></li>
              <li>
      ...
      <div class="navbar-collapse collapse col-sm-offset-3 col-xs-4 filcols nopad margtop5">
