...
echo anchor_popup('auth/login/Facebook/up','
	<div class="mensionsoc"><span class="fa fa-facebook fa-lg fa-fw color-white"></span>'.$this->lang->line('F_S_FB').'</div>', $atts);
$atts['class'] = 'logspecify tweetcolor';
echo anchor_popup('auth/login/Twitter/up','
	<div class="mensionsoc"><span class="fa fa-twitter fa-lg fa-fw color-white"></span>'.$this->lang->line('F_S_TW').'</div>', $atts);
$atts['class'] = 'logspecify gpluses';
echo anchor_popup('auth/login/Google/up','
	<div class="mensionsoc"><span class="fa fa-google-plus fa-lg fa-fw color-white"></span>'.$this->lang->line('F_S_GP').'</div>', $atts);
	?>
		</div>
		<div class="centerpul"><div class="orbar"><strong><?php echo $this->lang->line('F_L_Or'); ?></strong></div></div>
		<a class="logspecify mymail"><div class="mensionsoc"> <span class="fa fa-envelope fa-lg fa-fw"></span> <?php echo $this->lang->line('F_S_SE'); ?></div></a>
		<form id="registration" name="registration" action="<?php echo WEB_URL;?>/account/create">
			<div class="signupul"> 
				...
				<div class="rowput"><span class="icon icon-user"></span><input class="form-control logpadding" type="text" name="mname" placeholder="Middle Name" minlength="1" required /></div>
				<div class="rowput"><span class="icon icon-user"></span><input class="form-control logpadding" type="text" name="fname" placeholder="<?php echo $this->lang->line('F_S_lname'); ?>" minlength="4" required/></div>
...
<?php }?>
<div id="adwishlist" class="wellme minwidth" style="display:none;">
	<div class="popuperror" style="display:none;"></div>
	<div  class="pophed"><?php echo $this->lang->line('F_W_Create'); ?></div>
	<div class="signdiv">
		<div class="rowlistwish">
			<strong><?php echo $this->lang->line('F_W_Name'); ?></strong><input type="text" class="fulwish" id="wishNodeName" /></div>
			<div class="rowlistwish">
				<strong><?php echo $this->lang->line('F_W_See'); ?></strong><select class="wishsel" id="wishPrivacy"><option value="0"><?php echo $this->lang->line('F_W_Onlyme'); ?></option><option value="1"><?php echo $this->lang->line('F_W_Everyone'); ?></option></select>
			</div>
			<div class="clear"></div><div class="downselfom"><a class="savewish colorcancel adwishlist_close"><?php echo $this->lang->line('F_W_Cancel'); ?></a><a class="savewish colorsave" id="saveWishNode"><?php echo $this->lang->line('F_W_Save'); ?></a></div>
		</div>
	</div>
	<div id="editwishlist" class="wellme minwidth" style="display:none;">
		<div class="popuperror" style="display:none;"></div>
		<div  class="pophed"><?php echo $this->lang->line('F_W_Edit'); ?></div>
		<div class="signdiv">
			<div class="rowlistwish">
				<strong><?php echo $this->lang->line('F_W_Name'); ?></strong><input type="text" class="fulwish" id="editWishNodeName" /></div>
				<div class="rowlistwish">
					<strong><?php echo $this->lang->line('F_W_See'); ?></strong><select class="wishsel" id="editWishPrivacy"><option value="0"><?php echo $this->lang->line('F_W_Onlyme'); ?></option><option value="1"><?php echo $this->lang->line('F_W_Everyone'); ?></option>
				</select>
			</div>
			<div class="clear"></div><div class="downselfom"><a class="savewish colorcancel editwishlist_close"><?php echo $this->lang->line('F_W_Cancel'); ?></a><a class="savewish colorsave" id="saveEditWishNode"><?php echo $this->lang->line('F_W_Save'); ?></a></div>
		</div>
	</div>
	 ...
	 $(document).ready(function(){
		 ...
		 if($("input[name='trip_type']").is(':checked')){
			 ...
			 if(trip_type=='multicity'){
				 	$("div.normal :input").prop("disabled", true);
					$("div.normal select").prop("disabled", true);
			 }else{
