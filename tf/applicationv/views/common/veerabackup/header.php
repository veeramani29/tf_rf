        ...
        <div class="popup_detail">
          <div class="banner_signup">
            <form id="userlogin" name="userlogin" action="site/user/login_user" method="post">  
              <input type="text" id="lemail" name="email" value="" placeholder="Email Address" class="book_txt required email" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;"  />
              <input type="password" id="lpass" name="password" value="" placeholder="Password" class="book_txt required" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;" />
  ...
  <div id='inline_example14' style='background:#fff;'>
    <div class="popup_page">
      <div class="popup_header">Create your Account. </div>
        <div class="popup_detail">
          <div class="banner_signup">
            <form name="usermyaccount" id="usermyaccount" action="site/user/registerUser" method="post">    
              <input type="text" id="rfname" name="full_name" required placeholder="First Name"  class="book_txt required" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;"  />
              <input type="text" id="rlname" name="last_name" required placeholder="Last Name"   class="book_txt required" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;"  />
              <input type="text" id="remail" name="email" required  placeholder="Email Address"  class="book_txt required email" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;"  />                                 
              <input type="password" id="rpass" name="password" required  placeholder="Password" class="book_txt required" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;" />
              <input type="password" id="rconf" required  placeholder="Confirm Password" class="book_txt required" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;" />
        ...
        <div class="popup_detail">
          <div class="banner_signup">
            <form name="signupForgot" id="signupForgot" action="site/user/forgot_password_user" method="post">    
              ...
              <input type="text" id="femail" name="email" value="Email Address" class="book_txt required email" style="padding:8px 0px 8px 10px; font-size:13px; margin-bottom: 15px;"  />                                 
...
<div id="perspective" class="perspective effect-moveleft">
 ...
 <div class="onlyapart offset-0">
  <!-- Navigation-->
	...
	<a href="<?php echo WEB_URL;?>" class="navbar-brand myband"><img src="<?php echo ASSETS;?>images/logo.png" alt="<?php echo $this->lang->line('H_logo_title'); ?>" class="img-responsive" /></a>
	</div>
