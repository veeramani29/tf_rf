    ...
    <div class="container">
        <div class="container offset-0">
        	<div class="tickapt">
                ...
                <span class="msgofapt"><?=lang('Thank you for order');?></span>
            </div>
        </div>
    </div>
</div>
            	...
            	<ul id="user_bookings">
                  ...
                  <li class="bookingli">
                    ...
                    <div class="col-md-7 nopad">
                      ...
                      <!-- <span class="green bold size20"><?php echo CURR_ICON?><?php echo ($booking->amount+$booking->insurance_amount);?> --> 
                      </div>
                    </div>
                    ...
                    <div class="col-md-5 nopad">
                        <div class="botufis">
                               <a title="Mail voucher" onclick="mail_voucher(this)" data-pnr="<?php echo $booking->pnr_no;?>" data-placement="top" class="btn btn-success btn-xs has-tooltip" data-original-title="Edit Voucher">
                                ...
                                <a class="left">
                                  <span class="green bold size20"><?php echo CURR_ICON?><?php echo ($booking->amount+$booking->insurance_amount);?></span> 
                                  </a>
                            </div>
                    </div>
                  </li>
                    ...
                    <div class="col-md-5 offset-0 concell litgrycell">
                        ...
                        <div class="botufis">
                               <a title="<?=lang('Mail voucher');?>" onclick="flight_mail_voucher(this)" data-pnr="<?php echo $booking->pnr_no;?>" data-placement="top" class="btn btn-success btn-xs has-tooltip" data-original-title="<?=lang('Mail voucher');?>">
                                ...
                                <a href="<?php echo WEB_URL.'/flight/voucher/'.base64_encode(base64_encode($booking->pnr_no));?>" target="new" title="<?=lang('View voucher');?>" data-placement="top" class="btn btn-primary btn-xs has-tooltip" data-original-title="<?=lang('View voucher');?>">
								...
								{
									?>
                                       <a href="<?php echo WEB_URL.'/flight/invoice/'.base64_encode(base64_encode($booking->pnr_no));?>" target="new" title="<?=lang('View Invoice');?>" data-placement="top" class="btn btn-primary btn-xs has-tooltip" data-original-title="<?=lang('View Invoice');?>">
                  ...
                  <li class="bookingli">
                    ...
                    <div class="col-md-7 concell"> 
                        ...
                        <div class="col-md-3 nopad">
                            <span class="radiobtn"><?=lang('DURATION');?></span>
                            <span class="norto"><?=lang('Economy');?></span>
                            <span class="norto lbold"><?php echo $onward_dur;?></span>
                        </div>
                    </div>  
                        ...
                        <div class="col-md-3 nopad">
                            <span class="radiobtn"><?=lang('DURATION');?></span>
                            <span class="norto"><?=lang('ECONOMY');?></span>
                            <span class="norto lbold"><?php echo $return_dur;?></span>
                        </div>
                    </div>
