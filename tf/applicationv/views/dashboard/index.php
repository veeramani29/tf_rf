...
<div class="full brdcrump marintopcnt">
    ...
    echo "active";
} ?>"> <a href="#dashbord" data-toggle="tab" data-link="<?php echo base_url().'dashboard' ?>" class="dshbrdLnk"><?=lang('Dashboard');?></a> </li>
           <?php /*?> <li class="brdli <?php if (!empty($page_type) && $page_type == "inbox") {
    echo "active";
} ?>"> <a href="#inbox" id="inboxPg" data-toggle="tab" data-link="<?php echo base_url().'dashboard/inbox' ?>" class="dshbrdLnk">Inbox</a> </li>
            <li class="brdli <?php if (!empty($page_type) && $page_type == "listing") {
    echo "active";
} ?>"> <a href="#yourlisting" data-toggle="tab" data-link="<?php echo base_url().'dashboard/listing' ?>" class="dshbrdLnk">Your Listing</a> </li><?php */?>
<li class="brdli <?php if (!empty($page_type) && $page_type == "listing1") {
    echo "active";
} ?>"> <a href="#profile" data-toggle="tab" data-link="<?php echo base_url().'dashboard/profile' ?>" class="dshbrdLnk"><?=lang('Your_Profile');?></a> </li>
            <li class="brdli <?php if (!empty($page_type) && $page_type == "bookings") {
    echo "active";
} ?>"> <a href="#bookings" data-toggle="tab" onclick="mySelectUpdate()" data-link="<?php echo base_url().'dashboard/bookings'; ?>" class="dshbrdLnk"> <?=lang('Bookings');?></a> </li>
          <?php /*?>  <li class="brdli <?php if (!empty($page_type) && $page_type == "wishlist") {
    echo "active";
} ?>"> <a href="#wishlist" data-toggle="tab" onclick="mySelectUpdate()" data-link="<?php echo base_url().'dashboard/wishlist'; ?>" class="dshbrdLnk">Wishlist</a> </li><?php */?>
            <li class="brdli <?php if (!empty($page_type) && $page_type == "settings") {
    echo "active";
} ?>"> <a href="#settings" data-toggle="tab" onclick="mySelectUpdate()" data-link="<?php echo base_url().'dashboard/settings'; ?>" class="dshbrdLnk"><?=lang('Settings');?></a> </li>
<?php if($this->session->userdata('b2b_id')){?>
            <li class="brdli <?php if (!empty($page_type) && $page_type == "deposit") {
    echo "active";
} ?>"> <a href="#chg_password" data-toggle="tab" onclick="mySelectUpdate()" data-link="<?php echo base_url().'dashboard/deposit'; ?>" class="dshbrdLnk"><?=lang('Deposit');?></a> </li>
<!-- <li class="brdli <?php if (!empty($page_type) && $page_type == "deposit") {
    echo "active";
} ?>"> <a href="#chg_password" data-toggle="tab" onclick="mySelectUpdate()" data-link="deposit" class="dshbrdLnk">My Markup</a> </li> -->
<?php }?>
<li class="brdli <?php if (!empty($page_type) && $page_type == "newsletter") {
    echo "active";
} ?>"> <a href="#newsletter" data-toggle="tab" onclick="mySelectUpdate()" data-link="<?php echo base_url().'dashboard/newsletter'; ?>" class="dshbrdLnk"> <?=lang('Newsletters');?> </a> </li>
        </ul>
...
<?php $this->load->view('dashboard/yourtrips'); ?>     
<?php $this->load->view('dashboard/profile'); ?>      
<?php $this->load->view('dashboard/bookings'); ?>     
<?php $this->load->view('dashboard/wishlist'); ?>    
<?php $this->load->view('dashboard/settings'); ?>     
<?php if($this->session->userdata('b2b_id')){ $this->load->view('dashboard/depositmgmt'); }?>     
