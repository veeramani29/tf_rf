<?php
  ...
  //  echo'<pre>'; print_r($flights);die; 
    foreach($flights as $flight){
		...
		$time_s=str_replace("P","",$exp_Time[0]);
		$exp_M=explode("H",$exp_Time[1]);
		$time_string=substr($time_s, 0, 1);
		$fnl_time_string=explode("M",((24*$time_string)+$exp_M[0])."H"." ".$exp_M[1]);
		$Tot_traveltime=$fnl_time_string[0]."M";
    				...
    				<div class="col-md-12 col-xs-12 nopad fulwidmob">
    					<div class="onwyrow">
    						...
    						<div class="col-md-3 col-xs-3 nopad fulat500">
    							<br>
    							<div class="fatfi">
    								<span class="norto lbold"><img src="<?php echo ASSETS;?>images/site/clk.png"> <?php echo $onward_dur;//$Tot_traveltime;//$dur;?></span>
