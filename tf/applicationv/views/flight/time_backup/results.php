		...
		<div class="container mt15 offset-0">           
			...
			<div class="collapse col-md-3 filters nopad" id="mobilefilter">
				...
				<div class="filter-head">
					...
					<span class="total-search"> <p id="total-search">0</p> OPTIES <?php echo ($req->type!='M')?"VOOR":""; ?></span>
					<?php if($req->type!='M'){ ?> <span class="fligt-name"><?php echo $this->flight_model->get_airport_cityname($origin);?> (<?php echo $origin;?>) - <?php echo $this->flight_model->get_airport_cityname($destination);?> (<?php echo $destination;?>)</span><?php } ?>
				</div>
				<!-- end side review -->
  ...
  <div class="htlmodin widthmn">
   ...
   <div class="col-md-12 nopad left marbotom20 my12">
    <div class="col-md-4 md-4 xm-12">
     <div class="posrel">
      <input type="text" class="mySelectCalenda calinput flyinput" name="depature" id="depature" placeholder="<?php echo $this->lang->line('depart'); ?>"  value="<?php if($req->type != 'M'){ echo date('d/m/Y',strtotime($req->depart_date)); }?>"  required/>
    </div>
  </div>
...
<div class="ritsrch">
  <div class="inbar posrel myselect">
   <select class="mySelectBoxClass flyinput text-right persn" id="class" name="class" required>
    <option value="Economy" <?php echo ($req->class=='Economy')?"selected='selected'":'';?>>Economy</option>
    <option value="PremiumEconomy" <?php echo ($req->class=='PremiumEconomy')?"selected='selected'":'';?>>Premium economy</option>
    <option value="Business" <?php echo ($req->class=='Business')?"selected='selected'":'';?>>Business</option>
    <option value="First" <?php echo ($req->class=='First')?"selected='selected'":'';?>>First</option>
    <option value="PremiumFirst" <?php echo ($req->class=='PremiumFirst')?"selected='selected'":'';?>>Premium first</option>
  </select>
</div>
</div>
</div>
...
<input id="days" name="days" type="checkbox" <?php if(isset($req->days) && $req->days ==1){echo 'checked';}?> value="1"> Search 3 days before and after
</label>
</div>
</div>
<div class="clearfix"></div>
...
<div class="full multicity" style="<?php echo ($req->type=='M') ? '' : 'display: none'; ?>">
 <div class="addedCities">
  ...
  <div class="col-md-4 md-4 xm-12 marxm">
    <div class="posrel">
     <input type="text" value="<?php echo date('d/m/Y',strtotime($departDate_input[$k]));?>" class="mySelectCalenda calinput flyinput" placeholder="<?php echo $this->lang->line('depart'); ?>" name="mdepature[<?php echo $i; ?>]" id="depature<?php echo $i; ?>" required/>
   </div>
 </div>
