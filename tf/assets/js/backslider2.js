	...
	theme = {
		...
		----------------------------*/
	 	_init : function(){
			...
			/* Navigation Items
			----------------------------*/
			$("#imgapart").click(function(){api.goTo(1);});
			$("#imgflit").click(function(){api.goTo(2);});
			$("#imghtl").click(function(){api.goTo(3);});
			$("#imgcar").click(function(){api.goTo(4);});
			$("#imgdeail").click(function(){api.goTo(5);});
			$("#imgvac").click(function(){api.goTo(6);});
		...
		----------------------------*/
	 	beforeAnimation : function(direction){
			...
			var description1 = api.getField("title");
			var ref = api.getField("url");
