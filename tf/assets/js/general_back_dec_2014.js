...
$("#form_basicinfo").validate({
  submitHandler: function() { 
    ...
    data: data,
      beforeSend: function(){
          $("#general_loading_saving").show();
          $('.general_loading_saving_open').click();
          $('#general_loading_saving_background').css('display','block');
        },  
      success: function(data) {          
          updateCompletedStatus(data.property_list_id);
            setTimeout(function() {
                  $("#general_loading_saving").hide();
...
data: data,
beforeSend: function(){
$("#photos_loading_saving").show();
$('.photos_loading_saving_open').click();
$('#photos_loading_saving_background').css('display','block');
},	
success: function(data) {
    updateCompletedStatus(data.property_list_id); 
    setTimeout(function() {
        $("#photos_loading_saving").hide();
        $( "#photo_tab_section" ).addClass( "activetik" );
        $('#photos_loading_saving_background').css('display','none');
        setTimeout(function() {
          if(data.previous_completed_status == 0 && data.count_result == 3){
            inform();
          }    
