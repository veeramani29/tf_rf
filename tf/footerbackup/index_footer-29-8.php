...
<div class="row clearfix footer text-left bg-white">
	<div class="main">
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					...
					<ul class="footer-list newlisting payment_list">
						<?php if($banners->visa){ ?>
						<li>
							<a href="javascript:void(0);"><span class="fb1"></span></a>
						</li>
						<?php } if($banners->master){ ?>
						<li>
							<a href="javascript:void(0);"><span class="fb2"></span></a>
						</li>
						...
						<li>
							<a href="javascript:void(0);">
								<img src="<?php echo ASSETS;?>images/payment_logo/paypal_logo.png">
							</a>
						</li>
			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					...
					<ul class="footer-list newlisting payment_list">
						...
						<li>
							<a href="javascript:void(0);">
								<img src="<?php echo ASSETS;?>images/payment_logo/IATA_Logo.png">
							</a>
						</li>
						...
						<li>
							<a href="javascript:void(0);">
								<img src="<?php echo ASSETS;?>images/payment_logo/SGRlogo.jpg">
							</a>
						</li>
		...
		<div class="col-md-3 column">
			<div class="row clearfix">
				<div class="col-md-12 column"><span class="footer-title"><?=lang('ROW5_HEADING');?></span>
					<p class="p-sector"><?php echo $banners->tf_offer; ?></p>
					<h2 class="footer-tags"> <?php echo $banners->customer_support_phone; ?></h2>
					<a class="footer-mail" href="mailto:<?php echo $banners->customer_support_email; ?>">  <?php echo $banners->customer_support_email; ?></a></div>					       </div>
					<div class="row clearfix">
						<div class="col-md-12 column">
