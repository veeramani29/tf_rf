...
<com:CabinClass Type="' . $request->class . '" xmlns:com="http://www.travelport.com/schema/common_v33_0" />
    	...
    	$LegModifiers='<air:AirLegModifiers>
<air:PreferredCabins>
<com:CabinClass Type="Economy" xmlns:com="http://www.travelport.com/schema/common_v33_0" />
</air:PreferredCabins>
<!--<air:PreferredCabins>
<com:CabinClass Type="PremiumEconomy" xmlns:com="http://www.travelport.com/schema/common_v33_0" />
</air:PreferredCabins>
<air:PreferredCabins>
<com:CabinClass Type="Business" xmlns:com="http://www.travelport.com/schema/common_v33_0" />
</air:PreferredCabins>
<air:PreferredCabins>
<com:CabinClass Type="First" xmlns:com="http://www.travelport.com/schema/common_v33_0" />
</air:PreferredCabins>
<air:PreferredCabins>
<com:CabinClass Type="PremiumFirst" xmlns:com="http://www.travelport.com/schema/common_v33_0" />
</air:PreferredCabins>-->
</air:AirLegModifiers>'; 
    }*/
...
$ach.='<com:Provider Code="ACH" xmlns:com="http://www.travelport.com/schema/common_v33_0" />';
    ...
    $provider='<air:AirSearchModifiers >
                ...
                <com:Carrier xmlns:com="http://www.travelport.com/schema/common_v33_0" Code="QR"/>
                 </air:ProhibitedCarriers>
 ...
 $adults .= '<BookingTraveler Key="0" TravelerType="ADT" DOB="'.$doba.'" Gender="'.substr($checkout_form->$gender,0,1).'" xmlns="http://www.travelport.com/schema/common_v33_0">
    ...
    if($request->ADT >1){
        ...
        $SSR_meals_req_adult.='<SSR  Status="NN" Type="'.$passengers->meals_ssr[$s]->$audlt.'"/>';
            ...
            $adults .= '<BookingTraveler Key="'.$paxId.'" TravelerType="ADT" DOB="'.$doba.'" Gender="'.substr($passengers->gender[$s]->$audlt,0,1).'" xmlns="http://www.travelport.com/schema/common_v33_0">
