    ...
    <div class="container">
        <div class="helpsearch">
            <form id="helpCenterSearchForm" action="<?php echo WEB_URL.'/help/search' ?>" method="GET"> 
            	<input type="text" class="serchhlp" id="helpSearchInput" name="q" placeholder="Serch the help center" autocomplete="off"/>
        ...
        <div class="popsrch">
        	<ul>
                <li class="poli"><strong>Popular Searches</strong></li>
