							...
							<div id="multi_city_select" style="display: none;">
								<div id="paste_div">
									...
									<div class="multi_city_0  multi-city" >
										<div class="input-wrapper">
											<input type="text" required="" id="from1" name="mfrom[0]" placeholder="From" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>
										<div class="input-wrapper">
											<input type="text" required="" id="to1" name="mto[0]" placeholder="To" class="flyinput departflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>

										<div class="input-wrapper">
											<input type="text" required="" id="depature1" name="mdepature[0]" placeholder="Depart" class="flyinput multi_city_selector search_date" aria-required="true">
									...
									<div class="multi_city_1  multi-city" >
										<div class="input-wrapper">
											<input type="text" required="" id="from2" name="mfrom[1]" placeholder="From" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>
										<div class="input-wrapper">
											<input type="text" required="" id="to2" name="mto[1]" placeholder="To" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>

										<div class="input-wrapper">
											<input type="text" required="" id="depature2" name="mdepature[1]" placeholder="Depart" class="flyinput multi_city_selector search_date" aria-required="true">
									...
									<div class="multi_city_2  multi-city" style="display:none">
										<div class="input-wrapper">
											<input type="text" required="" id="from3" name="mfrom[2]" placeholder="From" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>
										<div class="input-wrapper">
											<input type="text" required="" id="to3" name="mto[2]" placeholder="To" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>

										<div class="input-wrapper">
											<input type="text" required="" id="depature3" name="mdepature[2]" placeholder="Depart" class="flyinput multi_city_selector search_date" aria-required="true">
									...
									<div class="multi_city_3  multi-city" style="display:none">
										<div class="input-wrapper">
											<input type="text" required="" id="from4" name="mfrom[3]" placeholder="From" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>
										<div class="input-wrapper">
											<input type="text" required="" id="to4" name="mto[3]" placeholder="To" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>

										<div class="input-wrapper">
											<input type="text" required="" id="depature4" name="mdepature[3]" placeholder="Depart" class="flyinput multi_city_selector search_date" aria-required="true">
									...
									<div class="multi_city_4  multi-city" style="display:none">
										<div class="input-wrapper">
											<input type="text" required="" id="from5" name="mfrom[4]" placeholder="From" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>
										<div class="input-wrapper">
											<input type="text" required="" id="to5" name="mto[4]" placeholder="To" class="flyinput fromflight" aria-required="true" autocomplete="off" aria-invalid="false">

										</div>

										<div class="input-wrapper">
											<input type="text" required="" id="depature5" name="mdepature[4]" placeholder="Depart" class="flyinput multi_city_selector search_date" aria-required="true">
