...
?>
	...
	<div class="insidechat">
		<div class="chatername"><?=lang('Admin');?></div>
		...
		$name1 = substr($a[1],3);
		?>
		    <p><a  href="<?php echo base_url(); ?>dashboard/download_file/<?php echo $file; ?>"><i class="icon-paper-clip"></i> <?=lang('Download The Attchment');?> : <?php echo $name1; ?></a>  </p>
		<?php } ?>
	    </div>
	</div>
	</div>
	...
	<div class="chatrow">
	<div class="chaterimage">
	<img src="<?php echo $user_details->image; ?>" alt="" />
	</div>
	<div class="chaterdetail">
	<div class="chatip"></div>
	<div class="insidechat">
    ...
    <span class="size16 padtabnenopad bold">
    	<span class="tickthed"><?=lang('Reply Ticket');?></span>
    </span>
	<div class="chaterimage">
		<img src="<?php echo $user_details->image;?>" alt="" />
	</div>
    <div class="withedrow">
        ...
        <input type="hidden" name="support_ticket_id" value="<?php echo $ticketrow->support_ticket_id; ?>">
            ...
            <div class="likrticktsec">
                ...
                <div class="coltcnt">
            	<input type="submit" class="adddtickt" value="<?=lang('Reply Ticket');?>">
                </div>
            </div>
            </form>
          </div>
