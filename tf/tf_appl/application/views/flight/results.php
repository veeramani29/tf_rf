...
<div class="full flitgray">
    ...
    <div class="container mt15 offset-0">
      ...
      <div class="collapse col-md-3 filters nopad" id="mobilefilter">
        ...
        <div class="filter-head">
          ...
          <span class="total-search"> <p id="total-search">0</p> <?=lang('OPTIONS');?> <?php echo ($req->type!='M') ? lang('FOR') : ""; ?></span>
          <?php if($req->type!='M'){ ?>
        ...
        <div class="pagefilter">
          ...
          <div class="rowfilter">
            <button type="button" class="filtedhed" data-toggle="collapse" data-target="#pricerange">
              <span class="hedfiltr"><?=lang('PRICE_RANGE');?> </span>
          ...
          <div class="rowfilter">
            <button type="button" class="filtedhed" data-toggle="collapse" data-target="#departtime">
              <span class="hedfiltr"><?=lang('DEPARTURE_TIME');?></span>
              <span class="filterdoen"></span>
            </button>
          ...
          <div class="rowfilter">
            <button type="button" class="filtedhed" data-toggle="collapse" data-target="#stops">
              <span class="hedfiltr"><?=lang('STOPS');?></span>
              <span class="filterdoen"></span>
            </button>
            <div id="stops" class="collapse merange">
              <div class="infiltrbox">
                <ul class="paddivs" id="StopFilter">
                 <li class="cheklist"><label for="stop_checkall" ><div class="left"><input class="filtchk serch-blue stop_checkall" name="stop_checkall" type="checkbox" id="stop_checkall"   ></div><span class="cheklabl">Check / Uncheck  All</span></label></li>
               </ul>
             </div>
           </div>
         </div>
         ...
         <!-- Classes Time -->
         <div class="rowfilter">
          <button type="button" class="filtedhed" data-toggle="collapse" data-target="#classes">
            <span class="hedfiltr"><?=lang('CLASS');?></span>
            <span class="filterdoen"></span>
          </button>
          <div id="classes" class="collapse merange">
            <div class="infiltrbox">
              <ul class="paddivs" id="ClassFilter">
               <li class="cheklist"><label for="class_checkall" ><div class="left"><input class="filtchk serch-blue class_checkall" name="class_checkall" type="checkbox" id="class_checkall"   ></div><span class="cheklabl">Check / Uncheck  All</span></label></li>
             </ul>
           </div>
         </div>
       </div>
       ...
       <div class="rowfilter">
        <button type="button" class="filtedhed" data-toggle="collapse" data-target="#airlines">
          <span class="hedfiltr"><?=lang('AIRLINES');?></span>
          <span class="filterdoen"></span>
        </button>
        <div id="airlines" class="collapse merange">
          <div class="infiltrbox">
            <ul class="paddivs" id="AirlineFilter">
              <li class="cheklist"><label for="Airline_checkall" ><div class="left"><input class="filtchk serch-blue Airline_checkall" name="Airline_checkall" type="checkbox" id="Airline_checkall"   ></div><span class="cheklabl">Check / Uncheck  All</span></label></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="rightcontent col-md-9 padlisting">
    <div class="lodrefrentrev imgLoader">
      <div class="centerload">
        <figure class="figure-loader">
         <img src="<?php echo ASSETS; ?>images/Travel_Loader.gif" alt="<?=lang('TRAVEL_LOADER');?>" class="img-responsive center-block">
         <figcaption class="text-uppercase text-center"><?php echo ($banners->loading_text!='')?$banners->loading_text:'LOADING';?></figcaption>
       </figure>
     </div>
   </div>
   <div class="itemscontainer">
    ...
    <div class="graph_results" id="wrapper" > </div><!--graph_results wrapper-->
    <div class="row hideDiv" id="chartSearch">
      <form class="custom show-search-options position-left" name="extradays_flight" id="extradays_flight" action="<?php echo WEB_URL;?>/flight/search" accept-charset="UTF-8" novalidate>
       <div class="col-md-12" style="padding: 15px 5px 50px 10px;background-color:rgba(0,0,0,0.5);">
      ...
      <input type="hidden" name="class" id="class" value="<?php echo (isset($_REQUEST['class']))?$_REQUEST['class']:'';?>">
      <input type="hidden" name="days" id="days" value="<?php echo $_REQUEST['days'];?>">
      <input type="hidden" name="Carriers" id="Carriers" value="<?php echo (isset($_REQUEST['Carriers']))?$_REQUEST['Carriers']:'';?>">
      <input type="hidden" name="provider" id="provider" value="<?php echo (isset($_REQUEST['provider']))?$_REQUEST['provider']:'';?>">
      <input type="hidden" name="disc_price" id="disc_price" value="<?php echo (isset($_REQUEST['disc_price']))?$_REQUEST['disc_price']:'';?>">
...
<div class="col-lg-3 col-xs-3 full550 ">
 <button class="modify himargin" data-toggle="collapse" data-target="#modhtl"><?=lang('MODIFY_SEARCH');?></button>
</div>
</div>
<div class="htlmod collapse" id="modhtl">
  <div class="htlmodin widthmn">
   <div class="col-md-12 nopad">
    <div class="smalsent"><?=lang('MODIFY_YOUR_SEARCH');?></div>
    <div class="clearfix"></div>
    <form name="flight" id="flight" action="<?php echo WEB_URL;?>/flight/search" autocomplete="off">
            ...
            <div class="col-md-6 md-6 xm-12">
             <div class="ritsrch">
              <div class="inbar posrel">
               ...
               ?>
               <input type="text" aria-invalid="false" class="flyinput fromflight" aria-required="true" placeholder="<?=lang('FROM');?>" name="from" value="<?php echo $origin;?>" required/>
             </div>
           </div>
         </div>
         <div class="col-md-6 md-6 xm-12 marxm">
           <div class="ritsrch">
            <div class="inbar posrel">
             ...
             <input type="text" class="flyinput departflight" placeholder="<?=lang('TO');?>" name="to" value="<?php echo $destination;?>" required />
           </div>
         </div>
       </div>
     </div>
     ...
     <div class="col-md-12 nopad left marbotom20 my12">
      <div class="col-md-4 md-4 xm-12">
       <div class="posrel">
        <input type="text" class="mySelectCalenda calinput flyinput" name="depature" id="depature" placeholder="<?=lang('FROM');?>"  value="<?php if($req->type != 'M'){ echo date('d/m/Y',strtotime($req->depart_date)); }?>"  required/>
      </div>
    </div>
    <div class="col-md-4 md-4 xm-12 marxm">
     <div class="posrel <?php if($req->type != 'R'){?>ifonway<?php }?>" id="returnDiv">
      <div class="onwayonly"></div>
      <input type="text" class="mySelectCalenda calinput flyinput" name="return" id="return" placeholder="<?=lang('TO');?>" <?php if($req->type == 'R'){?>value="<?php echo date('d/m/Y',strtotime($req->return_date));?>"<?php }?> <?php if($req->type != 'R'){?>disabled<?php }?>/>
    </div>
  </div>
  <div class="col-md-4 md-4 xm-12 marxm">
   <div class="leftcsrch">
    <div class="inlabel psnico"><?=lang('CLASS');?></div>
  </div>
  <div class="ritsrch">
    <div class="inbar posrel myselect">
     <select class="mySelectBoxClass flyinput text-right persn" id="class" name="class" >
       <option value="" >All</option>
       <option value="Economy" <?php echo (isset($req->class) && $req->class=='Economy')?"selected='selected'":'';?>><?=lang('ECONOMY');?></option>
       <option value="PremiumEconomy" <?php echo (isset($req->class) && $req->class=='PremiumEconomy')?"selected='selected'":'';?>><?=lang('P_ECONOMY');?></option>
       <option value="Business" <?php echo (isset($req->class) && $req->class=='Business')?"selected='selected'":'';?>><?=lang('BUSINESS');?></option>
       <option value="First" <?php echo (isset($req->class) && $req->class=='First')?"selected='selected'":'';?>><?=lang('FIRST');?></option>
       <option value="PremiumFirst" <?php echo (isset($req->class) && $req->class=='PremiumFirst')?"selected='selected'":'';?>><?=lang('P_FIRST');?></option>
     </select>
   </div>
 </div>
</div>
...
<div class="col-md-12 md-12 nopad left marbotom20">
  <div class="col-md-3 md-3 xm-12 marxm">
   <div class="leftsrch">
    <div class="inlabel psnico"><?=lang('ADULTS');?></div>
  </div>
  <div class="ritsrch">
    <div class="inbar posrel myselect">
     <select class="mySelectBoxClass flyinput text-right persn" id="adult" name="adult" required>
      <option <?php echo ($req->ADT=='1')?"selected='selected'":'';?>>1</option>
      <option <?php echo ($req->ADT=='2')?"selected='selected'":'';?>> 2</option>
      <option <?php echo ($req->ADT=='3')?"selected='selected'":'';?>>3</option>
      <option <?php echo ($req->ADT=='4')?"selected='selected'":'';?>>4</option>
      <option <?php echo ($req->ADT=='5')?"selected='selected'":'';?>>5</option>
      <option <?php echo ($req->ADT=='6')?"selected='selected'":'';?>>6</option>
      <option <?php echo ($req->ADT=='7')?"selected='selected'":'';?>>7</option>
      <option <?php echo ($req->ADT=='8')?"selected='selected'":'';?>>8</option>
      <option <?php echo ($req->ADT=='9')?"selected='selected'":'';?>>9</option>
    </select>
  </div>
</div>
</div>
<div class="col-md-3 md-3 xm-12 marxm">
 <div class="leftsrch">
  <div class="inlabel psnico"><?=lang('J_CHILD');?></div>
</div>
<div class="ritsrch">
  <div class="inbar posrel myselect">
   <select class="mySelectBoxClass flyinput text-right persn" id="child" name="child" required>
    <option <?php echo ($req->CHD=='0')?"selected='selected'":'';?>>0</option>
    <option <?php echo ($req->CHD=='1')?"selected='selected'":'';?>>1</option>
    <option <?php echo ($req->CHD=='2')?"selected='selected'":'';?>>2</option>
    <option <?php echo ($req->CHD=='3')?"selected='selected'":'';?>>3</option>
    <option <?php echo ($req->CHD=='4')?"selected='selected'":'';?>>4</option>
    <option <?php echo ($req->CHD=='5')?"selected='selected'":'';?>>5</option>
    <option <?php echo ($req->CHD=='6')?"selected='selected'":'';?>>6</option>
    <option <?php echo ($req->CHD=='7')?"selected='selected'":'';?>>7</option>
    <option <?php echo ($req->CHD=='8')?"selected='selected'":'';?>>8</option>
  </select>
</div>
</div>
</div>
<div class="col-md-3 md-3 xm-12 marxm">
 <div class="leftsrch">
  <div class="inlabel chi"><?=lang('J_INFANT');?></div>
</div>
<div class="ritsrch">
  <div class="inbar posrel myselect">
   <select class="mySelectBoxClass flyinput text-right persn" id="infant" name="infant" required>
    <option <?php echo ($req->INF=='0')?"selected='selected'":'';?>>0</option>
    <option <?php echo ($req->INF=='1')?"selected='selected'":'';?>>1</option>
    <option <?php echo ($req->INF=='2')?"selected='selected'":'';?>>2</option>
  </select>
</div>
</div>
</div>
<div class="col-md-3 md-3 xm-12 marxm">
  <label class="checkbox-inline">
    <input id="days" name="days" type="checkbox" <?php if(isset($req->days) && $req->days ==1){echo 'checked';}?> value="1"> <?=lang('SEARCH_3DAYS');?>
  </label>
</div>
</div>
<div class="clearfix"></div>
<div class="col-md-8 left marbotom20">
  <input class="indxsrch shadows" name="flight_submit" type="submit" value="<?=lang('SEARCH');?>"/>
</div>
<div class="clearfix"></div>
</div>
     ...
     <div class="col-md-4 md-4 xm-12 marxm">
      <div class="ritsrch">
       <div class="inbar posrel">
        ...
        ?>
        <input type="text" value="<?php  echo $origin_multi; ?>" class="flyinput fromflight" placeholder="<?=lang('FROM');?>" name="mfrom[<?php echo $i; ?>]" id="from<?php echo $i; ?>" required/>
      </div>
    </div>
  </div>
  <div class="col-md-4 md-4 xm-12 marxm">
    <div class="ritsrch">
     <div class="inbar posrel">
      <span class="flighttoo"></span>
      <input type="text" value="<?php echo $destination_multi; ?>" class="flyinput departflight" placeholder="<?=lang('TO');?>" name="mto[<?php echo $i; ?>]" id="to<?php echo $i; ?>" required />
    </div>
  </div>
</div>
<div class="col-md-4 md-4 xm-12 marxm">
  <div class="posrel">
   <input type="text" value="<?php echo date('d/m/Y',strtotime($departDate_input[$k]));?>" class="mySelectCalenda calinput flyinput" placeholder="<?=lang('DEPART');?>" name="mdepature[<?php echo $i; ?>]" id="depature<?php echo ($i+1); ?>" required/>
 </div>
</div>
</div>
   ...
   <div class="col-md-11 col-xs-11 xm-12 nopad left marbotom20">
    <div class="col-md-4 md-4 xm-12 marxm">
     <div class="ritsrch">
      <div class="inbar posrel">
       <span class="flightfrom"></span>
       <input type="text" class="flyinput fromflight" placeholder="<?=lang('FROM');?>" name="mfrom[0]" id="from1" required/>
     </div>
   </div>
 </div>
 <div class="col-md-4 md-4 xm-12 marxm">
   <div class="ritsrch">
    <div class="inbar posrel">
     <span class="flighttoo"></span>
     <input type="text" class="flyinput departflight" placeholder="<?=lang('TO');?>" name="mto[0]" id="to1" required />
   </div>
 </div>
</div>
<div class="col-md-4 md-4 xm-12 marxm">
 <div class="posrel">
  <input type="text" class="mySelectCalenda calinput flyinput" placeholder="<?=lang('DEPART');?>" name="mdepature[0]" id="depature1" required/>
</div>
</div>
</div>
 ...
 <div class="col-md-11 col-xs-11 xm-12 nopad left marbotom20">
  <div class="col-md-4 md-4 xm-12 marxm">
   <div class="ritsrch">
    <div class="inbar posrel">
     <span class="flightfrom"></span>
     <input type="text" class="flyinput fromflight" placeholder="<?=lang('FROM');?>" name="mfrom[1]" id="from2" required/>
   </div>
 </div>
</div>
<div class="col-md-4 md-4 xm-12 marxm">
 <div class="ritsrch">
  <div class="inbar posrel">
   <span class="flighttoo"></span>
   <input type="text" class="flyinput departflight" placeholder="<?=lang('TO');?>" name="mto[1]" id="to2" required />
 </div>
</div>
</div>
<div class="col-md-4 md-4 xm-12 marxm">
 <div class="posrel">
  <input type="text" class="mySelectCalenda calinput flyinput" placeholder="<?=lang('DEPART');?>" name="mdepature[1]" id="depature2" required/>
</div>
</div>
</div>
<div class="col-md-1 xm-12"></div>
...
<div class="col-md-11 col-xs-11 xm-12 nopad left marbotom20">
  ...
  <div class="ritsrch">
    <div class="inbar posrel myselect">
     <select class="mySelectBoxClass flyinput text-right persn musthunded" id="class" name="class" >
      <option value="" >All</option>
      <option value="Economy" <?php echo (isset($req->class) && $req->class=='Economy')?"selected='selected'":'';?>><?=lang('ECONOMY');?></option>
      <option value="PremiumEconomy" <?php echo (isset($req->class) && $req->class=='PremiumEconomy')?"selected='selected'":'';?>><?=lang('P_ECONOMY');?></option>
      <option value="Business" <?php echo (isset($req->class) && $req->class=='Business')?"selected='selected'":'';?>><?=lang('BUSINESS');?></option>
...
<div class="col-md-3 col-xs-3 fifmb xm-12 marxm">
 <div class="leftsrch">
  <div class="inlabel chilic"><?=lang('J_CHILD');?></div>
</div>
<div class="ritsrch">
  <div class="inbar posrel myselect">
...
<div class="col-lg-12 nopad">
 <ul class="sortul">
  <li class="sorthd"><?=lang('SORT_BY');?></li>
  <li class="upndwn"><a class="ascending" id="SortbyAirline"><?=lang('SB_AIRLINE');?></a></li>
  <li class="upndwn"><a class="ascending" id="SortbyDeparture"><?=lang('SB_DEPART');?></a></li>
  <li class="upndwn"><a class="ascending" id="SortbyArrive"><?=lang('SB_ARRIVE');?></a></li>
  <li class="upndwn"><a class="ascending" id="SortbyDuration"><?=lang('SB_DURATION');?></a></li>
  <li class="upndwn active"><a class="ascending" id="SortbyPrice"><?=lang('SB_PRICE');?></a></li>
</ul>
</div>
<div class="clearfix"></div>
<!-- FLIGHT TICKET-->
...
<!-- Normal trip End-->
<button id="load_more" class="loadings" style="display:none;" onclick="limit_flight_table('Click');"><?=lang('LOAD_MORE');?></button>
<div class="clearfix"></div>
...
limit_flight_table('Dep');
}
function SortbyArrive(type){
 if (type == 'ascending') {
  $('div.flight').map(function () {
   return {val: parseFloat($(this).data('arrive'), 10), el: this};
 }).sort(ascending).map(function () {
   return this.el;
 }).appendTo('.flights');
}else{
...
limit_flight_table('Arr');
}
function SortbyDuration(type){
 if (type == 'ascending') {
  $('div.flight').map(function () {
   return {val: parseFloat($(this).data('duration'), 10), el: this};
 }).sort(ascending).map(function () {
   return this.el;
 }).appendTo('.flights');
}else{
...
limit_flight_table('Prc');
 
}
function SortbyAirline(type){
 if (type == 'ascending') {
  $('div.flight').map(function () {
    //alert($(this).data('airline').replace(/,/g, ''));
...
$(function() {
    ...
    success: function(response) {
      ...
      console.log(endTime);
      <?php if($req->type!='M' && (isset($req->days) && $req->days==1)){ ?>
        var results = response.split("GRAPH-SECTION-FLEX-!!!!!!!!!!!!!!!!!!!!!!!!!");
        $('.graph_results').fadeIn();
        if(results[1]==undefined){
          $('.flights').html(results[0]);
        }else{
          $('.graph_results').html(results[0]);
          $('.flights').html(results[1]);
        }
        <?php }else {?>
...
$("div.flights").on("click", "button.loadings", function() {
  var data={};
  ...
  $.ajax({
    ...
    success: function(data) {
     $('.removel').remove();
     $(data.result).insertAfter("div.flights div.flight:last");
     $('.imgLoader').fadeOut();
