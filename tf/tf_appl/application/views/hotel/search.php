                ...
                <div class="col-md-6 tophr nopad">
                    <div class="col-md-6 min-6 nopad">
                        <div class="padwraphotel">
                            ...
                            <button class="showonmap lesmargin" data-toggle="modal" data-target="#myModal">Show on map</button>
                            <!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="hotel-maps" style="height: 500px"></div>
      </div>
...
<script>
    ...
    data['rooms'] = '<?php echo $request['total_rooms']; ?>';
...
$(document).ready(function()
{
    ...
    {       
     ...
     /* function initialize()
        {
            var map = new google.maps.Map(document.getElementById('hotel-maps'), {
            zoom: 12,
            center: new google.maps.LatLng(51.509369, -0.13629),
            mapTypeId: google.maps.MapTypeId.ROADMAP
          });
           
        var infoWindow= new google.maps.InfoWindow({maxWidth:600}),
                            marker, i, 
                            image = 'http://2makkah.tekhne.nl/extras/assets/images/icon-maker.png';
        var marker,htlname,htlimg,htladdrs,htlp,htlamt,str,htlbook;
        var starcnt=0;
var latlong=JSON.parse($('#json').html());
