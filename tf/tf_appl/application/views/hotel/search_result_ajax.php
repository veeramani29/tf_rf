                ...
                <div class="itemlabel3">
                    <div class="labelright col-md-3  textaligncntr">
                       ...
                       <!-- <b> </b>--></span><br/>
                        ...
                        <a  href="<?php echo WEB_URL; ?>/hotel/hotel_details?sid=<?php echo $hotel->hotel_chain_name; ?>&hotelid=<?php echo $hotel->sup_hotel_id; ?>&checkin=<?php echo $check_in; ?>&checkout=<?php echo $check_out; ?>&cityId=<?php echo $city_code; ?>&adult=<?php echo $adult; ?>&room_count=<?php echo $rooms; ?>&type=<?php echo base64_encode(base64_encode('CRS')); ?>">
        ...
        <div class="col-md-4 min-4 offset-0">
            <div class="listitem2">
				<?php $uniquid =  uniqid().$Hotel_search_result[$i]['Code']; ?>
					...
					<img src="<?php echo $Hotel_search_result[$i]['photo']?>">
        ...
        <div class="col-md-8 min-8 offset-0">
            <div class="itemlabel3">
                <div class="labelright col-md-3  textaligncntr">
                   ...
                   <!-- <b> </b>--></span><br/>
                    <span class="size11 grey">Min Price</span><br/><br/><br/>
                    <form action="<?php echo WEB_URL; ?>/hotel/hotel_details" method="post">
                        <input type="hidden" name="hotelid" value="<?php echo $Hotel_search_result[$i]['Code']; ?>">
                        <input type="hidden" name="checkin" value="<?php echo $Hotel_search_result[$i]['check_in']; ?>">
                        <input type="hidden" name="checkout" value="<?php echo $Hotel_search_result[$i]['check_out']; ?>">
                        <input type="hidden" name="city_code" value="<?php echo $Hotel_search_result[$i]['city_code']; ?>">
                        <input type="hidden" name="type" value="<?php echo base64_encode(base64_encode('API')); ?>">
                        <input type="hidden" name="minprice" value="<?php echo $Hotel_search_result[$i]['MinPrice']; ?>">
                        <input type="hidden" name="room_count" value="<?php echo $Hotel_search_result[$i]['rooms']; ?>">
                        <input type="hidden" name="rooms" value="<?php echo base64_encode(json_encode($rooms)); ?>">
                        <input type="hidden" name="roomslist" value='<?php echo $Hotel_search_result[$i]['roomslist']; ?>'>
                        <button class="booknowhtl" type="submit">Check Availabilty</button>
                    </form>
                    <!--<a  href="<?php echo WEB_URL; ?>/hotel/hotel_details?hotelid=<?php echo $Hotel_search_result[$i]['Code']; ?>&checkin=<?php echo $Hotel_search_result[$i]['check_in']; ?>&checkout=<?php echo $Hotel_search_result[$i]['check_out']; ?>&city_code=<?php echo $Hotel_search_result[$i]['city_code']; ?>&adult=<?php echo $Hotel_search_result[$i]['adult']; ?>&room_count=<?php echo $Hotel_search_result[$i]['rooms']; ?>&type=<?php echo base64_encode(base64_encode('API')); ?>">
                        <button class="booknowhtl">Check Availabilty</button>	
                    </a>-->		
                </div>
                <div class="labelleft2 col-md-9 offset-0">			
                    ...
                    <?php
                        $roomlist_arr=json_decode($Hotel_search_result[$i]['roomslist'],true);
                        
                        //print_r($roomlist_arr);

                        if(isset($roomlist_arr['Option']['@attributes'])){ ?>
                        <div class="roomslist">
                                <?php echo $roomlist_arr['Option']['@attributes']['Type']?>
                            </div>
                        <?php }else{ 
                             $roomcount=count($roomlist_arr['Option']);
                            ?>
                            <div class="roomslist">
                                <?php echo $roomlist_arr['Option'][0]['Rooms']['Room']['@attributes']['Type']."</br>";
                                 echo $roomcount." extra kamertypes > "
