...
<div class="full witeback">
    ...
    <div class="stepfollow">
        <div class="stpmns"><span id="steps_count">4</span> steps to list your space</div>
    ...
    <div class="full">
        ...
        <div class="col-md-10 offset-0 sideclear">
            <div class="tab-content5">                
                ...
                <div class="tab-pane" id="userdefined_fields">
                    <?php //$this->load->view('listings/edit_listings_udpa'); ?>
                </div>
                ...
                <div class="tab-pane" id="discounts">
					<?php //$this->load->view('listings/edit_listings_discounts'); ?>
                </div>
                ...
                <div class="tab-pane" id="otherfd">
					<?php //$this->load->view('listings/edit_listings_otherfd'); ?>
                </div>
