...
<div class="msg" style="display: none;"></div>
    <div class="tab-pane padding20me active" id="dashbord">
       ...
       <div class="withedrow fulbord">
            <span class="size16 padtabne ">Write your reviews about <?php echo $host_data->firstname; ?></span>
             <form action="<?php echo WEB_URL;  ?>/reviews/update_guest_reviewdata" method="post">
            ...
            <div class="rowit">
                <div class="col-md-5 nopad">
                  ...
                  <div class="abthost">
                	<h3 class="abtcnhost">About the host, <?php echo $host_data->firstname; ?></h3>
                    <div class="col-md-3">
                    <?php  
                    if(isset($host_data->profile_photo) && $host_data->profile_photo != "") {
                        $profile_photo = $host_data->profile_photo;
                    } else if(isset($host_data->agent_logo) && $host_data->agent_logo != "") {
                        $profile_photo = $host_data->agent_logo;
                    } else {
                    ...
                    <div class="col-md-9">
                    	<span class="abtabt">
                        	<?php echo $host_data->about; ?>
                        </span>
                        <?php  
                        if(isset($host_data->user_id)  && $host_data->user_id != "") {
                            $host_user_id = $host_data->user_id;
                            $host_user_type = 3;
                        } else if(isset($host_data->agent_id)  && $host_data->agent_id != "") {
                            $host_user_id = $host_data->agent_id;
                            $host_user_type = 2;
                        }
                        ?>
                        <a class="viewfulprof" target="_blank" href="<?php echo WEB_URL.'/users/show/'.$host_user_type.'/'.$host_user_id; ?>">View full profile</a>
                        <ul class="somelistg">
                        	<li class="listingsome" style="width:100%">
                        	<?php  
                        	$propOwnerName = $host_data->address;
                        	if($propOwnerName != "") {
                        		echo $propOwnerName;
                        	} else {
                        		echo "";
                            ...
                            <div class="clear"></div>
                            <li class="listingsome" style="width:100%">Member since <?php echo date('M Y',strtotime($host_data->register_date));?></li>
                    ...
                    <div class="rowabt">
                        ...
                        <div class="col-md-9">
							...
							$hostReviewCount = $this->reviews_model->get_reviews_about_you($host_user_id, $host_user_type)->num_rows();
                            $guestReviewCount = $this->reviews_model->get_reviews_about_you_guest($host_user_id, $host_user_type)->num_rows(); 
                            $hostReviewsCount = $hostReviewCount+$guestReviewCount;
		                    $verifi = $this->reviews_model->get_verfication_data($host_user_id, $host_user_type); 
                    ...
                    <div class="col-md-2 nopad">
                        <a class="userimgnm">
                            ...
                            if(isset($user_data->profile_photo) && $user_data->profile_photo != "") {
                                ...
                                $user_profile_photo = $user_data->agent_logo;
                            } else {
                                $user_profile_photo = ASSETS.'/images.user-avatar.jpg';
                            }
                            ?>
                            <div class="twouserimg"><img src="<?php echo $user_profile_photo; ?>" alt="" /></div>
